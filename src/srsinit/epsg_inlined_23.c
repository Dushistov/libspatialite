...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 4644, "epsg", 4644,
        "NEA74 Noumea", 1, 1, "International 1924", "NEA74_Noumea", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4645, "epsg", 4645,
        "RGNC 1991", 1, 1, "International 1924", "Reseau_Geodesique_Nouvelle_Caledonie_1991", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4646, "epsg", 4646,
        "Grand Comoros", 1, 1, "International 1924", "Grand_Comoros", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4647, "epsg", 4647,
        "ETRS89 / UTM zone 32N (zE-N)", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4652, "epsg", 4652,
        "New Beijing / 3-degree Gauss-Kruger zone 25", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4653, "epsg", 4653,
        "New Beijing / 3-degree Gauss-Kruger zone 26", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4654, "epsg", 4654,
        "New Beijing / 3-degree Gauss-Kruger zone 27", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4655, "epsg", 4655,
        "New Beijing / 3-degree Gauss-Kruger zone 28", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4656, "epsg", 4656,
        "New Beijing / 3-degree Gauss-Kruger zone 29", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4657, "epsg", 4657,
        "Reykjavik 1900", 1, 1, "Danish 1876", "Reykjavik_1900", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4658, "epsg", 4658,
        "Hjorsey 1955", 1, 1, "International 1924", "Hjorsey_1955", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4659, "epsg", 4659,
        "ISN93", 1, 1, "GRS 1980", "Islands_Net_1993", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4660, "epsg", 4660,
        "Helle 1954", 1, 1, "International 1924", "Helle_1954", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4661, "epsg", 4661,
        "LKS92", 1, 1, "GRS 1980", "Latvia_1992", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4662, "epsg", 4662,
        "IGN72 Grande Terre", 1, 1, "International 1924", "IGN72_Grande_Terre", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4663, "epsg", 4663,
        "Porto Santo 1995", 1, 1, "International 1924", "Porto_Santo_1995", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4664, "epsg", 4664,
        "Azores Oriental 1995", 1, 1, "International 1924", "Azores_Oriental_Islands_1995", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4665, "epsg", 4665,
        "Azores Central 1995", 1, 1, "International 1924", "Azores_Central_Islands_1995", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4666, "epsg", 4666,
        "Lisbon 1890", 1, 1, "Bessel 1841", "Lisbon_1890", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4667, "epsg", 4667,
        "IKBD-92", 1, 1, "WGS 84", "Iraq_Kuwait_Boundary_Datum_1992", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4668, "epsg", 4668,
        "ED79", 1, 1, "International 1924", "European_Datum_1979", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4669, "epsg", 4669,
        "LKS94", 1, 1, "GRS 1980", "Lithuania_1994_ETRS89", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4670, "epsg", 4670,
        "IGM95", 1, 1, "WGS 84", "Istituto_Geografico_Militaire_1995", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4671, "epsg", 4671,
        "Voirol 1879", 1, 1, "Clarke 1880 (IGN)", "Voirol_1879", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4672, "epsg", 4672,
        "Chatham Islands 1971", 1, 1, "International 1924", "Chatham_Islands_Datum_1971", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4673, "epsg", 4673,
        "Chatham Islands 1979", 1, 1, "International 1924", "Chatham_Islands_Datum_1979", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4674, "epsg", 4674,
        "SIRGAS 2000", 1, 1, "GRS 1980", "Sistema_de_Referencia_Geocentrico_para_las_AmericaS_2000", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4675, "epsg", 4675,
        "Guam 1963", 1, 1, "Clarke 1866", "Guam_1963", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4676, "epsg", 4676,
        "Vientiane 1982", 1, 1, "Krassowsky 1940", "Vientiane_1982", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4677, "epsg", 4677,
        "Lao 1993", 1, 1, "Krassowsky 1940", "Lao_1993", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=krass +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4678, "epsg", 4678,
        "Lao 1997", 1, 1, "Krassowsky 1940", "Lao_National_Datum_1997", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4679, "epsg", 4679,
        "Jouik 1961", 1, 1, "Clarke 1880 (RGS)", "Jouik_1961", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4680, "epsg", 4680,
        "Nouakchott 1965", 1, 1, "Clarke 1880 (RGS)", "Nouakchott_1965", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4681, "epsg", 4681,
        "Mauritania 1999", 1, 1, "Clarke 1880 (RGS)", "Mauritania_1999", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4682, "epsg", 4682,
        "Gulshan 303", 1, 1, "Everest 1830 (1937 Adjustment)", "Gulshan_303", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4683, "epsg", 4683,
        "PRS92", 1, 1, "Clarke 1866", "Philippine_Reference_System_1992", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4684, "epsg", 4684,
        "Gan 1970", 1, 1, "International 1924", "Gan_1970", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4685, "epsg", 4685,
        "Gandajika", 1, 1, "International 1924", "Gandajika", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4686, "epsg", 4686,
        "MAGNA-SIRGAS", 1, 1, "GRS 1980", "Marco_Geocentrico_Nacional_de_Referencia", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4687, "epsg", 4687,
        "RGPF", 1, 1, "GRS 1980", "Reseau_Geodesique_de_la_Polynesie_Francaise", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4688, "epsg", 4688,
        "Fatu Iva 72", 1, 1, "International 1924", "Fatu_Iva_72", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4689, "epsg", 4689,
        "IGN63 Hiva Oa", 1, 1, "International 1924", "IGN63_Hiva_Oa", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4690, "epsg", 4690,
        "Tahiti 79", 1, 1, "International 1924", "Tahiti_79", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4691, "epsg", 4691,
        "Moorea 87", 1, 1, "International 1924", "Moorea_87", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4692, "epsg", 4692,
        "Maupiti 83", 1, 1, "International 1924", "Maupiti_83", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4693, "epsg", 4693,
        "Nakhl-e Ghanem", 1, 1, "WGS 84", "Nakhl_e_Ghanem", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4694, "epsg", 4694,
        "POSGAR 94", 1, 1, "WGS 84", "Posiciones_Geodesicas_Argentinas_1994", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4695, "epsg", 4695,
        "Katanga 1955", 1, 1, "Clarke 1866", "Katanga_1955", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4696, "epsg", 4696,
        "Kasai 1953", 1, 1, "Clarke 1880 (RGS)", "Kasai_1953", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=clrk80 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4697, "epsg", 4697,
        "IGC 1962 6th Parallel South", 1, 1, "Clarke 1880 (RGS)", "IGC_1962_Arc_of_the_6th_Parallel_South", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=clrk80 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4698, "epsg", 4698,
        "IGN 1962 Kerguelen", 1, 1, "International 1924", "IGN_1962_Kerguelen", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4699, "epsg", 4699,
        "Le Pouce 1934", 1, 1, "Clarke 1880 (RGS)", "Le_Pouce_1934", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4700, "epsg", 4700,
        "IGN Astro 1960", 1, 1, "Clarke 1880 (RGS)", "IGN_Astro_1960", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=clrk80 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4701, "epsg", 4701,
        "IGCB 1955", 1, 1, "Clarke 1880 (RGS)", "Institut_Geographique_du_Congo_Belge_1955", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4702, "epsg", 4702,
        "Mauritania 1999", 1, 1, "GRS 1980", "Mauritania_1999", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4703, "epsg", 4703,
        "Mhast 1951", 1, 1, "Clarke 1880 (RGS)", "Missao_Hidrografico_Angola_y_Sao_Tome_1951", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=clrk80 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4704, "epsg", 4704,
        "Mhast (onshore)", 1, 1, "International 1924", "Mhast_onshore", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=intl +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4705, "epsg", 4705,
        "Mhast (offshore)", 1, 1, "International 1924", "Mhast_offshore", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=intl +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4706, "epsg", 4706,
        "Egypt Gulf of Suez S-650 TL", 1, 1, "Helmert 1906", "Egypt_Gulf_of_Suez_S_650_TL", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4707, "epsg", 4707,
        "Tern Island 1961", 1, 1, "International 1924", "Tern_Island_1961", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4708, "epsg", 4708,
        "Cocos Islands 1965", 1, 1, "Australian National Spheroid", "Cocos_Islands_1965", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4709, "epsg", 4709,
        "Iwo Jima 1945", 1, 1, "International 1924", "Iwo_Jima_1945", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4710, "epsg", 4710,
        "St. Helena 1971", 1, 1, "International 1924", "St_Helena_1971", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4711, "epsg", 4711,
        "Marcus Island 1952", 1, 1, "International 1924", "Marcus_Island_1952", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4712, "epsg", 4712,
        "Ascension Island 1958", 1, 1, "International 1924", "Ascension_Island_1958", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4713, "epsg", 4713,
        "Ayabelle Lighthouse", 1, 1, "Clarke 1880 (RGS)", "Ayabelle_Lighthouse", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4714, "epsg", 4714,
        "Bellevue", 1, 1, "International 1924", "Bellevue", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4715, "epsg", 4715,
        "Camp Area Astro", 1, 1, "International 1924", "Camp_Area_Astro", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4716, "epsg", 4716,
        "Phoenix Islands 1966", 1, 1, "International 1924", "Phoenix_Islands_1966", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4717, "epsg", 4717,
        "Cape Canaveral", 1, 1, "Clarke 1866", "Cape_Canaveral", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4718, "epsg", 4718,
        "Solomon 1968", 1, 1, "International 1924", "Solomon_1968", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4719, "epsg", 4719,
        "Easter Island 1967", 1, 1, "International 1924", "Easter_Island_1967", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4720, "epsg", 4720,
        "Fiji 1986", 1, 1, "WGS 72", "Fiji_Geodetic_Datum_1986", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4721, "epsg", 4721,
        "Fiji 1956", 1, 1, "International 1924", "Fiji_1956", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4722, "epsg", 4722,
        "South Georgia 1968", 1, 1, "International 1924", "South_Georgia_1968", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4723, "epsg", 4723,
        "GCGD59", 1, 1, "Clarke 1866", "Grand_Cayman_Geodetic_Datum_1959", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4724, "epsg", 4724,
        "Diego Garcia 1969", 1, 1, "International 1924", "Diego_Garcia_1969", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4725, "epsg", 4725,
        "Johnston Island 1961", 1, 1, "International 1924", "Johnston_Island_1961", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4726, "epsg", 4726,
        "SIGD61", 1, 1, "Clarke 1866", "Sister_Islands_Geodetic_Datum_1961", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4727, "epsg", 4727,
        "Midway 1961", 1, 1, "International 1924", "Midway_1961", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4728, "epsg", 4728,
        "Pico de las Nieves 1984", 1, 1, "International 1924", "Pico_de_las_Nieves_1984", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4729, "epsg", 4729,
        "Pitcairn 1967", 1, 1, "International 1924", "Pitcairn_1967", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4730, "epsg", 4730,
        "Santo 1965", 1, 1, "International 1924", "Santo_1965", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4731, "epsg", 4731,
        "Viti Levu 1916", 1, 1, "Clarke 1880 (RGS)", "Viti_Levu_1916", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4732, "epsg", 4732,
        "Marshall Islands 1960", 1, 1, "Hough 1960", "Marshall_Islands_1960", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4733, "epsg", 4733,
        "Wake Island 1952", 1, 1, "International 1924", "Wake_Island_1952", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4734, "epsg", 4734,
        "Tristan 1968", 1, 1, "International 1924", "Tristan_1968", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4735, "epsg", 4735,
        "Kusaie 1951", 1, 1, "International 1924", "Kusaie_1951", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4736, "epsg", 4736,
        "Deception Island", 1, 1, "Clarke 1880 (RGS)", "Deception_Island", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4737, "epsg", 4737,
        "Korea 2000", 1, 1, "GRS 1980", "Geocentric_datum_of_Korea", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4738, "epsg", 4738,
        "Hong Kong 1963", 1, 1, "Clarke 1858", "Hong_Kong_1963", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4739, "epsg", 4739,
        "Hong Kong 1963(67)", 1, 1, "International 1924", "Hong_Kong_1963_67", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4740, "epsg", 4740,
        "PZ-90", 1, 1, "PZ-90", "Parametrop_Zemp_1990", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4741, "epsg", 4741,
        "FD54", 1, 1, "International 1924", "Faroe_Datum_1954", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=intl +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4742, "epsg", 4742,
        "GDM2000", 1, 1, "GRS 1980", "Geodetic_Datum_of_Malaysia_2000", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4743, "epsg", 4743,
        "Karbala 1979", 1, 1, "Clarke 1880 (RGS)", "Karbala_1979", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4744, "epsg", 4744,
        "Nahrwan 1934", 1, 1, "Clarke 1880 (RGS)", "Nahrwan_1934", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=clrk80 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4745, "epsg", 4745,
        "RD/83", 1, 1, "Bessel 1841", "Rauenberg_Datum_83", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4746, "epsg", 4746,
        "PD/83", 1, 1, "Bessel 1841", "Potsdam_Datum_83", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=bessel +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4747, "epsg", 4747,
        "GR96", 1, 1, "GRS 1980", "Greenland_1996", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4748, "epsg", 4748,
        "Vanua Levu 1915", 1, 1, "Clarke 1880 (international foot)", "Vanua_Levu_1915", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
