...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 6563, "epsg", 6563,
        "NAD83(2011) / Pennsylvania North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6564, "epsg", 6564,
        "NAD83(2011) / Pennsylvania South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6565, "epsg", 6565,
        "NAD83(2011) / Pennsylvania South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=40.96666666666667 +lat_2=39.93333333333");
    add_proj4text (p, 1,
        "333 +lat_0=39.33333333333334 +lon_0=-77.75 +x_0=600000 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 6566, "epsg", 6566,
        "NAD83(2011) / Puerto Rico and Virgin Is.", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6567, "epsg", 6567,
        "NAD83(2011) / Rhode Island", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6568, "epsg", 6568,
        "NAD83(2011) / Rhode Island (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=41.08333333333334 +lon_0=-71.5 +k=0.9");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6569, "epsg", 6569,
        "NAD83(2011) / South Carolina", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6570, "epsg", 6570,
        "NAD83(2011) / South Carolina (ft)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=34.83333333333334 +lat_2=32.5 +lat_0=31");
    add_proj4text (p, 1,
        ".83333333333333 +lon_0=-81 +x_0=609600 +y_0=0 +ellps=GRS");
    ...
    p = add_epsg_def_ex (filter, first, last, 6571, "epsg", 6571,
        "NAD83(2011) / South Dakota North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6572, "epsg", 6572,
        "NAD83(2011) / South Dakota North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=45.68333333333333 +lat_2=44.41666666666");
    add_proj4text (p, 1,
        "666 +lat_0=43.83333333333334 +lon_0=-100 +x_0=600000 +y_");
    ...
    p = add_epsg_def_ex (filter, first, last, 6573, "epsg", 6573,
        "NAD83(2011) / South Dakota South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6574, "epsg", 6574,
        "NAD83(2011) / South Dakota South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=44.4 +lat_2=42.83333333333334 +lat_0=42");
    add_proj4text (p, 1,
        ".33333333333334 +lon_0=-100.3333333333333 +x_0=600000 +y");
    ...
    p = add_epsg_def_ex (filter, first, last, 6575, "epsg", 6575,
        "NAD83(2011) / Tennessee", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6576, "epsg", 6576,
        "NAD83(2011) / Tennessee (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=36.41666666666666 +lat_2=35.25 +lat_0=3");
    add_proj4text (p, 1,
        "4.33333333333334 +lon_0=-86 +x_0=600000 +y_0=0 +ellps=GR");
    ...
    p = add_epsg_def_ex (filter, first, last, 6577, "epsg", 6577,
        "NAD83(2011) / Texas Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6578, "epsg", 6578,
        "NAD83(2011) / Texas Central (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=31.88333333333333 +lat_2=30.11666666666");
    add_proj4text (p, 1,
        "667 +lat_0=29.66666666666667 +lon_0=-100.3333333333333 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 6579, "epsg", 6579,
        "NAD83(2011) / Texas Centric Albers Equal Area", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6580, "epsg", 6580,
        "NAD83(2011) / Texas Centric Lambert Conformal", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6581, "epsg", 6581,
        "NAD83(2011) / Texas North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6582, "epsg", 6582,
        "NAD83(2011) / Texas North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=36.18333333333333 +lat_2=34.65 +lat_0=3");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6583, "epsg", 6583,
        "NAD83(2011) / Texas North Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6584, "epsg", 6584,
        "NAD83(2011) / Texas North Central (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=33.96666666666667 +lat_2=32.13333333333");
    add_proj4text (p, 1,
        "333 +lat_0=31.66666666666667 +lon_0=-98.5 +x_0=600000 +y");
    ...
    p = add_epsg_def_ex (filter, first, last, 6585, "epsg", 6585,
        "NAD83(2011) / Texas South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6586, "epsg", 6586,
        "NAD83(2011) / Texas South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=27.83333333333333 +lat_2=26.16666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6587, "epsg", 6587,
        "NAD83(2011) / Texas South Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6588, "epsg", 6588,
        "NAD83(2011) / Texas South Central (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=30.28333333333333 +lat_2=28.38333333333");
    add_proj4text (p, 1,
        "333 +lat_0=27.83333333333333 +lon_0=-99 +x_0=600000 +y_0");
    ...
    p = add_epsg_def_ex (filter, first, last, 6589, "epsg", 6589,
        "NAD83(2011) / Vermont", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6590, "epsg", 6590,
        "NAD83(2011) / Vermont (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=42.5 +lon_0=-72.5 +k=0.999964286 +x_0");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6591, "epsg", 6591,
        "NAD83(2011) / Virginia Lambert", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6592, "epsg", 6592,
        "NAD83(2011) / Virginia North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6593, "epsg", 6593,
        "NAD83(2011) / Virginia North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=39.2 +lat_2=38.03333333333333 +lat_0=37");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6594, "epsg", 6594,
        "NAD83(2011) / Virginia South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6595, "epsg", 6595,
        "NAD83(2011) / Virginia South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=37.96666666666667 +lat_2=36.76666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6596, "epsg", 6596,
        "NAD83(2011) / Washington North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6597, "epsg", 6597,
        "NAD83(2011) / Washington North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=48.73333333333333 +lat_2=47.5 +lat_0=47");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6598, "epsg", 6598,
        "NAD83(2011) / Washington South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6599, "epsg", 6599,
        "NAD83(2011) / Washington South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=47.33333333333334 +lat_2=45.83333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6600, "epsg", 6600,
        "NAD83(2011) / West Virginia North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6601, "epsg", 6601,
        "NAD83(2011) / West Virginia North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=40.25 +lat_2=39 +lat_0=38.5 +lon_0=-79.");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6602, "epsg", 6602,
        "NAD83(2011) / West Virginia South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6603, "epsg", 6603,
        "NAD83(2011) / West Virginia South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=38.88333333333333 +lat_2=37.48333333333");
    add_proj4text (p, 1,
        "333 +lat_0=37 +lon_0=-81 +x_0=600000 +y_0=0 +ellps=GRS80");
    ...
    p = add_epsg_def_ex (filter, first, last, 6604, "epsg", 6604,
        "NAD83(2011) / Wisconsin Central (deprecated)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6605, "epsg", 6605,
        "NAD83(2011) / Wisconsin Central (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=45.5 +lat_2=44.25 +lat_0=43.83333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6606, "epsg", 6606,
        "NAD83(2011) / Wisconsin North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6607, "epsg", 6607,
        "NAD83(2011) / Wisconsin North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=46.76666666666667 +lat_2=45.56666666666");
    add_proj4text (p, 1,
        "667 +lat_0=45.16666666666666 +lon_0=-90 +x_0=600000 +y_0");
    ...
    p = add_epsg_def_ex (filter, first, last, 6608, "epsg", 6608,
        "NAD83(2011) / Wisconsin South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6609, "epsg", 6609,
        "NAD83(2011) / Wisconsin South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=44.06666666666667 +lat_2=42.73333333333");
    add_proj4text (p, 1,
        "333 +lat_0=42 +lon_0=-90 +x_0=600000 +y_0=0 +ellps=GRS80");
    ...
    p = add_epsg_def_ex (filter, first, last, 6610, "epsg", 6610,
        "NAD83(2011) / Wisconsin Transverse Mercator", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6611, "epsg", 6611,
        "NAD83(2011) / Wyoming East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6612, "epsg", 6612,
        "NAD83(2011) / Wyoming East (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=40.5 +lon_0=-105.1666666666667 +k=0.9");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6613, "epsg", 6613,
        "NAD83(2011) / Wyoming East Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6614, "epsg", 6614,
        "NAD83(2011) / Wyoming East Central (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=40.5 +lon_0=-107.3333333333333 +k=0.9");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6615, "epsg", 6615,
        "NAD83(2011) / Wyoming West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6616, "epsg", 6616,
        "NAD83(2011) / Wyoming West (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=40.5 +lon_0=-110.0833333333333 +k=0.9");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6617, "epsg", 6617,
        "NAD83(2011) / Wyoming West Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6618, "epsg", 6618,
        "NAD83(2011) / Wyoming West Central (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=40.5 +lon_0=-108.75 +k=0.9999375 +x_0");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6619, "epsg", 6619,
        "NAD83(2011) / Utah Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6620, "epsg", 6620,
        "NAD83(2011) / Utah North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6621, "epsg", 6621,
        "NAD83(2011) / Utah South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6622, "epsg", 6622,
        "NAD83(CSRS) / Quebec Lambert", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6623, "epsg", 6623,
        "NAD83 / Quebec Albers", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6624, "epsg", 6624,
        "NAD83(CSRS) / Quebec Albers", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=aea +lat_1=60 +lat_2=46 +lat_0=44 +lon_0=-68.5 +x_");
    add_proj4text (p, 1,
        "0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m ");
    ...
    p = add_epsg_def_ex (filter, first, last, 6625, "epsg", 6625,
        "NAD83(2011) / Utah Central (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=40.65 +lat_2=39.01666666666667 +lat_0=3");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6626, "epsg", 6626,
        "NAD83(2011) / Utah North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=41.78333333333333 +lat_2=40.71666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6627, "epsg", 6627,
        "NAD83(2011) / Utah South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2011", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=38.35 +lat_2=37.21666666666667 +lat_0=3");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6628, "epsg", 6628,
        "NAD83(PA11) / Hawaii zone 1", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_PA11", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6629, "epsg", 6629,
        "NAD83(PA11) / Hawaii zone 2", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_PA11", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6630, "epsg", 6630,
        "NAD83(PA11) / Hawaii zone 3", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_PA11", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6631, "epsg", 6631,
        "NAD83(PA11) / Hawaii zone 4", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_PA11", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6632, "epsg", 6632,
        "NAD83(PA11) / Hawaii zone 5", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_PA11", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6633, "epsg", 6633,
        "NAD83(PA11) / Hawaii zone 3 (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_PA11", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=21.16666666666667 +lon_0=-158 +k=0.99");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6634, "epsg", 6634,
        "NAD83(PA11) / UTM zone 4N", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_PA11", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6635, "epsg", 6635,
        "NAD83(PA11) / UTM zone 5N", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_PA11", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6636, "epsg", 6636,
        "NAD83(PA11) / UTM zone 2S", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_PA11", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6637, "epsg", 6637,
        "NAD83(MA11) / Guam Map Grid", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_MA11", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6646, "epsg", 6646,
        "Karbala 1979 / Iraq National Grid", 0, 0, "Clarke 1880 (RGS)", "Karbala_1979", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6649, "epsg", 6649,
        "NAD83(CSRS)", 1, 1, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6650, "epsg", 6650,
        "NAD83(CSRS) / UTM zone 7N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6651, "epsg", 6651,
        "NAD83(CSRS) / UTM zone 8N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6652, "epsg", 6652,
        "NAD83(CSRS) / UTM zone 9N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6653, "epsg", 6653,
        "NAD83(CSRS) / UTM zone 10N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6654, "epsg", 6654,
        "NAD83(CSRS) / UTM zone 11N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6655, "epsg", 6655,
        "NAD83(CSRS) / UTM zone 12N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6656, "epsg", 6656,
        "NAD83(CSRS) / UTM zone 13N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6657, "epsg", 6657,
        "NAD83(CSRS) / UTM zone 14N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6658, "epsg", 6658,
        "NAD83(CSRS) / UTM zone 15N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6659, "epsg", 6659,
        "NAD83(CSRS) / UTM zone 16N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6660, "epsg", 6660,
        "NAD83(CSRS) / UTM zone 17N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6661, "epsg", 6661,
        "NAD83(CSRS) / UTM zone 18N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6662, "epsg", 6662,
        "NAD83(CSRS) / UTM zone 19N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6663, "epsg", 6663,
        "NAD83(CSRS) / UTM zone 20N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6664, "epsg", 6664,
        "NAD83(CSRS) / UTM zone 21N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6665, "epsg", 6665,
        "NAD83(CSRS) / UTM zone 22N", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6668, "epsg", 6668,
        "JGD2011", 1, 1, "GRS 1980", "Japanese_Geodetic_Datum_2011", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6669, "epsg", 6669,
        "JGD2011 / Japan Plane Rectangular CS I", 0, 1, "GRS 1980", "Japanese_Geodetic_Datum_2011", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6670, "epsg", 6670,
        "JGD2011 / Japan Plane Rectangular CS II", 0, 1, "GRS 1980", "Japanese_Geodetic_Datum_2011", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6671, "epsg", 6671,
        "JGD2011 / Japan Plane Rectangular CS III", 0, 1, "GRS 1980", "Japanese_Geodetic_Datum_2011", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6672, "epsg", 6672,
        "JGD2011 / Japan Plane Rectangular CS IV", 0, 1, "GRS 1980", "Japanese_Geodetic_Datum_2011", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6673, "epsg", 6673,
        "JGD2011 / Japan Plane Rectangular CS V", 0, 1, "GRS 1980", "Japanese_Geodetic_Datum_2011", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6674, "epsg", 6674,
        "JGD2011 / Japan Plane Rectangular CS VI", 0, 1, "GRS 1980", "Japanese_Geodetic_Datum_2011", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6675, "epsg", 6675,
        "JGD2011 / Japan Plane Rectangular CS VII", 0, 1, "GRS 1980", "Japanese_Geodetic_Datum_2011", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
