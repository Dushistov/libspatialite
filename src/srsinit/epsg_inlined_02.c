...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 2209, "epsg", 2209,
        "ED50 / 3-degree Gauss-Kruger zone 12", 0, 1, "International 1924", "European_Datum_1950", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2210, "epsg", 2210,
        "ED50 / 3-degree Gauss-Kruger zone 13", 0, 1, "International 1924", "European_Datum_1950", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2211, "epsg", 2211,
        "ED50 / 3-degree Gauss-Kruger zone 14", 0, 1, "International 1924", "European_Datum_1950", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2212, "epsg", 2212,
        "ED50 / 3-degree Gauss-Kruger zone 15", 0, 1, "International 1924", "European_Datum_1950", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2213, "epsg", 2213,
        "ETRS89 / TM 30 NE", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2214, "epsg", 2214,
        "Douala 1948 / AOF west (deprecated)", 0, 0, "International 1924", "Douala_1948", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2215, "epsg", 2215,
        "Manoca 1962 / UTM zone 32N", 0, 0, "Clarke 1880 (IGN)", "Manoca_1962", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2216, "epsg", 2216,
        "Qornoq 1927 / UTM zone 22N", 0, 0, "International 1924", "Qornoq_1927", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2217, "epsg", 2217,
        "Qornoq 1927 / UTM zone 23N", 0, 0, "International 1924", "Qornoq_1927", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2219, "epsg", 2219,
        "ATS77 / UTM zone 19N", 0, 0, "Average Terrestrial System 1977", "Average_Terrestrial_System_1977", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2220, "epsg", 2220,
        "ATS77 / UTM zone 20N", 0, 0, "Average Terrestrial System 1977", "Average_Terrestrial_System_1977", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2222, "epsg", 2222,
        "NAD83 / Arizona East (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2223, "epsg", 2223,
        "NAD83 / Arizona Central (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2224, "epsg", 2224,
        "NAD83 / Arizona West (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2225, "epsg", 2225,
        "NAD83 / California zone 1 (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2226, "epsg", 2226,
        "NAD83 / California zone 2 (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2227, "epsg", 2227,
        "NAD83 / California zone 3 (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2228, "epsg", 2228,
        "NAD83 / California zone 4 (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2229, "epsg", 2229,
        "NAD83 / California zone 5 (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2230, "epsg", 2230,
        "NAD83 / California zone 6 (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2231, "epsg", 2231,
        "NAD83 / Colorado North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2232, "epsg", 2232,
        "NAD83 / Colorado Central (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2233, "epsg", 2233,
        "NAD83 / Colorado South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2234, "epsg", 2234,
        "NAD83 / Connecticut (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2235, "epsg", 2235,
        "NAD83 / Delaware (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2236, "epsg", 2236,
        "NAD83 / Florida East (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2237, "epsg", 2237,
        "NAD83 / Florida West (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2238, "epsg", 2238,
        "NAD83 / Florida North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2239, "epsg", 2239,
        "NAD83 / Georgia East (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2240, "epsg", 2240,
        "NAD83 / Georgia West (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2241, "epsg", 2241,
        "NAD83 / Idaho East (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2242, "epsg", 2242,
        "NAD83 / Idaho Central (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2243, "epsg", 2243,
        "NAD83 / Idaho West (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2244, "epsg", 2244,
        "NAD83 / Indiana East (ftUS) (deprecated)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2245, "epsg", 2245,
        "NAD83 / Indiana West (ftUS) (deprecated)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2246, "epsg", 2246,
        "NAD83 / Kentucky North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2247, "epsg", 2247,
        "NAD83 / Kentucky South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2248, "epsg", 2248,
        "NAD83 / Maryland (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2249, "epsg", 2249,
        "NAD83 / Massachusetts Mainland (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2250, "epsg", 2250,
        "NAD83 / Massachusetts Island (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2251, "epsg", 2251,
        "NAD83 / Michigan North (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2252, "epsg", 2252,
        "NAD83 / Michigan Central (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2253, "epsg", 2253,
        "NAD83 / Michigan South (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2254, "epsg", 2254,
        "NAD83 / Mississippi East (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2255, "epsg", 2255,
        "NAD83 / Mississippi West (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2256, "epsg", 2256,
        "NAD83 / Montana (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2257, "epsg", 2257,
        "NAD83 / New Mexico East (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2258, "epsg", 2258,
        "NAD83 / New Mexico Central (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2259, "epsg", 2259,
        "NAD83 / New Mexico West (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2260, "epsg", 2260,
        "NAD83 / New York East (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2261, "epsg", 2261,
        "NAD83 / New York Central (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2262, "epsg", 2262,
        "NAD83 / New York West (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2263, "epsg", 2263,
        "NAD83 / New York Long Island (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2264, "epsg", 2264,
        "NAD83 / North Carolina (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2265, "epsg", 2265,
        "NAD83 / North Dakota North (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2266, "epsg", 2266,
        "NAD83 / North Dakota South (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2267, "epsg", 2267,
        "NAD83 / Oklahoma North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2268, "epsg", 2268,
        "NAD83 / Oklahoma South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2269, "epsg", 2269,
        "NAD83 / Oregon North (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2270, "epsg", 2270,
        "NAD83 / Oregon South (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2271, "epsg", 2271,
        "NAD83 / Pennsylvania North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2272, "epsg", 2272,
        "NAD83 / Pennsylvania South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2273, "epsg", 2273,
        "NAD83 / South Carolina (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2274, "epsg", 2274,
        "NAD83 / Tennessee (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2275, "epsg", 2275,
        "NAD83 / Texas North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2276, "epsg", 2276,
        "NAD83 / Texas North Central (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2277, "epsg", 2277,
        "NAD83 / Texas Central (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2278, "epsg", 2278,
        "NAD83 / Texas South Central (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2279, "epsg", 2279,
        "NAD83 / Texas South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2280, "epsg", 2280,
        "NAD83 / Utah North (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2281, "epsg", 2281,
        "NAD83 / Utah Central (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2282, "epsg", 2282,
        "NAD83 / Utah South (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2283, "epsg", 2283,
        "NAD83 / Virginia North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2284, "epsg", 2284,
        "NAD83 / Virginia South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2285, "epsg", 2285,
        "NAD83 / Washington North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2286, "epsg", 2286,
        "NAD83 / Washington South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2287, "epsg", 2287,
        "NAD83 / Wisconsin North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2288, "epsg", 2288,
        "NAD83 / Wisconsin Central (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2289, "epsg", 2289,
        "NAD83 / Wisconsin South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2290, "epsg", 2290,
        "ATS77 / Prince Edward Isl. Stereographic (ATS77)", 0, 0, "Average Terrestrial System 1977", "Average_Terrestrial_System_1977", "metre", "E(X)", "East", "N(Y)", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2291, "epsg", 2291,
        "NAD83(CSRS98) / Prince Edward Isl. Stereographic (NAD83) (deprecated)", 0, 0, "Average Terrestrial System 1977", "Average_Terrestrial_System_1977", "metre", "E(X)", "East", "N(Y)", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2292, "epsg", 2292,
        "NAD83(CSRS98) / Prince Edward Isl. Stereographic (NAD83) (deprecated)", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "E(X)", "East", "N(Y)", "North");
    add_proj4text (p, 0,
        "+proj=sterea +lat_0=47.25 +lon_0=-63 +k=0.999912 +x_0=40");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2294, "epsg", 2294,
        "ATS77 / MTM Nova Scotia zone 4", 0, 0, "Average Terrestrial System 1977", "Average_Terrestrial_System_1977", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2295, "epsg", 2295,
        "ATS77 / MTM Nova Scotia zone 5", 0, 0, "Average Terrestrial System 1977", "Average_Terrestrial_System_1977", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2308, "epsg", 2308,
        "Batavia / TM 109 SE", 0, 0, "Bessel 1841", "Batavia", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2309, "epsg", 2309,
        "WGS 84 / TM 116 SE", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2310, "epsg", 2310,
        "WGS 84 / TM 132 SE", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2311, "epsg", 2311,
        "WGS 84 / TM 6 NE", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2312, "epsg", 2312,
        "Garoua / UTM zone 33N", 0, 0, "Clarke 1880 (RGS)", "Garoua", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2313, "epsg", 2313,
        "Kousseri / UTM zone 33N", 0, 0, "Clarke 1880 (RGS)", "Kousseri", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=utm +zone=33 +ellps=clrk80 +units=m +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2314, "epsg", 2314,
        "Trinidad 1903 / Trinidad Grid (ftCla)", 0, 0, "Clarke 1858", "Trinidad_1903", "Clarke's foot", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2315, "epsg", 2315,
        "Campo Inchauspe / UTM zone 19S", 0, 0, "International 1924", "Campo_Inchauspe", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2316, "epsg", 2316,
        "Campo Inchauspe / UTM zone 20S", 0, 0, "International 1924", "Campo_Inchauspe", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2317, "epsg", 2317,
        "PSAD56 / ICN Regional", 0, 0, "International 1924", "Provisional_South_American_Datum_1956", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2318, "epsg", 2318,
        "Ain el Abd / Aramco Lambert", 0, 0, "International 1924", "Ain_el_Abd_1970", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2319, "epsg", 2319,
        "ED50 / TM27", 0, 1, "International 1924", "European_Datum_1950", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2320, "epsg", 2320,
        "ED50 / TM30", 0, 1, "International 1924", "European_Datum_1950", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2321, "epsg", 2321,
        "ED50 / TM33", 0, 1, "International 1924", "European_Datum_1950", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2322, "epsg", 2322,
        "ED50 / TM36", 0, 1, "International 1924", "European_Datum_1950", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2323, "epsg", 2323,
        "ED50 / TM39", 0, 1, "International 1924", "European_Datum_1950", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2324, "epsg", 2324,
        "ED50 / TM42", 0, 1, "International 1924", "European_Datum_1950", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
