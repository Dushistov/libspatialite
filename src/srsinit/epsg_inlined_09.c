...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 2931, "epsg", 2931,
        "Beduaram / TM 13 NE", 0, 0, "Clarke 1880 (IGN)", "Beduaram", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2932, "epsg", 2932,
        "QND95 / Qatar National Grid", 0, 0, "International 1924", "Qatar_National_Datum_1995", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2933, "epsg", 2933,
        "Segara / UTM zone 50S", 0, 0, "Bessel 1841", "Gunung_Segara", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2934, "epsg", 2934,
        "Segara (Jakarta) / NEIEZ (deprecated)", 0, 0, "Bessel 1841", "Gunung_Segara_Jakarta", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2935, "epsg", 2935,
        "Pulkovo 1942 / CS63 zone A1", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2936, "epsg", 2936,
        "Pulkovo 1942 / CS63 zone A2", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2937, "epsg", 2937,
        "Pulkovo 1942 / CS63 zone A3", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2938, "epsg", 2938,
        "Pulkovo 1942 / CS63 zone A4", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2939, "epsg", 2939,
        "Pulkovo 1942 / CS63 zone K2", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2940, "epsg", 2940,
        "Pulkovo 1942 / CS63 zone K3", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2941, "epsg", 2941,
        "Pulkovo 1942 / CS63 zone K4", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2942, "epsg", 2942,
        "Porto Santo / UTM zone 28N", 0, 0, "International 1924", "Porto_Santo_1936", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2943, "epsg", 2943,
        "Selvagem Grande / UTM zone 28N", 0, 0, "International 1924", "Selvagem_Grande", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2944, "epsg", 2944,
        "NAD83(CSRS) / SCoPQ zone 2 (deprecated)", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2945, "epsg", 2945,
        "NAD83(CSRS) / MTM zone 3", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "E(X)", "East", "N(Y)", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2946, "epsg", 2946,
        "NAD83(CSRS) / MTM zone 4", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "E(X)", "East", "N(Y)", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2947, "epsg", 2947,
        "NAD83(CSRS) / MTM zone 5", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "E(X)", "East", "N(Y)", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2948, "epsg", 2948,
        "NAD83(CSRS) / MTM zone 6", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "E(X)", "East", "N(Y)", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2949, "epsg", 2949,
        "NAD83(CSRS) / MTM zone 7", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "E(X)", "East", "N(Y)", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2950, "epsg", 2950,
        "NAD83(CSRS) / MTM zone 8", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "E(X)", "East", "N(Y)", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2951, "epsg", 2951,
        "NAD83(CSRS) / MTM zone 9", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "E(X)", "East", "N(Y)", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2952, "epsg", 2952,
        "NAD83(CSRS) / MTM zone 10", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "E(X)", "East", "N(Y)", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2953, "epsg", 2953,
        "NAD83(CSRS) / New Brunswick Stereographic", 0, 1, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2954, "epsg", 2954,
        "NAD83(CSRS) / Prince Edward Isl. Stereographic (NAD83)", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "E(X)", "East", "N(Y)", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2964, "epsg", 2964,
        "NAD27 / Alaska Albers", 0, 0, "Clarke 1866", "North_American_Datum_1927", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2965, "epsg", 2965,
        "NAD83 / Indiana East (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2966, "epsg", 2966,
        "NAD83 / Indiana West (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2967, "epsg", 2967,
        "NAD83(HARN) / Indiana East (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=37.5 +lon_0=-85.66666666666667 +k=0.9");
    add_proj4text (p, 1,
        "99966667 +x_0=99999.99989839978 +y_0=249999.9998983998 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 2968, "epsg", 2968,
        "NAD83(HARN) / Indiana West (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=37.5 +lon_0=-87.08333333333333 +k=0.9");
    add_proj4text (p, 1,
        "99966667 +x_0=900000 +y_0=249999.9998983998 +ellps=GRS80");
    ...
    p = add_epsg_def_ex (filter, first, last, 2969, "epsg", 2969,
        "Fort Marigot / UTM zone 20N", 0, 0, "International 1924", "Fort_Marigot", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2970, "epsg", 2970,
        "Guadeloupe 1948 / UTM zone 20N", 0, 0, "International 1924", "Guadeloupe_1948", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2971, "epsg", 2971,
        "CSG67 / UTM zone 22N", 0, 0, "International 1924", "Centre_Spatial_Guyanais_1967", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2972, "epsg", 2972,
        "RGFG95 / UTM zone 22N", 0, 0, "GRS 1980", "Reseau_Geodesique_Francais_Guyane_1995", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2973, "epsg", 2973,
        "Martinique 1938 / UTM zone 20N", 0, 0, "International 1924", "Martinique_1938", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2975, "epsg", 2975,
        "RGR92 / UTM zone 40S", 0, 0, "GRS 1980", "Reseau_Geodesique_de_la_Reunion_1992", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2976, "epsg", 2976,
        "Tahiti 52 / UTM zone 6S", 0, 0, "International 1924", "Tahiti_52", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2977, "epsg", 2977,
        "Tahaa 54 / UTM zone 5S", 0, 0, "International 1924", "Tahaa_54", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2978, "epsg", 2978,
        "IGN72 Nuku Hiva / UTM zone 7S", 0, 0, "International 1924", "IGN72_Nuku_Hiva", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2979, "epsg", 2979,
        "K0 1949 / UTM zone 42S (deprecated)", 0, 0, "International 1924", "K0_1949", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2980, "epsg", 2980,
        "Combani 1950 / UTM zone 38S", 0, 0, "International 1924", "Combani_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2981, "epsg", 2981,
        "IGN56 Lifou / UTM zone 58S", 0, 0, "International 1924", "IGN56_Lifou", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2982, "epsg", 2982,
        "IGN72 Grand Terre / UTM zone 58S (deprecated)", 0, 0, "International 1924", "IGN72_Grande_Terre", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2983, "epsg", 2983,
        "ST87 Ouvea / UTM zone 58S (deprecated)", 0, 0, "International 1924", "ST87_Ouvea", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2984, "epsg", 2984,
        "RGNC 1991 / Lambert New Caledonia (deprecated)", 0, 0, "International 1924", "Reseau_Geodesique_Nouvelle_Caledonie_1991", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2987, "epsg", 2987,
        "Saint Pierre et Miquelon 1950 / UTM zone 21N", 0, 0, "Clarke 1866", "Saint_Pierre_et_Miquelon_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2988, "epsg", 2988,
        "MOP78 / UTM zone 1S", 0, 0, "International 1924", "MOP78", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2989, "epsg", 2989,
        "RRAF 1991 / UTM zone 20N (deprecated)", 0, 0, "WGS 84", "Reseau_de_Reference_des_Antilles_Francaises_1991", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2990, "epsg", 2990,
        "Reunion 1947 / TM Reunion (deprecated)", 0, 0, "International 1924", "Reunion_1947", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2991, "epsg", 2991,
        "NAD83 / Oregon LCC (m)", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2992, "epsg", 2992,
        "NAD83 / Oregon GIC Lambert (ft)", 0, 0, "GRS 1980", "North_American_Datum_1983", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=43 +lat_2=45.5 +lat_0=41.75 +lon_0=-120");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2993, "epsg", 2993,
        "NAD83(HARN) / Oregon LCC (m)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=43 +lat_2=45.5 +lat_0=41.75 +lon_0=-120");
    add_proj4text (p, 1,
        ".5 +x_0=400000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,");
    ...
    p = add_epsg_def_ex (filter, first, last, 2994, "epsg", 2994,
        "NAD83(HARN) / Oregon GIC Lambert (ft)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=43 +lat_2=45.5 +lat_0=41.75 +lon_0=-120");
    add_proj4text (p, 1,
        ".5 +x_0=399999.9999984 +y_0=0 +ellps=GRS80 +towgs84=0,0,");
    ...
    p = add_epsg_def_ex (filter, first, last, 2995, "epsg", 2995,
        "IGN53 Mare / UTM zone 58S", 0, 0, "International 1924", "IGN53_Mare", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2996, "epsg", 2996,
        "ST84 Ile des Pins / UTM zone 58S", 0, 0, "International 1924", "ST84_Ile_des_Pins", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=utm +zone=58 +south +ellps=intl +towgs84=-13,-348,");
    add_proj4text (p, 1,
        "292,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2997, "epsg", 2997,
        "ST71 Belep / UTM zone 58S", 0, 0, "International 1924", "ST71_Belep", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2998, "epsg", 2998,
        "NEA74 Noumea / UTM zone 58S", 0, 0, "International 1924", "NEA74_Noumea", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2999, "epsg", 2999,
        "Grand Comoros / UTM zone 38S", 0, 0, "International 1924", "Grand_Comoros", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3000, "epsg", 3000,
        "Segara / NEIEZ", 0, 0, "Bessel 1841", "Gunung_Segara", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=merc +lon_0=110 +k=0.997 +x_0=3900000 +y_0=900000 ");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3001, "epsg", 3001,
        "Batavia / NEIEZ", 0, 0, "Bessel 1841", "Batavia", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=merc +lon_0=110 +k=0.997 +x_0=3900000 +y_0=900000 ");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3002, "epsg", 3002,
        "Makassar / NEIEZ", 0, 0, "Bessel 1841", "Makassar", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=merc +lon_0=110 +k=0.997 +x_0=3900000 +y_0=900000 ");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3003, "epsg", 3003,
        "Monte Mario / Italy zone 1", 0, 0, "International 1924", "Monte_Mario", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3004, "epsg", 3004,
        "Monte Mario / Italy zone 2", 0, 0, "International 1924", "Monte_Mario", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3005, "epsg", 3005,
        "NAD83 / BC Albers", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3019, "epsg", 3019,
        "RT90 7.5 gon V", 0, 1, "Bessel 1841", "Rikets_koordinatsystem_1990", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3020, "epsg", 3020,
        "RT90 5 gon V", 0, 1, "Bessel 1841", "Rikets_koordinatsystem_1990", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3021, "epsg", 3021,
        "RT90 2.5 gon V", 0, 1, "Bessel 1841", "Rikets_koordinatsystem_1990", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3022, "epsg", 3022,
        "RT90 0 gon", 0, 1, "Bessel 1841", "Rikets_koordinatsystem_1990", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3023, "epsg", 3023,
        "RT90 2.5 gon O", 0, 1, "Bessel 1841", "Rikets_koordinatsystem_1990", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3024, "epsg", 3024,
        "RT90 5 gon O", 0, 1, "Bessel 1841", "Rikets_koordinatsystem_1990", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3025, "epsg", 3025,
        "RT38 7.5 gon V", 0, 1, "Bessel 1841", "Stockholm_1938", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=11.30827777777778 +k=1 +x_0=");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3026, "epsg", 3026,
        "RT38 5 gon V", 0, 1, "Bessel 1841", "Stockholm_1938", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=13.55827777777778 +k=1 +x_0=");
    add_proj4text (p, 1,
        "1500000 +y_0=0 +ellps=bessel +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3027, "epsg", 3027,
        "RT38 2.5 gon V", 0, 1, "Bessel 1841", "Stockholm_1938", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=15.80827777777778 +k=1 +x_0=");
    add_proj4text (p, 1,
        "1500000 +y_0=0 +ellps=bessel +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3028, "epsg", 3028,
        "RT38 0 gon", 0, 1, "Bessel 1841", "Stockholm_1938", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=18.05827777777778 +k=1 +x_0=");
    add_proj4text (p, 1,
        "1500000 +y_0=0 +ellps=bessel +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3029, "epsg", 3029,
        "RT38 2.5 gon O", 0, 1, "Bessel 1841", "Stockholm_1938", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=20.30827777777778 +k=1 +x_0=");
    add_proj4text (p, 1,
        "1500000 +y_0=0 +ellps=bessel +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3030, "epsg", 3030,
        "RT38 5 gon O", 0, 1, "Bessel 1841", "Stockholm_1938", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=22.55827777777778 +k=1 +x_0=");
    add_proj4text (p, 1,
        "1500000 +y_0=0 +ellps=bessel +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3031, "epsg", 3031,
        "WGS 84 / Antarctic Polar Stereographic", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3032, "epsg", 3032,
        "WGS 84 / Australian Antarctic Polar Stereographic", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3033, "epsg", 3033,
        "WGS 84 / Australian Antarctic Lambert", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3034, "epsg", 3034,
        "ETRS89 / LCC Europe", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3035, "epsg", 3035,
        "ETRS89 / LAEA Europe", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Y", "North", "X", "East");
    add_proj4text (p, 0,
