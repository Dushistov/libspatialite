...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 3447, "epsg", 3447,
        "ETRS89 / Belgian Lambert 2005", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3448, "epsg", 3448,
        "JAD2001 / Jamaica Metric Grid", 0, 0, "WGS 84", "Jamaica_2001", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3449, "epsg", 3449,
        "JAD2001 / UTM zone 17N", 0, 0, "WGS 84", "Jamaica_2001", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3450, "epsg", 3450,
        "JAD2001 / UTM zone 18N", 0, 0, "WGS 84", "Jamaica_2001", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3451, "epsg", 3451,
        "NAD83 / Louisiana North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3452, "epsg", 3452,
        "NAD83 / Louisiana South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3453, "epsg", 3453,
        "NAD83 / Louisiana Offshore (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3454, "epsg", 3454,
        "NAD83 / South Dakota North (ftUS) (deprecated)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3455, "epsg", 3455,
        "NAD83 / South Dakota South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=44.4 +lat_2=42.83333333333334 +lat_0=42");
    add_proj4text (p, 1,
        ".33333333333334 +lon_0=-100.3333333333333 +x_0=600000 +y");
    ...
    p = add_epsg_def_ex (filter, first, last, 3456, "epsg", 3456,
        "NAD83(HARN) / Louisiana North (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=32.66666666666666 +lat_2=31.16666666666");
    add_proj4text (p, 1,
        "667 +lat_0=30.5 +lon_0=-92.5 +x_0=999999.9999898402 +y_0");
    ...
    p = add_epsg_def_ex (filter, first, last, 3457, "epsg", 3457,
        "NAD83(HARN) / Louisiana South (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=30.7 +lat_2=29.3 +lat_0=28.5 +lon_0=-91");
    add_proj4text (p, 1,
        ".33333333333333 +x_0=999999.9999898402 +y_0=0 +ellps=GRS");
    ...
    p = add_epsg_def_ex (filter, first, last, 3458, "epsg", 3458,
        "NAD83(HARN) / South Dakota North (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3459, "epsg", 3459,
        "NAD83(HARN) / South Dakota South (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=44.4 +lat_2=42.83333333333334 +lat_0=42");
    add_proj4text (p, 1,
        ".33333333333334 +lon_0=-100.3333333333333 +x_0=600000 +y");
    ...
    p = add_epsg_def_ex (filter, first, last, 3460, "epsg", 3460,
        "Fiji 1986 / Fiji Map Grid", 0, 0, "WGS 72", "Fiji_Geodetic_Datum_1986", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3461, "epsg", 3461,
        "Dabola 1981 / UTM zone 28N", 0, 0, "Clarke 1880 (IGN)", "Dabola_1981", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3462, "epsg", 3462,
        "Dabola 1981 / UTM zone 29N", 0, 0, "Clarke 1880 (IGN)", "Dabola_1981", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3463, "epsg", 3463,
        "NAD83 / Maine CS2000 Central", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3464, "epsg", 3464,
        "NAD83(HARN) / Maine CS2000 Central", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=43.5 +lon_0=-69.125 +k=0.99998 +x_0=5");
    add_proj4text (p, 1,
        "00000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=");
    ...
    p = add_epsg_def_ex (filter, first, last, 3465, "epsg", 3465,
        "NAD83(NSRS2007) / Alabama East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3466, "epsg", 3466,
        "NAD83(NSRS2007) / Alabama West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3467, "epsg", 3467,
        "NAD83(NSRS2007) / Alaska Albers", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3468, "epsg", 3468,
        "NAD83(NSRS2007) / Alaska zone 1", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3469, "epsg", 3469,
        "NAD83(NSRS2007) / Alaska zone 2", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3470, "epsg", 3470,
        "NAD83(NSRS2007) / Alaska zone 3", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3471, "epsg", 3471,
        "NAD83(NSRS2007) / Alaska zone 4", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3472, "epsg", 3472,
        "NAD83(NSRS2007) / Alaska zone 5", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3473, "epsg", 3473,
        "NAD83(NSRS2007) / Alaska zone 6", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3474, "epsg", 3474,
        "NAD83(NSRS2007) / Alaska zone 7", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3475, "epsg", 3475,
        "NAD83(NSRS2007) / Alaska zone 8", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3476, "epsg", 3476,
        "NAD83(NSRS2007) / Alaska zone 9", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3477, "epsg", 3477,
        "NAD83(NSRS2007) / Alaska zone 10", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3478, "epsg", 3478,
        "NAD83(NSRS2007) / Arizona Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3479, "epsg", 3479,
        "NAD83(NSRS2007) / Arizona Central (ft)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=31 +lon_0=-111.9166666666667 +k=0.999");
    add_proj4text (p, 1,
        "9 +x_0=213360 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0");
    ...
    p = add_epsg_def_ex (filter, first, last, 3480, "epsg", 3480,
        "NAD83(NSRS2007) / Arizona East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3481, "epsg", 3481,
        "NAD83(NSRS2007) / Arizona East (ft)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=31 +lon_0=-110.1666666666667 +k=0.999");
    add_proj4text (p, 1,
        "9 +x_0=213360 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0");
    ...
    p = add_epsg_def_ex (filter, first, last, 3482, "epsg", 3482,
        "NAD83(NSRS2007) / Arizona West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3483, "epsg", 3483,
        "NAD83(NSRS2007) / Arizona West (ft)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=31 +lon_0=-113.75 +k=0.999933333 +x_0");
    add_proj4text (p, 1,
        "=213360 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +unit");
    ...
    p = add_epsg_def_ex (filter, first, last, 3484, "epsg", 3484,
        "NAD83(NSRS2007) / Arkansas North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3485, "epsg", 3485,
        "NAD83(NSRS2007) / Arkansas North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=36.23333333333333 +lat_2=34.93333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3486, "epsg", 3486,
        "NAD83(NSRS2007) / Arkansas South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3487, "epsg", 3487,
        "NAD83(NSRS2007) / Arkansas South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=34.76666666666667 +lat_2=33.3 +lat_0=32");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3488, "epsg", 3488,
        "NAD83(NSRS2007) / California Albers", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3489, "epsg", 3489,
        "NAD83(NSRS2007) / California zone 1", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3490, "epsg", 3490,
        "NAD83(NSRS2007) / California zone 1 (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=41.66666666666666 +lat_2=40 +lat_0=39.3");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3491, "epsg", 3491,
        "NAD83(NSRS2007) / California zone 2", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3492, "epsg", 3492,
        "NAD83(NSRS2007) / California zone 2 (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=39.83333333333334 +lat_2=38.33333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3493, "epsg", 3493,
        "NAD83(NSRS2007) / California zone 3", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3494, "epsg", 3494,
        "NAD83(NSRS2007) / California zone 3 (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=38.43333333333333 +lat_2=37.06666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3495, "epsg", 3495,
        "NAD83(NSRS2007) / California zone 4", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3496, "epsg", 3496,
        "NAD83(NSRS2007) / California zone 4 (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=37.25 +lat_2=36 +lat_0=35.3333333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3497, "epsg", 3497,
        "NAD83(NSRS2007) / California zone 5", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3498, "epsg", 3498,
        "NAD83(NSRS2007) / California zone 5 (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=35.46666666666667 +lat_2=34.03333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3499, "epsg", 3499,
        "NAD83(NSRS2007) / California zone 6", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3500, "epsg", 3500,
        "NAD83(NSRS2007) / California zone 6 (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=33.88333333333333 +lat_2=32.78333333333");
    add_proj4text (p, 1,
        "333 +lat_0=32.16666666666666 +lon_0=-116.25 +x_0=2000000");
    ...
    p = add_epsg_def_ex (filter, first, last, 3501, "epsg", 3501,
        "NAD83(NSRS2007) / Colorado Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3502, "epsg", 3502,
        "NAD83(NSRS2007) / Colorado Central (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=39.75 +lat_2=38.45 +lat_0=37.8333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3503, "epsg", 3503,
        "NAD83(NSRS2007) / Colorado North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3504, "epsg", 3504,
        "NAD83(NSRS2007) / Colorado North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=40.78333333333333 +lat_2=39.71666666666");
    add_proj4text (p, 1,
        "667 +lat_0=39.33333333333334 +lon_0=-105.5 +x_0=914401.8");
    ...
    p = add_epsg_def_ex (filter, first, last, 3505, "epsg", 3505,
        "NAD83(NSRS2007) / Colorado South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3506, "epsg", 3506,
        "NAD83(NSRS2007) / Colorado South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=38.43333333333333 +lat_2=37.23333333333");
    add_proj4text (p, 1,
        "333 +lat_0=36.66666666666666 +lon_0=-105.5 +x_0=914401.8");
    ...
    p = add_epsg_def_ex (filter, first, last, 3507, "epsg", 3507,
        "NAD83(NSRS2007) / Connecticut", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3508, "epsg", 3508,
        "NAD83(NSRS2007) / Connecticut (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=41.86666666666667 +lat_2=41.2 +lat_0=40");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3509, "epsg", 3509,
        "NAD83(NSRS2007) / Delaware", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3510, "epsg", 3510,
        "NAD83(NSRS2007) / Delaware (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38 +lon_0=-75.41666666666667 +k=0.999");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3511, "epsg", 3511,
        "NAD83(NSRS2007) / Florida East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3512, "epsg", 3512,
        "NAD83(NSRS2007) / Florida East (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=24.33333333333333 +lon_0=-81 +k=0.999");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3513, "epsg", 3513,
        "NAD83(NSRS2007) / Florida GDL Albers", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3514, "epsg", 3514,
        "NAD83(NSRS2007) / Florida North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3515, "epsg", 3515,
        "NAD83(NSRS2007) / Florida North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=30.75 +lat_2=29.58333333333333 +lat_0=2");
    add_proj4text (p, 1,
        "9 +lon_0=-84.5 +x_0=600000 +y_0=0 +ellps=GRS80 +towgs84=");
    ...
    p = add_epsg_def_ex (filter, first, last, 3516, "epsg", 3516,
        "NAD83(NSRS2007) / Florida West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3517, "epsg", 3517,
        "NAD83(NSRS2007) / Florida West (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=24.33333333333333 +lon_0=-82 +k=0.999");
    add_proj4text (p, 1,
        "941177 +x_0=200000.0001016002 +y_0=0 +ellps=GRS80 +towgs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3518, "epsg", 3518,
        "NAD83(NSRS2007) / Georgia East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3519, "epsg", 3519,
        "NAD83(NSRS2007) / Georgia East (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=30 +lon_0=-82.16666666666667 +k=0.999");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3520, "epsg", 3520,
        "NAD83(NSRS2007) / Georgia West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3521, "epsg", 3521,
        "NAD83(NSRS2007) / Georgia West (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=30 +lon_0=-84.16666666666667 +k=0.999");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3522, "epsg", 3522,
        "NAD83(NSRS2007) / Idaho Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3523, "epsg", 3523,
        "NAD83(NSRS2007) / Idaho Central (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=41.66666666666666 +lon_0=-114 +k=0.99");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3524, "epsg", 3524,
        "NAD83(NSRS2007) / Idaho East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3525, "epsg", 3525,
        "NAD83(NSRS2007) / Idaho East (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=41.66666666666666 +lon_0=-112.1666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3526, "epsg", 3526,
        "NAD83(NSRS2007) / Idaho West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3527, "epsg", 3527,
        "NAD83(NSRS2007) / Idaho West (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=41.66666666666666 +lon_0=-115.75 +k=0");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3528, "epsg", 3528,
        "NAD83(NSRS2007) / Illinois East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3529, "epsg", 3529,
        "NAD83(NSRS2007) / Illinois East (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=36.66666666666666 +lon_0=-88.33333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3530, "epsg", 3530,
        "NAD83(NSRS2007) / Illinois West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3531, "epsg", 3531,
        "NAD83(NSRS2007) / Illinois West (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=36.66666666666666 +lon_0=-90.16666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3532, "epsg", 3532,
        "NAD83(NSRS2007) / Indiana East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3533, "epsg", 3533,
        "NAD83(NSRS2007) / Indiana East (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=37.5 +lon_0=-85.66666666666667 +k=0.9");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3534, "epsg", 3534,
        "NAD83(NSRS2007) / Indiana West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3535, "epsg", 3535,
        "NAD83(NSRS2007) / Indiana West (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=37.5 +lon_0=-87.08333333333333 +k=0.9");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3536, "epsg", 3536,
        "NAD83(NSRS2007) / Iowa North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3537, "epsg", 3537,
        "NAD83(NSRS2007) / Iowa North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=43.26666666666667 +lat_2=42.06666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3538, "epsg", 3538,
        "NAD83(NSRS2007) / Iowa South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3539, "epsg", 3539,
        "NAD83(NSRS2007) / Iowa South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=41.78333333333333 +lat_2=40.61666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3540, "epsg", 3540,
        "NAD83(NSRS2007) / Kansas North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3541, "epsg", 3541,
        "NAD83(NSRS2007) / Kansas North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=39.78333333333333 +lat_2=38.71666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3542, "epsg", 3542,
        "NAD83(NSRS2007) / Kansas South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3543, "epsg", 3543,
        "NAD83(NSRS2007) / Kansas South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=38.56666666666667 +lat_2=37.26666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3544, "epsg", 3544,
        "NAD83(NSRS2007) / Kentucky North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3545, "epsg", 3545,
        "NAD83(NSRS2007) / Kentucky North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=37.96666666666667 +lat_2=38.96666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3546, "epsg", 3546,
        "NAD83(NSRS2007) / Kentucky Single Zone", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3547, "epsg", 3547,
        "NAD83(NSRS2007) / Kentucky Single Zone (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=37.08333333333334 +lat_2=38.66666666666");
    add_proj4text (p, 1,
        "666 +lat_0=36.33333333333334 +lon_0=-85.75 +x_0=1500000 ");
