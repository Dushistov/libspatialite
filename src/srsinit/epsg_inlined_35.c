...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 21459, "epsg", 21459,
        "Beijing 1954 / Gauss-Kruger CM 111E", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21460, "epsg", 21460,
        "Beijing 1954 / Gauss-Kruger CM 117E", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21461, "epsg", 21461,
        "Beijing 1954 / Gauss-Kruger CM 123E", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21462, "epsg", 21462,
        "Beijing 1954 / Gauss-Kruger CM 129E", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21463, "epsg", 21463,
        "Beijing 1954 / Gauss-Kruger CM 135E", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21473, "epsg", 21473,
        "Beijing 1954 / Gauss-Kruger 13N (deprecated)", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21474, "epsg", 21474,
        "Beijing 1954 / Gauss-Kruger 14N (deprecated)", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21475, "epsg", 21475,
        "Beijing 1954 / Gauss-Kruger 15N (deprecated)", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21476, "epsg", 21476,
        "Beijing 1954 / Gauss-Kruger 16N (deprecated)", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21477, "epsg", 21477,
        "Beijing 1954 / Gauss-Kruger 17N (deprecated)", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21478, "epsg", 21478,
        "Beijing 1954 / Gauss-Kruger 18N (deprecated)", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21479, "epsg", 21479,
        "Beijing 1954 / Gauss-Kruger 19N (deprecated)", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=111 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=m");
    ...
    p = add_epsg_def_ex (filter, first, last, 21480, "epsg", 21480,
        "Beijing 1954 / Gauss-Kruger 20N (deprecated)", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=117 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=m");
    ...
    p = add_epsg_def_ex (filter, first, last, 21481, "epsg", 21481,
        "Beijing 1954 / Gauss-Kruger 21N (deprecated)", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=123 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=m");
    ...
    p = add_epsg_def_ex (filter, first, last, 21482, "epsg", 21482,
        "Beijing 1954 / Gauss-Kruger 22N (deprecated)", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=129 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=m");
    ...
    p = add_epsg_def_ex (filter, first, last, 21483, "epsg", 21483,
        "Beijing 1954 / Gauss-Kruger 23N (deprecated)", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=135 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=m");
    ...
    p = add_epsg_def_ex (filter, first, last, 21500, "epsg", 21500,
        "Belge 1950 (Brussels) / Belge Lambert 50", 0, 0, "International 1924", "Reseau_National_Belge_1950_Brussels", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21780, "epsg", 21780,
        "Bern 1898 (Bern) / LV03C", 0, 0, "Bessel 1841", "CH1903_Bern", "metre", "Y", "East", "X", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21781, "epsg", 21781,
        "CH1903 / LV03", 0, 0, "Bessel 1841", "CH1903", "metre", "Y", "East", "X", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21782, "epsg", 21782,
        "CH1903 / LV03C-G", 0, 0, "Bessel 1841", "CH1903", "metre", "Y", "East", "X", "North");
    add_proj4text (p, 0,
        "+proj=somerc +lat_0=46.95240555555556 +lon_0=7.439583333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 21817, "epsg", 21817,
        "Bogota 1975 / UTM zone 17N (deprecated)", 0, 0, "International 1924", "Bogota_1975", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21818, "epsg", 21818,
        "Bogota 1975 / UTM zone 18N", 0, 0, "International 1924", "Bogota_1975", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21891, "epsg", 21891,
        "Bogota 1975 / Colombia West zone (deprecated)", 0, 0, "International 1924", "Bogota_1975", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21892, "epsg", 21892,
        "Bogota 1975 / Colombia Bogota zone (deprecated)", 0, 0, "International 1924", "Bogota_1975", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21893, "epsg", 21893,
        "Bogota 1975 / Colombia East Central zone (deprecated)", 0, 0, "International 1924", "Bogota_1975", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21894, "epsg", 21894,
        "Bogota 1975 / Colombia East (deprecated)", 0, 0, "International 1924", "Bogota_1975", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 21896, "epsg", 21896,
        "Bogota 1975 / Colombia West zone", 0, 1, "International 1924", "Bogota_1975", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=4.599047222222222 +lon_0=-77.08091666");
    add_proj4text (p, 1,
        "666667 +k=1 +x_0=1000000 +y_0=1000000 +ellps=intl +towgs");
    ...
    p = add_epsg_def_ex (filter, first, last, 21897, "epsg", 21897,
        "Bogota 1975 / Colombia Bogota zone", 0, 1, "International 1924", "Bogota_1975", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=4.599047222222222 +lon_0=-74.08091666");
    add_proj4text (p, 1,
        "666667 +k=1 +x_0=1000000 +y_0=1000000 +ellps=intl +towgs");
    ...
    p = add_epsg_def_ex (filter, first, last, 21898, "epsg", 21898,
        "Bogota 1975 / Colombia East Central zone", 0, 1, "International 1924", "Bogota_1975", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=4.599047222222222 +lon_0=-71.08091666");
    add_proj4text (p, 1,
        "666667 +k=1 +x_0=1000000 +y_0=1000000 +ellps=intl +towgs");
    ...
    p = add_epsg_def_ex (filter, first, last, 21899, "epsg", 21899,
        "Bogota 1975 / Colombia East", 0, 1, "International 1924", "Bogota_1975", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=4.599047222222222 +lon_0=-68.08091666");
    add_proj4text (p, 1,
        "666667 +k=1 +x_0=1000000 +y_0=1000000 +ellps=intl +towgs");
    ...
    p = add_epsg_def_ex (filter, first, last, 22032, "epsg", 22032,
        "Camacupa / UTM zone 32S", 0, 0, "Clarke 1880 (RGS)", "Camacupa", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22033, "epsg", 22033,
        "Camacupa / UTM zone 33S", 0, 0, "Clarke 1880 (RGS)", "Camacupa", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22091, "epsg", 22091,
        "Camacupa / TM 11.30 SE", 0, 0, "Clarke 1880 (RGS)", "Camacupa", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22092, "epsg", 22092,
        "Camacupa / TM 12 SE", 0, 0, "Clarke 1880 (RGS)", "Camacupa", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22171, "epsg", 22171,
        "POSGAR 98 / Argentina 1", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_1998", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22172, "epsg", 22172,
        "POSGAR 98 / Argentina 2", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_1998", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22173, "epsg", 22173,
        "POSGAR 98 / Argentina 3", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_1998", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22174, "epsg", 22174,
        "POSGAR 98 / Argentina 4", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_1998", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22175, "epsg", 22175,
        "POSGAR 98 / Argentina 5", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_1998", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22176, "epsg", 22176,
        "POSGAR 98 / Argentina 6", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_1998", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22177, "epsg", 22177,
        "POSGAR 98 / Argentina 7", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_1998", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22181, "epsg", 22181,
        "POSGAR 94 / Argentina 1", 0, 1, "WGS 84", "Posiciones_Geodesicas_Argentinas_1994", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-72 +k=1 +x_0=1500000 +y_0");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 22182, "epsg", 22182,
        "POSGAR 94 / Argentina 2", 0, 1, "WGS 84", "Posiciones_Geodesicas_Argentinas_1994", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-69 +k=1 +x_0=2500000 +y_0");
    add_proj4text (p, 1,
        "=0 +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 22183, "epsg", 22183,
        "POSGAR 94 / Argentina 3", 0, 1, "WGS 84", "Posiciones_Geodesicas_Argentinas_1994", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-66 +k=1 +x_0=3500000 +y_0");
    add_proj4text (p, 1,
        "=0 +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 22184, "epsg", 22184,
        "POSGAR 94 / Argentina 4", 0, 1, "WGS 84", "Posiciones_Geodesicas_Argentinas_1994", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-63 +k=1 +x_0=4500000 +y_0");
    add_proj4text (p, 1,
        "=0 +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 22185, "epsg", 22185,
        "POSGAR 94 / Argentina 5", 0, 1, "WGS 84", "Posiciones_Geodesicas_Argentinas_1994", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-60 +k=1 +x_0=5500000 +y_0");
    add_proj4text (p, 1,
        "=0 +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 22186, "epsg", 22186,
        "POSGAR 94 / Argentina 6", 0, 1, "WGS 84", "Posiciones_Geodesicas_Argentinas_1994", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-57 +k=1 +x_0=6500000 +y_0");
    add_proj4text (p, 1,
        "=0 +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 22187, "epsg", 22187,
        "POSGAR 94 / Argentina 7", 0, 1, "WGS 84", "Posiciones_Geodesicas_Argentinas_1994", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-54 +k=1 +x_0=7500000 +y_0");
    add_proj4text (p, 1,
        "=0 +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 22191, "epsg", 22191,
        "Campo Inchauspe / Argentina 1", 0, 1, "International 1924", "Campo_Inchauspe", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-72 +k=1 +x_0=1500000 +y_0");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 22192, "epsg", 22192,
        "Campo Inchauspe / Argentina 2", 0, 1, "International 1924", "Campo_Inchauspe", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-69 +k=1 +x_0=2500000 +y_0");
    add_proj4text (p, 1,
        "=0 +ellps=intl +towgs84=-148,136,90,0,0,0,0 +units=m +no");
    ...
    p = add_epsg_def_ex (filter, first, last, 22193, "epsg", 22193,
        "Campo Inchauspe / Argentina 3", 0, 1, "International 1924", "Campo_Inchauspe", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-66 +k=1 +x_0=3500000 +y_0");
    add_proj4text (p, 1,
        "=0 +ellps=intl +towgs84=-148,136,90,0,0,0,0 +units=m +no");
    ...
    p = add_epsg_def_ex (filter, first, last, 22194, "epsg", 22194,
        "Campo Inchauspe / Argentina 4", 0, 1, "International 1924", "Campo_Inchauspe", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-63 +k=1 +x_0=4500000 +y_0");
    add_proj4text (p, 1,
        "=0 +ellps=intl +towgs84=-148,136,90,0,0,0,0 +units=m +no");
    ...
    p = add_epsg_def_ex (filter, first, last, 22195, "epsg", 22195,
        "Campo Inchauspe / Argentina 5", 0, 1, "International 1924", "Campo_Inchauspe", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-60 +k=1 +x_0=5500000 +y_0");
    add_proj4text (p, 1,
        "=0 +ellps=intl +towgs84=-148,136,90,0,0,0,0 +units=m +no");
    ...
    p = add_epsg_def_ex (filter, first, last, 22196, "epsg", 22196,
        "Campo Inchauspe / Argentina 6", 0, 1, "International 1924", "Campo_Inchauspe", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-57 +k=1 +x_0=6500000 +y_0");
    add_proj4text (p, 1,
        "=0 +ellps=intl +towgs84=-148,136,90,0,0,0,0 +units=m +no");
    ...
    p = add_epsg_def_ex (filter, first, last, 22197, "epsg", 22197,
        "Campo Inchauspe / Argentina 7", 0, 1, "International 1924", "Campo_Inchauspe", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-54 +k=1 +x_0=7500000 +y_0");
    add_proj4text (p, 1,
        "=0 +ellps=intl +towgs84=-148,136,90,0,0,0,0 +units=m +no");
    ...
    p = add_epsg_def_ex (filter, first, last, 22234, "epsg", 22234,
        "Cape / UTM zone 34S", 0, 0, "Clarke 1880 (Arc)", "Cape", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22235, "epsg", 22235,
        "Cape / UTM zone 35S", 0, 0, "Clarke 1880 (Arc)", "Cape", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22236, "epsg", 22236,
        "Cape / UTM zone 36S (deprecated)", 0, 0, "Clarke 1880 (Arc)", "Cape", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22275, "epsg", 22275,
        "Cape / Lo15", 0, 0, "Clarke 1880 (Arc)", "Cape", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22277, "epsg", 22277,
        "Cape / Lo17", 0, 0, "Clarke 1880 (Arc)", "Cape", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22279, "epsg", 22279,
        "Cape / Lo19", 0, 0, "Clarke 1880 (Arc)", "Cape", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22281, "epsg", 22281,
        "Cape / Lo21", 0, 0, "Clarke 1880 (Arc)", "Cape", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22283, "epsg", 22283,
        "Cape / Lo23", 0, 0, "Clarke 1880 (Arc)", "Cape", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22285, "epsg", 22285,
        "Cape / Lo25", 0, 0, "Clarke 1880 (Arc)", "Cape", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22287, "epsg", 22287,
        "Cape / Lo27", 0, 0, "Clarke 1880 (Arc)", "Cape", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22289, "epsg", 22289,
        "Cape / Lo29", 0, 0, "Clarke 1880 (Arc)", "Cape", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22291, "epsg", 22291,
        "Cape / Lo31", 0, 0, "Clarke 1880 (Arc)", "Cape", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22293, "epsg", 22293,
        "Cape / Lo33", 0, 0, "Clarke 1880 (Arc)", "Cape", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22332, "epsg", 22332,
        "Carthage / UTM zone 32N", 0, 0, "Clarke 1880 (IGN)", "Carthage", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22391, "epsg", 22391,
        "Carthage / Nord Tunisie", 0, 0, "Clarke 1880 (IGN)", "Carthage", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22392, "epsg", 22392,
        "Carthage / Sud Tunisie", 0, 0, "Clarke 1880 (IGN)", "Carthage", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22521, "epsg", 22521,
        "Corrego Alegre 1970-72 / UTM zone 21S", 0, 0, "International 1924", "Corrego_Alegre_1970_72", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22522, "epsg", 22522,
        "Corrego Alegre 1970-72 / UTM zone 22S", 0, 0, "International 1924", "Corrego_Alegre_1970_72", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22523, "epsg", 22523,
        "Corrego Alegre 1970-72 / UTM zone 23S", 0, 0, "International 1924", "Corrego_Alegre_1970_72", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22524, "epsg", 22524,
        "Corrego Alegre 1970-72 / UTM zone 24S", 0, 0, "International 1924", "Corrego_Alegre_1970_72", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22525, "epsg", 22525,
        "Corrego Alegre 1970-72 / UTM zone 25S", 0, 0, "International 1924", "Corrego_Alegre_1970_72", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22700, "epsg", 22700,
        "Deir ez Zor / Levant Zone", 0, 0, "Clarke 1880 (IGN)", "Deir_ez_Zor", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22770, "epsg", 22770,
        "Deir ez Zor / Syria Lambert", 0, 0, "Clarke 1880 (IGN)", "Deir_ez_Zor", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=34.65 +lat_0=34.65 +lon_0=37.35 +k_0=0.");
    add_proj4text (p, 1,
        "9996256 +x_0=300000 +y_0=300000 +a=6378249.2 +b=6356515 ");
    ...
    p = add_epsg_def_ex (filter, first, last, 22780, "epsg", 22780,
        "Deir ez Zor / Levant Stereographic", 0, 0, "Clarke 1880 (IGN)", "Deir_ez_Zor", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22832, "epsg", 22832,
        "Douala / UTM zone 32N (deprecated)", 0, 0, "Clarke 1880 (IGN)", "Douala", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22991, "epsg", 22991,
        "Egypt 1907 / Blue Belt", 0, 0, "Helmert 1906", "Egypt_1907", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22992, "epsg", 22992,
        "Egypt 1907 / Red Belt", 0, 0, "Helmert 1906", "Egypt_1907", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22993, "epsg", 22993,
        "Egypt 1907 / Purple Belt", 0, 0, "Helmert 1906", "Egypt_1907", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 22994, "epsg", 22994,
        "Egypt 1907 / Extended Purple Belt", 0, 0, "Helmert 1906", "Egypt_1907", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23028, "epsg", 23028,
        "ED50 / UTM zone 28N", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23029, "epsg", 23029,
        "ED50 / UTM zone 29N", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23030, "epsg", 23030,
        "ED50 / UTM zone 30N", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23031, "epsg", 23031,
        "ED50 / UTM zone 31N", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23032, "epsg", 23032,
        "ED50 / UTM zone 32N", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23033, "epsg", 23033,
        "ED50 / UTM zone 33N", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23034, "epsg", 23034,
        "ED50 / UTM zone 34N", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23035, "epsg", 23035,
        "ED50 / UTM zone 35N", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23036, "epsg", 23036,
        "ED50 / UTM zone 36N", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23037, "epsg", 23037,
        "ED50 / UTM zone 37N", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23038, "epsg", 23038,
        "ED50 / UTM zone 38N", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23090, "epsg", 23090,
        "ED50 / TM 0 N", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23095, "epsg", 23095,
        "ED50 / TM 5 NE", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23239, "epsg", 23239,
        "Fahud / UTM zone 39N", 0, 0, "Clarke 1880 (RGS)", "Fahud", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23240, "epsg", 23240,
        "Fahud / UTM zone 40N", 0, 0, "Clarke 1880 (RGS)", "Fahud", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23433, "epsg", 23433,
        "Garoua / UTM zone 33N (deprecated)", 0, 0, "Clarke 1880 (IGN)", "Garoua", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 23700, "epsg", 23700,
        "HD72 / EOV", 0, 0, "GRS 1967", "Hungarian_Datum_1972", "metre", "Y", "East", "X", "North");
    add_proj4text (p, 0,
