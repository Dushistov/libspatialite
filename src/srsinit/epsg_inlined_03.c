...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 2325, "epsg", 2325,
        "ED50 / TM45", 0, 1, "International 1924", "European_Datum_1950", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2326, "epsg", 2326,
        "Hong Kong 1980 Grid System", 0, 1, "International 1924", "Hong_Kong_1980", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2327, "epsg", 2327,
        "Xian 1980 / Gauss-Kruger zone 13", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2328, "epsg", 2328,
        "Xian 1980 / Gauss-Kruger zone 14", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2329, "epsg", 2329,
        "Xian 1980 / Gauss-Kruger zone 15", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2330, "epsg", 2330,
        "Xian 1980 / Gauss-Kruger zone 16", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2331, "epsg", 2331,
        "Xian 1980 / Gauss-Kruger zone 17", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2332, "epsg", 2332,
        "Xian 1980 / Gauss-Kruger zone 18", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2333, "epsg", 2333,
        "Xian 1980 / Gauss-Kruger zone 19", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2334, "epsg", 2334,
        "Xian 1980 / Gauss-Kruger zone 20", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2335, "epsg", 2335,
        "Xian 1980 / Gauss-Kruger zone 21", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2336, "epsg", 2336,
        "Xian 1980 / Gauss-Kruger zone 22", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2337, "epsg", 2337,
        "Xian 1980 / Gauss-Kruger zone 23", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2338, "epsg", 2338,
        "Xian 1980 / Gauss-Kruger CM 75E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2339, "epsg", 2339,
        "Xian 1980 / Gauss-Kruger CM 81E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2340, "epsg", 2340,
        "Xian 1980 / Gauss-Kruger CM 87E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2341, "epsg", 2341,
        "Xian 1980 / Gauss-Kruger CM 93E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2342, "epsg", 2342,
        "Xian 1980 / Gauss-Kruger CM 99E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2343, "epsg", 2343,
        "Xian 1980 / Gauss-Kruger CM 105E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2344, "epsg", 2344,
        "Xian 1980 / Gauss-Kruger CM 111E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2345, "epsg", 2345,
        "Xian 1980 / Gauss-Kruger CM 117E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2346, "epsg", 2346,
        "Xian 1980 / Gauss-Kruger CM 123E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2347, "epsg", 2347,
        "Xian 1980 / Gauss-Kruger CM 129E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2348, "epsg", 2348,
        "Xian 1980 / Gauss-Kruger CM 135E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2349, "epsg", 2349,
        "Xian 1980 / 3-degree Gauss-Kruger zone 25", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2350, "epsg", 2350,
        "Xian 1980 / 3-degree Gauss-Kruger zone 26", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2351, "epsg", 2351,
        "Xian 1980 / 3-degree Gauss-Kruger zone 27", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2352, "epsg", 2352,
        "Xian 1980 / 3-degree Gauss-Kruger zone 28", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2353, "epsg", 2353,
        "Xian 1980 / 3-degree Gauss-Kruger zone 29", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2354, "epsg", 2354,
        "Xian 1980 / 3-degree Gauss-Kruger zone 30", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2355, "epsg", 2355,
        "Xian 1980 / 3-degree Gauss-Kruger zone 31", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2356, "epsg", 2356,
        "Xian 1980 / 3-degree Gauss-Kruger zone 32", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2357, "epsg", 2357,
        "Xian 1980 / 3-degree Gauss-Kruger zone 33", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2358, "epsg", 2358,
        "Xian 1980 / 3-degree Gauss-Kruger zone 34", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2359, "epsg", 2359,
        "Xian 1980 / 3-degree Gauss-Kruger zone 35", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2360, "epsg", 2360,
        "Xian 1980 / 3-degree Gauss-Kruger zone 36", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2361, "epsg", 2361,
        "Xian 1980 / 3-degree Gauss-Kruger zone 37", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2362, "epsg", 2362,
        "Xian 1980 / 3-degree Gauss-Kruger zone 38", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2363, "epsg", 2363,
        "Xian 1980 / 3-degree Gauss-Kruger zone 39", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2364, "epsg", 2364,
        "Xian 1980 / 3-degree Gauss-Kruger zone 40", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2365, "epsg", 2365,
        "Xian 1980 / 3-degree Gauss-Kruger zone 41", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2366, "epsg", 2366,
        "Xian 1980 / 3-degree Gauss-Kruger zone 42", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2367, "epsg", 2367,
        "Xian 1980 / 3-degree Gauss-Kruger zone 43", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2368, "epsg", 2368,
        "Xian 1980 / 3-degree Gauss-Kruger zone 44", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2369, "epsg", 2369,
        "Xian 1980 / 3-degree Gauss-Kruger zone 45", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2370, "epsg", 2370,
        "Xian 1980 / 3-degree Gauss-Kruger CM 75E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=75 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "a=6378140 +b=6356755.288157528 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2371, "epsg", 2371,
        "Xian 1980 / 3-degree Gauss-Kruger CM 78E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2372, "epsg", 2372,
        "Xian 1980 / 3-degree Gauss-Kruger CM 81E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=81 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "a=6378140 +b=6356755.288157528 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2373, "epsg", 2373,
        "Xian 1980 / 3-degree Gauss-Kruger CM 84E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2374, "epsg", 2374,
        "Xian 1980 / 3-degree Gauss-Kruger CM 87E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=87 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "a=6378140 +b=6356755.288157528 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2375, "epsg", 2375,
        "Xian 1980 / 3-degree Gauss-Kruger CM 90E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2376, "epsg", 2376,
        "Xian 1980 / 3-degree Gauss-Kruger CM 93E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=93 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "a=6378140 +b=6356755.288157528 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2377, "epsg", 2377,
        "Xian 1980 / 3-degree Gauss-Kruger CM 96E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2378, "epsg", 2378,
        "Xian 1980 / 3-degree Gauss-Kruger CM 99E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=99 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "a=6378140 +b=6356755.288157528 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2379, "epsg", 2379,
        "Xian 1980 / 3-degree Gauss-Kruger CM 102E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2380, "epsg", 2380,
        "Xian 1980 / 3-degree Gauss-Kruger CM 105E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=105 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+a=6378140 +b=6356755.288157528 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2381, "epsg", 2381,
        "Xian 1980 / 3-degree Gauss-Kruger CM 108E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2382, "epsg", 2382,
        "Xian 1980 / 3-degree Gauss-Kruger CM 111E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=111 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+a=6378140 +b=6356755.288157528 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2383, "epsg", 2383,
        "Xian 1980 / 3-degree Gauss-Kruger CM 114E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2384, "epsg", 2384,
        "Xian 1980 / 3-degree Gauss-Kruger CM 117E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=117 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+a=6378140 +b=6356755.288157528 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2385, "epsg", 2385,
        "Xian 1980 / 3-degree Gauss-Kruger CM 120E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2386, "epsg", 2386,
        "Xian 1980 / 3-degree Gauss-Kruger CM 123E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=123 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+a=6378140 +b=6356755.288157528 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2387, "epsg", 2387,
        "Xian 1980 / 3-degree Gauss-Kruger CM 126E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2388, "epsg", 2388,
        "Xian 1980 / 3-degree Gauss-Kruger CM 129E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=129 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+a=6378140 +b=6356755.288157528 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2389, "epsg", 2389,
        "Xian 1980 / 3-degree Gauss-Kruger CM 132E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2390, "epsg", 2390,
        "Xian 1980 / 3-degree Gauss-Kruger CM 135E", 0, 1, "IAG 1975", "Xian_1980", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=135 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+a=6378140 +b=6356755.288157528 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2391, "epsg", 2391,
        "KKJ / Finland zone 1", 0, 1, "International 1924", "Kartastokoordinaattijarjestelma_1966", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2392, "epsg", 2392,
        "KKJ / Finland zone 2", 0, 1, "International 1924", "Kartastokoordinaattijarjestelma_1966", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2394, "epsg", 2394,
        "KKJ / Finland zone 4", 0, 1, "International 1924", "Kartastokoordinaattijarjestelma_1966", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2395, "epsg", 2395,
        "South Yemen / Gauss-Kruger zone 8", 0, 1, "Krassowsky 1940", "South_Yemen", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2396, "epsg", 2396,
        "South Yemen / Gauss-Kruger zone 9", 0, 1, "Krassowsky 1940", "South_Yemen", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2397, "epsg", 2397,
        "Pulkovo 1942(83) / 3-degree Gauss-Kruger zone 3", 0, 1, "Krassowsky 1940", "Pulkovo_1942_83", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2398, "epsg", 2398,
        "Pulkovo 1942(83) / 3-degree Gauss-Kruger zone 4", 0, 1, "Krassowsky 1940", "Pulkovo_1942_83", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2399, "epsg", 2399,
        "Pulkovo 1942(83) / 3-degree Gauss-Kruger zone 5", 0, 1, "Krassowsky 1940", "Pulkovo_1942_83", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2400, "epsg", 2400,
        "RT90 2.5 gon W (deprecated)", 0, 1, "Bessel 1841", "Rikets_koordinatsystem_1990", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2401, "epsg", 2401,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 25", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=75 +k=1 +x_0=25500000 +y_0=0");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2402, "epsg", 2402,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 26", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=78 +k=1 +x_0=26500000 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=");
    ...
    p = add_epsg_def_ex (filter, first, last, 2403, "epsg", 2403,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 27", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=81 +k=1 +x_0=27500000 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=");
    ...
    p = add_epsg_def_ex (filter, first, last, 2404, "epsg", 2404,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 28", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=84 +k=1 +x_0=28500000 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=");
    ...
    p = add_epsg_def_ex (filter, first, last, 2405, "epsg", 2405,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 29", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=87 +k=1 +x_0=29500000 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=");
    ...
    p = add_epsg_def_ex (filter, first, last, 2406, "epsg", 2406,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 30", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=90 +k=1 +x_0=30500000 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=");
    ...
    p = add_epsg_def_ex (filter, first, last, 2407, "epsg", 2407,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 31", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=93 +k=1 +x_0=31500000 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=");
    ...
    p = add_epsg_def_ex (filter, first, last, 2408, "epsg", 2408,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 32", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=96 +k=1 +x_0=32500000 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=");
    ...
    p = add_epsg_def_ex (filter, first, last, 2409, "epsg", 2409,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 33", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=99 +k=1 +x_0=33500000 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=");
    ...
    p = add_epsg_def_ex (filter, first, last, 2410, "epsg", 2410,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 34", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=102 +k=1 +x_0=34500000 +y_0=");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2411, "epsg", 2411,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 35", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=105 +k=1 +x_0=35500000 +y_0=");
    add_proj4text (p, 1,
        "0 +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units");
    ...
    p = add_epsg_def_ex (filter, first, last, 2412, "epsg", 2412,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 36", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=108 +k=1 +x_0=36500000 +y_0=");
    add_proj4text (p, 1,
        "0 +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units");
    ...
    p = add_epsg_def_ex (filter, first, last, 2413, "epsg", 2413,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 37", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=111 +k=1 +x_0=37500000 +y_0=");
    add_proj4text (p, 1,
        "0 +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units");
    ...
    p = add_epsg_def_ex (filter, first, last, 2414, "epsg", 2414,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 38", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=114 +k=1 +x_0=38500000 +y_0=");
    add_proj4text (p, 1,
        "0 +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units");
    ...
    p = add_epsg_def_ex (filter, first, last, 2415, "epsg", 2415,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 39", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=117 +k=1 +x_0=39500000 +y_0=");
    add_proj4text (p, 1,
        "0 +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units");
    ...
    p = add_epsg_def_ex (filter, first, last, 2416, "epsg", 2416,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 40", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=120 +k=1 +x_0=40500000 +y_0=");
    add_proj4text (p, 1,
        "0 +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units");
    ...
    p = add_epsg_def_ex (filter, first, last, 2417, "epsg", 2417,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 41", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=123 +k=1 +x_0=41500000 +y_0=");
    add_proj4text (p, 1,
        "0 +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units");
    ...
    p = add_epsg_def_ex (filter, first, last, 2418, "epsg", 2418,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 42", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=126 +k=1 +x_0=42500000 +y_0=");
    add_proj4text (p, 1,
        "0 +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units");
    ...
    p = add_epsg_def_ex (filter, first, last, 2419, "epsg", 2419,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 43", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=129 +k=1 +x_0=43500000 +y_0=");
    add_proj4text (p, 1,
        "0 +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units");
    ...
    p = add_epsg_def_ex (filter, first, last, 2420, "epsg", 2420,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 44", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=132 +k=1 +x_0=44500000 +y_0=");
    add_proj4text (p, 1,
        "0 +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units");
    ...
    p = add_epsg_def_ex (filter, first, last, 2421, "epsg", 2421,
        "Beijing 1954 / 3-degree Gauss-Kruger zone 45", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=135 +k=1 +x_0=45500000 +y_0=");
    add_proj4text (p, 1,
        "0 +ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units");
    ...
    p = add_epsg_def_ex (filter, first, last, 2422, "epsg", 2422,
        "Beijing 1954 / 3-degree Gauss-Kruger CM 75E", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=75 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2423, "epsg", 2423,
        "Beijing 1954 / 3-degree Gauss-Kruger CM 78E", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=78 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=m ");
    ...
    p = add_epsg_def_ex (filter, first, last, 2424, "epsg", 2424,
        "Beijing 1954 / 3-degree Gauss-Kruger CM 81E", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=81 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=m ");
    ...
    p = add_epsg_def_ex (filter, first, last, 2425, "epsg", 2425,
        "Beijing 1954 / 3-degree Gauss-Kruger CM 84E", 0, 1, "Krassowsky 1940", "Beijing_1954", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=84 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "ellps=krass +towgs84=15.8,-154.4,-82.3,0,0,0,0 +units=m ");
