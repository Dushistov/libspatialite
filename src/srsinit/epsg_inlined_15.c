...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 3548, "epsg", 3548,
        "NAD83(NSRS2007) / Kentucky South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3549, "epsg", 3549,
        "NAD83(NSRS2007) / Kentucky South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=37.93333333333333 +lat_2=36.73333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3550, "epsg", 3550,
        "NAD83(NSRS2007) / Louisiana North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3551, "epsg", 3551,
        "NAD83(NSRS2007) / Louisiana North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=32.66666666666666 +lat_2=31.16666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3552, "epsg", 3552,
        "NAD83(NSRS2007) / Louisiana South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3553, "epsg", 3553,
        "NAD83(NSRS2007) / Louisiana South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=30.7 +lat_2=29.3 +lat_0=28.5 +lon_0=-91");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3554, "epsg", 3554,
        "NAD83(NSRS2007) / Maine CS2000 Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3555, "epsg", 3555,
        "NAD83(NSRS2007) / Maine CS2000 East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3556, "epsg", 3556,
        "NAD83(NSRS2007) / Maine CS2000 West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3557, "epsg", 3557,
        "NAD83(NSRS2007) / Maine East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3558, "epsg", 3558,
        "NAD83(NSRS2007) / Maine West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3559, "epsg", 3559,
        "NAD83(NSRS2007) / Maryland", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3560, "epsg", 3560,
        "NAD83 / Utah North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3561, "epsg", 3561,
        "Old Hawaiian / Hawaii zone 1", 0, 0, "Clarke 1866", "Old_Hawaiian", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3562, "epsg", 3562,
        "Old Hawaiian / Hawaii zone 2", 0, 0, "Clarke 1866", "Old_Hawaiian", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3563, "epsg", 3563,
        "Old Hawaiian / Hawaii zone 3", 0, 0, "Clarke 1866", "Old_Hawaiian", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3564, "epsg", 3564,
        "Old Hawaiian / Hawaii zone 4", 0, 0, "Clarke 1866", "Old_Hawaiian", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3565, "epsg", 3565,
        "Old Hawaiian / Hawaii zone 5", 0, 0, "Clarke 1866", "Old_Hawaiian", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3566, "epsg", 3566,
        "NAD83 / Utah Central (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3567, "epsg", 3567,
        "NAD83 / Utah South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3568, "epsg", 3568,
        "NAD83(HARN) / Utah North (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=41.78333333333333 +lat_2=40.71666666666");
    add_proj4text (p, 1,
        "667 +lat_0=40.33333333333334 +lon_0=-111.5 +x_0=500000.0");
    ...
    p = add_epsg_def_ex (filter, first, last, 3569, "epsg", 3569,
        "NAD83(HARN) / Utah Central (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=40.65 +lat_2=39.01666666666667 +lat_0=3");
    add_proj4text (p, 1,
        "8.33333333333334 +lon_0=-111.5 +x_0=500000.00001016 +y_0");
    ...
    p = add_epsg_def_ex (filter, first, last, 3570, "epsg", 3570,
        "NAD83(HARN) / Utah South (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=38.35 +lat_2=37.21666666666667 +lat_0=3");
    add_proj4text (p, 1,
        "6.66666666666666 +lon_0=-111.5 +x_0=500000.00001016 +y_0");
    ...
    p = add_epsg_def_ex (filter, first, last, 3571, "epsg", 3571,
        "WGS 84 / North Pole LAEA Bering Sea", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3572, "epsg", 3572,
        "WGS 84 / North Pole LAEA Alaska", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3573, "epsg", 3573,
        "WGS 84 / North Pole LAEA Canada", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3574, "epsg", 3574,
        "WGS 84 / North Pole LAEA Atlantic", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3575, "epsg", 3575,
        "WGS 84 / North Pole LAEA Europe", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3576, "epsg", 3576,
        "WGS 84 / North Pole LAEA Russia", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3577, "epsg", 3577,
        "GDA94 / Australian Albers", 0, 0, "GRS 1980", "Geocentric_Datum_of_Australia_1994", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3578, "epsg", 3578,
        "NAD83 / Yukon Albers", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3579, "epsg", 3579,
        "NAD83(CSRS) / Yukon Albers", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=aea +lat_1=61.66666666666666 +lat_2=68 +lat_0=59 +");
    add_proj4text (p, 1,
        "lon_0=-132.5 +x_0=500000 +y_0=500000 +ellps=GRS80 +towgs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3580, "epsg", 3580,
        "NAD83 / NWT Lambert", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3581, "epsg", 3581,
        "NAD83(CSRS) / NWT Lambert", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=62 +lat_2=70 +lat_0=0 +lon_0=-112 +x_0=");
    add_proj4text (p, 1,
        "0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +n");
    ...
    p = add_epsg_def_ex (filter, first, last, 3582, "epsg", 3582,
        "NAD83(NSRS2007) / Maryland (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=39.45 +lat_2=38.3 +lat_0=37.66666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3583, "epsg", 3583,
        "NAD83(NSRS2007) / Massachusetts Island", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3584, "epsg", 3584,
        "NAD83(NSRS2007) / Massachusetts Island (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=41.48333333333333 +lat_2=41.28333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3585, "epsg", 3585,
        "NAD83(NSRS2007) / Massachusetts Mainland", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3586, "epsg", 3586,
        "NAD83(NSRS2007) / Massachusetts Mainland (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=42.68333333333333 +lat_2=41.71666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3587, "epsg", 3587,
        "NAD83(NSRS2007) / Michigan Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3588, "epsg", 3588,
        "NAD83(NSRS2007) / Michigan Central (ft)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=45.7 +lat_2=44.18333333333333 +lat_0=43");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3589, "epsg", 3589,
        "NAD83(NSRS2007) / Michigan North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3590, "epsg", 3590,
        "NAD83(NSRS2007) / Michigan North (ft)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=47.08333333333334 +lat_2=45.48333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3591, "epsg", 3591,
        "NAD83(NSRS2007) / Michigan Oblique Mercator", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3592, "epsg", 3592,
        "NAD83(NSRS2007) / Michigan South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3593, "epsg", 3593,
        "NAD83(NSRS2007) / Michigan South (ft)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=43.66666666666666 +lat_2=42.1 +lat_0=41");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3594, "epsg", 3594,
        "NAD83(NSRS2007) / Minnesota Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3595, "epsg", 3595,
        "NAD83(NSRS2007) / Minnesota North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3596, "epsg", 3596,
        "NAD83(NSRS2007) / Minnesota South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3597, "epsg", 3597,
        "NAD83(NSRS2007) / Mississippi East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3598, "epsg", 3598,
        "NAD83(NSRS2007) / Mississippi East (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=29.5 +lon_0=-88.83333333333333 +k=0.9");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3599, "epsg", 3599,
        "NAD83(NSRS2007) / Mississippi West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3600, "epsg", 3600,
        "NAD83(NSRS2007) / Mississippi West (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=29.5 +lon_0=-90.33333333333333 +k=0.9");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3601, "epsg", 3601,
        "NAD83(NSRS2007) / Missouri Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3602, "epsg", 3602,
        "NAD83(NSRS2007) / Missouri East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3603, "epsg", 3603,
        "NAD83(NSRS2007) / Missouri West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3604, "epsg", 3604,
        "NAD83(NSRS2007) / Montana", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3605, "epsg", 3605,
        "NAD83(NSRS2007) / Montana (ft)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=49 +lat_2=45 +lat_0=44.25 +lon_0=-109.5");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3606, "epsg", 3606,
        "NAD83(NSRS2007) / Nebraska", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3607, "epsg", 3607,
        "NAD83(NSRS2007) / Nevada Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3608, "epsg", 3608,
        "NAD83(NSRS2007) / Nevada Central (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=34.75 +lon_0=-116.6666666666667 +k=0.");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3609, "epsg", 3609,
        "NAD83(NSRS2007) / Nevada East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3610, "epsg", 3610,
        "NAD83(NSRS2007) / Nevada East (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=34.75 +lon_0=-115.5833333333333 +k=0.");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3611, "epsg", 3611,
        "NAD83(NSRS2007) / Nevada West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3612, "epsg", 3612,
        "NAD83(NSRS2007) / Nevada West (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=34.75 +lon_0=-118.5833333333333 +k=0.");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3613, "epsg", 3613,
        "NAD83(NSRS2007) / New Hampshire", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3614, "epsg", 3614,
        "NAD83(NSRS2007) / New Hampshire (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=42.5 +lon_0=-71.66666666666667 +k=0.9");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3615, "epsg", 3615,
        "NAD83(NSRS2007) / New Jersey", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3616, "epsg", 3616,
        "NAD83(NSRS2007) / New Jersey (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38.83333333333334 +lon_0=-74.5 +k=0.9");
    add_proj4text (p, 1,
        "999 +x_0=150000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0");
    ...
    p = add_epsg_def_ex (filter, first, last, 3617, "epsg", 3617,
        "NAD83(NSRS2007) / New Mexico Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3618, "epsg", 3618,
        "NAD83(NSRS2007) / New Mexico Central (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=31 +lon_0=-106.25 +k=0.9999 +x_0=5000");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3619, "epsg", 3619,
        "NAD83(NSRS2007) / New Mexico East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3620, "epsg", 3620,
        "NAD83(NSRS2007) / New Mexico East (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=31 +lon_0=-104.3333333333333 +k=0.999");
    add_proj4text (p, 1,
        "909091 +x_0=165000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,");
    ...
    p = add_epsg_def_ex (filter, first, last, 3621, "epsg", 3621,
        "NAD83(NSRS2007) / New Mexico West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3622, "epsg", 3622,
        "NAD83(NSRS2007) / New Mexico West (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=31 +lon_0=-107.8333333333333 +k=0.999");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3623, "epsg", 3623,
        "NAD83(NSRS2007) / New York Central", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3624, "epsg", 3624,
        "NAD83(NSRS2007) / New York Central (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=40 +lon_0=-76.58333333333333 +k=0.999");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3625, "epsg", 3625,
        "NAD83(NSRS2007) / New York East", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38.83333333333334 +lon_0=-74.5 +k=0.9");
    add_proj4text (p, 1,
        "999 +x_0=150000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0");
    ...
    p = add_epsg_def_ex (filter, first, last, 3626, "epsg", 3626,
        "NAD83(NSRS2007) / New York East (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38.83333333333334 +lon_0=-74.5 +k=0.9");
    add_proj4text (p, 1,
        "999 +x_0=150000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0");
    ...
    p = add_epsg_def_ex (filter, first, last, 3627, "epsg", 3627,
        "NAD83(NSRS2007) / New York Long Island", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3628, "epsg", 3628,
        "NAD83(NSRS2007) / New York Long Island (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=41.03333333333333 +lat_2=40.66666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3629, "epsg", 3629,
        "NAD83(NSRS2007) / New York West", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3630, "epsg", 3630,
        "NAD83(NSRS2007) / New York West (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=40 +lon_0=-78.58333333333333 +k=0.999");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3631, "epsg", 3631,
        "NAD83(NSRS2007) / North Carolina", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3632, "epsg", 3632,
        "NAD83(NSRS2007) / North Carolina (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=36.16666666666666 +lat_2=34.33333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3633, "epsg", 3633,
        "NAD83(NSRS2007) / North Dakota North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3634, "epsg", 3634,
        "NAD83(NSRS2007) / North Dakota North (ft)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=48.73333333333333 +lat_2=47.43333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3635, "epsg", 3635,
        "NAD83(NSRS2007) / North Dakota South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3636, "epsg", 3636,
        "NAD83(NSRS2007) / North Dakota South (ft)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=47.48333333333333 +lat_2=46.18333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3637, "epsg", 3637,
        "NAD83(NSRS2007) / Ohio North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3638, "epsg", 3638,
        "NAD83(NSRS2007) / Ohio South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3639, "epsg", 3639,
        "NAD83(NSRS2007) / Oklahoma North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3640, "epsg", 3640,
        "NAD83(NSRS2007) / Oklahoma North (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=36.76666666666667 +lat_2=35.56666666666");
    add_proj4text (p, 1,
        "667 +lat_0=35 +lon_0=-98 +x_0=600000 +y_0=0 +ellps=GRS80");
    ...
    p = add_epsg_def_ex (filter, first, last, 3641, "epsg", 3641,
        "NAD83(NSRS2007) / Oklahoma South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3642, "epsg", 3642,
        "NAD83(NSRS2007) / Oklahoma South (ftUS)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=35.23333333333333 +lat_2=33.93333333333");
    add_proj4text (p, 1,
        "333 +lat_0=33.33333333333334 +lon_0=-98 +x_0=600000 +y_0");
    ...
    p = add_epsg_def_ex (filter, first, last, 3643, "epsg", 3643,
        "NAD83(NSRS2007) / Oregon LCC (m)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3644, "epsg", 3644,
        "NAD83(NSRS2007) / Oregon GIC Lambert (ft)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=43 +lat_2=45.5 +lat_0=41.75 +lon_0=-120");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3645, "epsg", 3645,
        "NAD83(NSRS2007) / Oregon North", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3646, "epsg", 3646,
        "NAD83(NSRS2007) / Oregon North (ft)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=46 +lat_2=44.33333333333334 +lat_0=43.6");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3647, "epsg", 3647,
        "NAD83(NSRS2007) / Oregon South", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3648, "epsg", 3648,
        "NAD83(NSRS2007) / Oregon South (ft)", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=44 +lat_2=42.33333333333334 +lat_0=41.6");
    add_proj4text (p, 1,
