...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 5298, "epsg", 5298,
        "DRUKREF 03 / Mongar TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5299, "epsg", 5299,
        "DRUKREF 03 / Paro TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5300, "epsg", 5300,
        "DRUKREF 03 / Pemagatshel TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5301, "epsg", 5301,
        "DRUKREF 03 / Punakha TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5302, "epsg", 5302,
        "DRUKREF 03 / Samdrup Jongkhar TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5303, "epsg", 5303,
        "DRUKREF 03 / Samtse TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5304, "epsg", 5304,
        "DRUKREF 03 / Sarpang TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5305, "epsg", 5305,
        "DRUKREF 03 / Thimphu TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5306, "epsg", 5306,
        "DRUKREF 03 / Trashigang TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5307, "epsg", 5307,
        "DRUKREF 03 / Trongsa TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5308, "epsg", 5308,
        "DRUKREF 03 / Tsirang TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5309, "epsg", 5309,
        "DRUKREF 03 / Wangdue Phodrang TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5310, "epsg", 5310,
        "DRUKREF 03 / Yangtse TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=91.56666666666666 +k=1 +x_0=");
    add_proj4text (p, 1,
        "250000 +y_0=-2500000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0");
    ...
    p = add_epsg_def_ex (filter, first, last, 5311, "epsg", 5311,
        "DRUKREF 03 / Zhemgang TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5316, "epsg", 5316,
        "ETRS89 / Faroe TM", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5320, "epsg", 5320,
        "NAD83 / Teranet Ontario Lambert", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5321, "epsg", 5321,
        "NAD83(CSRS) / Teranet Ontario Lambert", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=44.5 +lat_2=54.5 +lat_0=0 +lon_0=-84 +x");
    add_proj4text (p, 1,
        "_0=1000000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +u");
    ...
    p = add_epsg_def_ex (filter, first, last, 5324, "epsg", 5324,
        "ISN2004", 1, 1, "GRS 1980", "Islands_Net_2004", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5325, "epsg", 5325,
        "ISN2004 / Lambert 2004", 0, 0, "GRS 1980", "Islands_Net_2004", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5329, "epsg", 5329,
        "Segara (Jakarta) / NEIEZ", 0, 0, "Bessel 1841", "Gunung_Segara_Jakarta", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5330, "epsg", 5330,
        "Batavia (Jakarta) / NEIEZ", 0, 0, "Bessel 1841", "Batavia_Jakarta", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=merc +lon_0=3.192280555555556 +k=0.997 +x_0=390000");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 5331, "epsg", 5331,
        "Makassar (Jakarta) / NEIEZ", 0, 0, "Bessel 1841", "Makassar_Jakarta", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=merc +lon_0=3.192280555555556 +k=0.997 +x_0=390000");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 5337, "epsg", 5337,
        "Aratu / UTM zone 25S", 0, 0, "International 1924", "Aratu", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5340, "epsg", 5340,
        "POSGAR 2007", 1, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_2007", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5343, "epsg", 5343,
        "POSGAR 2007 / Argentina 1", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_2007", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5344, "epsg", 5344,
        "POSGAR 2007 / Argentina 2", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_2007", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5345, "epsg", 5345,
        "POSGAR 2007 / Argentina 3", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_2007", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5346, "epsg", 5346,
        "POSGAR 2007 / Argentina 4", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_2007", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5347, "epsg", 5347,
        "POSGAR 2007 / Argentina 5", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_2007", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5348, "epsg", 5348,
        "POSGAR 2007 / Argentina 6", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_2007", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5349, "epsg", 5349,
        "POSGAR 2007 / Argentina 7", 0, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_2007", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5354, "epsg", 5354,
        "MARGEN", 1, 1, "GRS 1980", "Marco_Geodesico_Nacional", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5355, "epsg", 5355,
        "MARGEN / UTM zone 20S", 0, 0, "GRS 1980", "Marco_Geodesico_Nacional", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5356, "epsg", 5356,
        "MARGEN / UTM zone 19S", 0, 0, "GRS 1980", "Marco_Geodesico_Nacional", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5357, "epsg", 5357,
        "MARGEN / UTM zone 21S", 0, 0, "GRS 1980", "Marco_Geodesico_Nacional", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5360, "epsg", 5360,
        "SIRGAS-Chile", 1, 1, "GRS 1980", "SIRGAS_Chile", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5361, "epsg", 5361,
        "SIRGAS-Chile / UTM zone 19S", 0, 0, "GRS 1980", "SIRGAS_Chile", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=utm +zone=19 +south +ellps=GRS80 +towgs84=0,0,0,0,");
    add_proj4text (p, 1,
        "0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5362, "epsg", 5362,
        "SIRGAS-Chile / UTM zone 18S", 0, 0, "GRS 1980", "SIRGAS_Chile", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5365, "epsg", 5365,
        "CR05", 1, 1, "WGS 84", "Costa_Rica_2005", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5367, "epsg", 5367,
        "CR05 / CRTM05", 0, 1, "WGS 84", "Costa_Rica_2005", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5371, "epsg", 5371,
        "MACARIO SOLIS", 1, 1, "GRS 1980", "Sistema_Geodesico_Nacional_de_Panama_MACARIO_SOLIS", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5373, "epsg", 5373,
        "Peru96", 1, 1, "GRS 1980", "Peru96", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5381, "epsg", 5381,
        "SIRGAS-ROU98", 1, 1, "WGS 84", "SIRGAS_ROU98", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5382, "epsg", 5382,
        "SIRGAS-ROU98 / UTM zone 21S", 0, 0, "WGS 84", "SIRGAS_ROU98", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5383, "epsg", 5383,
        "SIRGAS-ROU98 / UTM zone 22S", 0, 0, "WGS 84", "SIRGAS_ROU98", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5387, "epsg", 5387,
        "Peru96 / UTM zone 18S", 0, 0, "GRS 1980", "Peru96", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=utm +zone=18 +south +ellps=GRS80 +towgs84=0,0,0,0,");
    add_proj4text (p, 1,
        "0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5388, "epsg", 5388,
        "Peru96 / UTM zone 17S (deprecated)", 0, 0, "GRS 1980", "Peru96", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5389, "epsg", 5389,
        "Peru96 / UTM zone 19S", 0, 0, "GRS 1980", "Peru96", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=utm +zone=19 +south +ellps=GRS80 +towgs84=0,0,0,0,");
    add_proj4text (p, 1,
        "0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5393, "epsg", 5393,
        "SIRGAS_ES2007.8", 1, 1, "GRS 1980", "SIRGAS_ES2007_8", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5396, "epsg", 5396,
        "SIRGAS 2000 / UTM zone 26S", 0, 0, "GRS 1980", "Sistema_de_Referencia_Geocentrico_para_las_AmericaS_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5451, "epsg", 5451,
        "Ocotepeque 1935", 1, 1, "Clarke 1866", "Ocotepeque_1935", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5456, "epsg", 5456,
        "Ocotepeque 1935 / Costa Rica Norte", 0, 0, "Clarke 1866", "Ocotepeque_1935", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5457, "epsg", 5457,
        "Ocotepeque 1935 / Costa Rica Sur", 0, 0, "Clarke 1866", "Ocotepeque_1935", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5458, "epsg", 5458,
        "Ocotepeque 1935 / Guatemala Norte (deprecated)", 0, 0, "Clarke 1866", "North_American_Datum_1927", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5459, "epsg", 5459,
        "Ocotepeque 1935 / Guatemala Sur", 0, 0, "Clarke 1866", "Ocotepeque_1935", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5460, "epsg", 5460,
        "Ocotepeque 1935 / El Salvador Lambert", 0, 0, "Clarke 1866", "Ocotepeque_1935", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5461, "epsg", 5461,
        "Ocotepeque 1935 / Nicaragua Norte", 0, 0, "Clarke 1866", "Ocotepeque_1935", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5462, "epsg", 5462,
        "Ocotepeque 1935 / Nicaragua Sur", 0, 0, "Clarke 1866", "Ocotepeque_1935", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5463, "epsg", 5463,
        "SAD69 / UTM zone 17N", 0, 0, "GRS 1967 Modified", "South_American_Datum_1969", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5464, "epsg", 5464,
        "Sibun Gorge 1922", 1, 1, "Clarke 1858", "Sibun_Gorge_1922", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5466, "epsg", 5466,
        "Sibun Gorge 1922 / Colony Grid (deprecated)", 0, 0, "Clarke 1858", "Sibun_Gorge_1922", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5467, "epsg", 5467,
        "Panama-Colon 1911", 1, 1, "Clarke 1866", "Panama_Colon_1911", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5469, "epsg", 5469,
        "Panama-Colon 1911 / Panama Lambert", 0, 0, "Clarke 1866", "Panama_Colon_1911", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5472, "epsg", 5472,
        "Panama-Colon 1911 / Panama Polyconic", 0, 0, "Clarke 1866", "Panama_Colon_1911", "Clarke's yard", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5479, "epsg", 5479,
        "RSRGD2000 / MSLC2000", 0, 1, "GRS 1980", "Ross_Sea_Region_Geodetic_Datum_2000", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5480, "epsg", 5480,
        "RSRGD2000 / BCLC2000", 0, 1, "GRS 1980", "Ross_Sea_Region_Geodetic_Datum_2000", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5481, "epsg", 5481,
        "RSRGD2000 / PCLC2000", 0, 1, "GRS 1980", "Ross_Sea_Region_Geodetic_Datum_2000", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5482, "epsg", 5482,
        "RSRGD2000 / RSPS2000", 0, 1, "GRS 1980", "Ross_Sea_Region_Geodetic_Datum_2000", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5489, "epsg", 5489,
        "RGAF09", 1, 1, "GRS 1980", "Reseau_Geodesique_des_Antilles_Francaises_2009", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5490, "epsg", 5490,
        "RGAF09 / UTM zone 20N", 0, 0, "GRS 1980", "Reseau_Geodesique_des_Antilles_Francaises_2009", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5498, "epsg", 5498,
        "NAD83", 1, 1, "GRS 1980", "North_American_Datum_1983", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5499, "epsg", 5499,
        "NAD83(HARN)", 1, 1, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +geoid");
    add_proj4text (p, 1,
        "grids=g2012a_conus.gtx,g2012a_alaska.gtx,g2012a_guam.gtx");
    ...
    p = add_epsg_def_ex (filter, first, last, 5513, "epsg", 5513,
        "S-JTSK / Krovak", 0, 0, "Bessel 1841", "System_Jednotne_Trigonometricke_Site_Katastralni", "metre", "X", "South", "Y", "West");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5514, "epsg", 5514,
        "S-JTSK / Krovak East North", 0, 0, "Bessel 1841", "System_Jednotne_Trigonometricke_Site_Katastralni", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=krovak +lat_0=49.5 +lon_0=24.83333333333333 +alpha");
    add_proj4text (p, 1,
        "=30.28813972222222 +k=0.9999 +x_0=0 +y_0=0 +ellps=bessel");
    ...
    p = add_epsg_def_ex (filter, first, last, 5518, "epsg", 5518,
        "CI1971 / Chatham Islands Map Grid", 0, 1, "International 1924", "Chatham_Islands_Datum_1971", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5519, "epsg", 5519,
        "CI1979 / Chatham Islands Map Grid", 0, 1, "International 1924", "Chatham_Islands_Datum_1979", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-44 +lon_0=-176.5 +k=1 +x_0=350000 +y");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 5520, "epsg", 5520,
        "DHDN / 3-degree Gauss-Kruger zone 1", 0, 1, "Bessel 1841", "Deutsches_Hauptdreiecksnetz", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5523, "epsg", 5523,
        "WGS 84 / Gabon TM 2011", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5524, "epsg", 5524,
        "Corrego Alegre 1961", 1, 1, "International 1924", "Corrego_Alegre_1961", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5527, "epsg", 5527,
        "SAD69(96)", 1, 1, "GRS 1967 Modified", "South_American_Datum_1969_96", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5530, "epsg", 5530,
        "SAD69(96) / Brazil Polyconic", 0, 0, "GRS 1967 Modified", "South_American_Datum_1969_96", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5531, "epsg", 5531,
        "SAD69(96) / UTM zone 21S", 0, 0, "GRS 1967 Modified", "South_American_Datum_1969_96", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5532, "epsg", 5532,
        "SAD69(96) / UTM zone 22S (deprecated)", 0, 0, "GRS 1967 Modified", "South_American_Datum_1969", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5533, "epsg", 5533,
        "SAD69(96) / UTM zone 23S", 0, 0, "GRS 1967 Modified", "South_American_Datum_1969_96", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5534, "epsg", 5534,
        "SAD69(96) / UTM zone 24S", 0, 0, "GRS 1967 Modified", "South_American_Datum_1969_96", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5535, "epsg", 5535,
        "SAD69(96) / UTM zone 25S", 0, 0, "GRS 1967 Modified", "South_American_Datum_1969_96", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5536, "epsg", 5536,
        "Corrego Alegre 1961 / UTM zone 21S", 0, 0, "International 1924", "Corrego_Alegre_1961", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5537, "epsg", 5537,
        "Corrego Alegre 1961 / UTM zone 22S", 0, 0, "International 1924", "Corrego_Alegre_1961", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5538, "epsg", 5538,
        "Corrego Alegre 1961 / UTM zone 23S", 0, 0, "International 1924", "Corrego_Alegre_1961", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5539, "epsg", 5539,
        "Corrego Alegre 1961 / UTM zone 24S", 0, 0, "International 1924", "Corrego_Alegre_1961", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5546, "epsg", 5546,
        "PNG94", 1, 1, "GRS 1980", "Papua_New_Guinea_Geodetic_Datum_1994", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5550, "epsg", 5550,
        "PNG94 / PNGMG94 zone 54", 0, 0, "GRS 1980", "Papua_New_Guinea_Geodetic_Datum_1994", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5551, "epsg", 5551,
        "PNG94 / PNGMG94 zone 55", 0, 0, "GRS 1980", "Papua_New_Guinea_Geodetic_Datum_1994", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5552, "epsg", 5552,
        "PNG94 / PNGMG94 zone 56", 0, 0, "GRS 1980", "Papua_New_Guinea_Geodetic_Datum_1994", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5559, "epsg", 5559,
        "Ocotepeque 1935 / Guatemala Norte", 0, 0, "Clarke 1866", "Ocotepeque_1935", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=16.81666666666667 +lat_0=16.81666666666");
    add_proj4text (p, 1,
        "667 +lon_0=-90.33333333333333 +k_0=0.99992226 +x_0=50000");
    ...
    p = add_epsg_def_ex (filter, first, last, 5561, "epsg", 5561,
        "UCS-2000", 1, 1, "Krassowsky 1940", "Ukraine_2000", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
