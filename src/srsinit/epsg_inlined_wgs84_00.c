...
/* initializing the EPSG defs list [WGS84] */
    ...
    p = add_epsg_def_ex (filter, first, last, 4326, "epsg", 4326,
        "WGS 84", 1, 1, "WGS 84", "WGS_1984", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32601, "epsg", 32601,
        "WGS 84 / UTM zone 1N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32602, "epsg", 32602,
        "WGS 84 / UTM zone 2N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32603, "epsg", 32603,
        "WGS 84 / UTM zone 3N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32604, "epsg", 32604,
        "WGS 84 / UTM zone 4N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32605, "epsg", 32605,
        "WGS 84 / UTM zone 5N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32606, "epsg", 32606,
        "WGS 84 / UTM zone 6N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32607, "epsg", 32607,
        "WGS 84 / UTM zone 7N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32608, "epsg", 32608,
        "WGS 84 / UTM zone 8N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32609, "epsg", 32609,
        "WGS 84 / UTM zone 9N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32610, "epsg", 32610,
        "WGS 84 / UTM zone 10N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32611, "epsg", 32611,
        "WGS 84 / UTM zone 11N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32612, "epsg", 32612,
        "WGS 84 / UTM zone 12N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32613, "epsg", 32613,
        "WGS 84 / UTM zone 13N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32614, "epsg", 32614,
        "WGS 84 / UTM zone 14N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32615, "epsg", 32615,
        "WGS 84 / UTM zone 15N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32616, "epsg", 32616,
        "WGS 84 / UTM zone 16N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32617, "epsg", 32617,
        "WGS 84 / UTM zone 17N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32618, "epsg", 32618,
        "WGS 84 / UTM zone 18N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32619, "epsg", 32619,
        "WGS 84 / UTM zone 19N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32620, "epsg", 32620,
        "WGS 84 / UTM zone 20N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32621, "epsg", 32621,
        "WGS 84 / UTM zone 21N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32622, "epsg", 32622,
        "WGS 84 / UTM zone 22N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32623, "epsg", 32623,
        "WGS 84 / UTM zone 23N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32624, "epsg", 32624,
        "WGS 84 / UTM zone 24N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32625, "epsg", 32625,
        "WGS 84 / UTM zone 25N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32626, "epsg", 32626,
        "WGS 84 / UTM zone 26N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32627, "epsg", 32627,
        "WGS 84 / UTM zone 27N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32628, "epsg", 32628,
        "WGS 84 / UTM zone 28N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32629, "epsg", 32629,
        "WGS 84 / UTM zone 29N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32630, "epsg", 32630,
        "WGS 84 / UTM zone 30N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32631, "epsg", 32631,
        "WGS 84 / UTM zone 31N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32632, "epsg", 32632,
        "WGS 84 / UTM zone 32N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32633, "epsg", 32633,
        "WGS 84 / UTM zone 33N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32634, "epsg", 32634,
        "WGS 84 / UTM zone 34N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32635, "epsg", 32635,
        "WGS 84 / UTM zone 35N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32636, "epsg", 32636,
        "WGS 84 / UTM zone 36N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32637, "epsg", 32637,
        "WGS 84 / UTM zone 37N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32638, "epsg", 32638,
        "WGS 84 / UTM zone 38N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32639, "epsg", 32639,
        "WGS 84 / UTM zone 39N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32640, "epsg", 32640,
        "WGS 84 / UTM zone 40N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32641, "epsg", 32641,
        "WGS 84 / UTM zone 41N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32642, "epsg", 32642,
        "WGS 84 / UTM zone 42N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32643, "epsg", 32643,
        "WGS 84 / UTM zone 43N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32644, "epsg", 32644,
        "WGS 84 / UTM zone 44N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32645, "epsg", 32645,
        "WGS 84 / UTM zone 45N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32646, "epsg", 32646,
        "WGS 84 / UTM zone 46N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32647, "epsg", 32647,
        "WGS 84 / UTM zone 47N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32648, "epsg", 32648,
        "WGS 84 / UTM zone 48N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32649, "epsg", 32649,
        "WGS 84 / UTM zone 49N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32650, "epsg", 32650,
        "WGS 84 / UTM zone 50N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32651, "epsg", 32651,
        "WGS 84 / UTM zone 51N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32652, "epsg", 32652,
        "WGS 84 / UTM zone 52N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32653, "epsg", 32653,
        "WGS 84 / UTM zone 53N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32654, "epsg", 32654,
        "WGS 84 / UTM zone 54N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32655, "epsg", 32655,
        "WGS 84 / UTM zone 55N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32656, "epsg", 32656,
        "WGS 84 / UTM zone 56N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32657, "epsg", 32657,
        "WGS 84 / UTM zone 57N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32658, "epsg", 32658,
        "WGS 84 / UTM zone 58N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32659, "epsg", 32659,
        "WGS 84 / UTM zone 59N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32660, "epsg", 32660,
        "WGS 84 / UTM zone 60N", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32661, "epsg", 32661,
        "WGS 84 / UPS North (N,E)", 0, 1, "WGS 84", "WGS_1984", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32662, "epsg", 32662,
        "WGS 84 / Plate Carree (deprecated)", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32664, "epsg", 32664,
        "WGS 84 / BLM 14N (ftUS)", 0, 0, "WGS 84", "WGS_1984", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32665, "epsg", 32665,
        "WGS 84 / BLM 15N (ftUS)", 0, 0, "WGS 84", "WGS_1984", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32666, "epsg", 32666,
        "WGS 84 / BLM 16N (ftUS)", 0, 0, "WGS 84", "WGS_1984", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32667, "epsg", 32667,
        "WGS 84 / BLM 17N (ftUS)", 0, 0, "WGS 84", "WGS_1984", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32701, "epsg", 32701,
        "WGS 84 / UTM zone 1S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32702, "epsg", 32702,
        "WGS 84 / UTM zone 2S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32703, "epsg", 32703,
        "WGS 84 / UTM zone 3S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32704, "epsg", 32704,
        "WGS 84 / UTM zone 4S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32705, "epsg", 32705,
        "WGS 84 / UTM zone 5S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32706, "epsg", 32706,
        "WGS 84 / UTM zone 6S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32707, "epsg", 32707,
        "WGS 84 / UTM zone 7S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32708, "epsg", 32708,
        "WGS 84 / UTM zone 8S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32709, "epsg", 32709,
        "WGS 84 / UTM zone 9S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32710, "epsg", 32710,
        "WGS 84 / UTM zone 10S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32711, "epsg", 32711,
        "WGS 84 / UTM zone 11S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32712, "epsg", 32712,
        "WGS 84 / UTM zone 12S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32713, "epsg", 32713,
        "WGS 84 / UTM zone 13S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32714, "epsg", 32714,
        "WGS 84 / UTM zone 14S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32715, "epsg", 32715,
        "WGS 84 / UTM zone 15S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32716, "epsg", 32716,
        "WGS 84 / UTM zone 16S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32717, "epsg", 32717,
        "WGS 84 / UTM zone 17S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32718, "epsg", 32718,
        "WGS 84 / UTM zone 18S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32719, "epsg", 32719,
        "WGS 84 / UTM zone 19S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32720, "epsg", 32720,
        "WGS 84 / UTM zone 20S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32721, "epsg", 32721,
        "WGS 84 / UTM zone 21S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32722, "epsg", 32722,
        "WGS 84 / UTM zone 22S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32723, "epsg", 32723,
        "WGS 84 / UTM zone 23S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32724, "epsg", 32724,
        "WGS 84 / UTM zone 24S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32725, "epsg", 32725,
        "WGS 84 / UTM zone 25S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32726, "epsg", 32726,
        "WGS 84 / UTM zone 26S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32727, "epsg", 32727,
        "WGS 84 / UTM zone 27S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32728, "epsg", 32728,
        "WGS 84 / UTM zone 28S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32729, "epsg", 32729,
        "WGS 84 / UTM zone 29S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32730, "epsg", 32730,
        "WGS 84 / UTM zone 30S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32731, "epsg", 32731,
        "WGS 84 / UTM zone 31S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32732, "epsg", 32732,
        "WGS 84 / UTM zone 32S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32733, "epsg", 32733,
        "WGS 84 / UTM zone 33S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32734, "epsg", 32734,
        "WGS 84 / UTM zone 34S", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
