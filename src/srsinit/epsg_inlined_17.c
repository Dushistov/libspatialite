...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 3750, "epsg", 3750,
        "NAD83(HARN) / UTM zone 4N", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3751, "epsg", 3751,
        "NAD83(HARN) / UTM zone 5N", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3752, "epsg", 3752,
        "WGS 84 / Mercator 41 (deprecated)", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3753, "epsg", 3753,
        "NAD83(HARN) / Ohio North (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3754, "epsg", 3754,
        "NAD83(HARN) / Ohio South (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3755, "epsg", 3755,
        "NAD83(HARN) / Wyoming East (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3756, "epsg", 3756,
        "NAD83(HARN) / Wyoming East Central (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3757, "epsg", 3757,
        "NAD83(HARN) / Wyoming West Central (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3758, "epsg", 3758,
        "NAD83(HARN) / Wyoming West (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3759, "epsg", 3759,
        "NAD83 / Hawaii zone 3 (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3760, "epsg", 3760,
        "NAD83(HARN) / Hawaii zone 3 (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=21.16666666666667 +lon_0=-158 +k=0.99");
    add_proj4text (p, 1,
        "999 +x_0=500000.00001016 +y_0=0 +ellps=GRS80 +towgs84=0,");
    ...
    p = add_epsg_def_ex (filter, first, last, 3762, "epsg", 3762,
        "WGS 84 / South Georgia Lambert", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3763, "epsg", 3763,
        "ETRS89 / Portugal TM06", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3764, "epsg", 3764,
        "NZGD2000 / Chatham Island Circuit 2000", 0, 1, "GRS 1980", "New_Zealand_Geodetic_Datum_2000", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3765, "epsg", 3765,
        "HTRS96 / Croatia TM", 0, 0, "GRS 1980", "Croatian_Terrestrial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3766, "epsg", 3766,
        "HTRS96 / Croatia LCC", 0, 0, "GRS 1980", "Croatian_Terrestrial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3767, "epsg", 3767,
        "HTRS96 / UTM zone 33N", 0, 0, "GRS 1980", "Croatian_Terrestrial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3768, "epsg", 3768,
        "HTRS96 / UTM zone 34N", 0, 0, "GRS 1980", "Croatian_Terrestrial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3769, "epsg", 3769,
        "Bermuda 1957 / UTM zone 20N", 0, 0, "Clarke 1866", "Bermuda_1957", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3770, "epsg", 3770,
        "BDA2000 / Bermuda 2000 National Grid", 0, 0, "WGS 84", "Bermuda_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3771, "epsg", 3771,
        "NAD27 / Alberta 3TM ref merid 111 W", 0, 0, "Clarke 1866", "North_American_Datum_1927", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3772, "epsg", 3772,
        "NAD27 / Alberta 3TM ref merid 114 W", 0, 0, "Clarke 1866", "North_American_Datum_1927", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3773, "epsg", 3773,
        "NAD27 / Alberta 3TM ref merid 117 W", 0, 0, "Clarke 1866", "North_American_Datum_1927", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3774, "epsg", 3774,
        "NAD27 / Alberta 3TM ref merid 120 W (deprecated)", 0, 0, "Clarke 1866", "North_American_Datum_1927", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3775, "epsg", 3775,
        "NAD83 / Alberta 3TM ref merid 111 W", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-111 +k=0.9999 +x_0=0 +y_0=0");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3776, "epsg", 3776,
        "NAD83 / Alberta 3TM ref merid 114 W", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-114 +k=0.9999 +x_0=0 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3777, "epsg", 3777,
        "NAD83 / Alberta 3TM ref merid 117 W", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-117 +k=0.9999 +x_0=0 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3778, "epsg", 3778,
        "NAD83 / Alberta 3TM ref merid 120 W (deprecated)", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-120 +k=0.9999 +x_0=0 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3779, "epsg", 3779,
        "NAD83(CSRS) / Alberta 3TM ref merid 111 W", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-111 +k=0.9999 +x_0=0 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3780, "epsg", 3780,
        "NAD83(CSRS) / Alberta 3TM ref merid 114 W", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-114 +k=0.9999 +x_0=0 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3781, "epsg", 3781,
        "NAD83(CSRS) / Alberta 3TM ref merid 117 W", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-117 +k=0.9999 +x_0=0 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3782, "epsg", 3782,
        "NAD83(CSRS) / Alberta 3TM ref merid 120 W (deprecated)", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-120 +k=0.9999 +x_0=0 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3783, "epsg", 3783,
        "Pitcairn 2006 / Pitcairn TM 2006", 0, 0, "WGS 84", "Pitcairn_2006", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3784, "epsg", 3784,
        "Pitcairn 1967 / UTM zone 9S", 0, 0, "International 1924", "Pitcairn_1967", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3785, "epsg", 3785,
        "Popular Visualisation CRS / Mercator (deprecated)", 0, 0, "Popular Visualisation Sphere", "Popular_Visualisation_Datum", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3786, "epsg", 3786,
        "World Equidistant Cylindrical (Sphere) (deprecated)", 0, 0, "GRS 1980 Authalic Sphere", "Not_specified_based_on_GRS_1980_Authalic_Sphere", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3787, "epsg", 3787,
        "MGI / Slovene National Grid (deprecated)", 0, 0, "Bessel 1841", "Militar_Geographische_Institute", "metre", "Y", "East", "X", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3788, "epsg", 3788,
        "NZGD2000 / Auckland Islands TM 2000", 0, 1, "GRS 1980", "New_Zealand_Geodetic_Datum_2000", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3789, "epsg", 3789,
        "NZGD2000 / Campbell Island TM 2000", 0, 1, "GRS 1980", "New_Zealand_Geodetic_Datum_2000", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3790, "epsg", 3790,
        "NZGD2000 / Antipodes Islands TM 2000", 0, 1, "GRS 1980", "New_Zealand_Geodetic_Datum_2000", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3791, "epsg", 3791,
        "NZGD2000 / Raoul Island TM 2000", 0, 1, "GRS 1980", "New_Zealand_Geodetic_Datum_2000", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3793, "epsg", 3793,
        "NZGD2000 / Chatham Islands TM 2000", 0, 1, "GRS 1980", "New_Zealand_Geodetic_Datum_2000", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3794, "epsg", 3794,
        "Slovenia 1996 / Slovene National Grid", 0, 0, "GRS 1980", "Slovenia_Geodetic_Datum_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=15 +k=0.9999 +x_0=500000 +y_");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3795, "epsg", 3795,
        "NAD27 / Cuba Norte", 0, 1, "Clarke 1866", "North_American_Datum_1927", "metre", "Y", "North", "X", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3796, "epsg", 3796,
        "NAD27 / Cuba Sur", 0, 1, "Clarke 1866", "North_American_Datum_1927", "metre", "Y", "North", "X", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3797, "epsg", 3797,
        "NAD27 / MTQ Lambert", 0, 0, "Clarke 1866", "North_American_Datum_1927", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3798, "epsg", 3798,
        "NAD83 / MTQ Lambert", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=50 +lat_2=46 +lat_0=44 +lon_0=-70 +x_0=");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3799, "epsg", 3799,
        "NAD83(CSRS) / MTQ Lambert", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=50 +lat_2=46 +lat_0=44 +lon_0=-70 +x_0=");
    add_proj4text (p, 1,
        "800000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units");
    ...
    p = add_epsg_def_ex (filter, first, last, 3800, "epsg", 3800,
        "NAD27 / Alberta 3TM ref merid 120 W", 0, 0, "Clarke 1866", "North_American_Datum_1927", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-120 +k=0.9999 +x_0=0 +y_0=0");
    add_proj4text (p, 1,
        " +datum=NAD27 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3801, "epsg", 3801,
        "NAD83 / Alberta 3TM ref merid 120 W", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-120 +k=0.9999 +x_0=0 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3802, "epsg", 3802,
        "NAD83(CSRS) / Alberta 3TM ref merid 120 W", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-120 +k=0.9999 +x_0=0 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3812, "epsg", 3812,
        "ETRS89 / Belgian Lambert 2008", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3814, "epsg", 3814,
        "NAD83 / Mississippi TM", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3815, "epsg", 3815,
        "NAD83(HARN) / Mississippi TM", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=32.5 +lon_0=-89.75 +k=0.9998335 +x_0=");
    add_proj4text (p, 1,
        "500000 +y_0=1300000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 ");
    ...
    p = add_epsg_def_ex (filter, first, last, 3816, "epsg", 3816,
        "NAD83(NSRS2007) / Mississippi TM", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=32.5 +lon_0=-89.75 +k=0.9998335 +x_0=");
    add_proj4text (p, 1,
        "500000 +y_0=1300000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 ");
    ...
    p = add_epsg_def_ex (filter, first, last, 3819, "epsg", 3819,
        "HD1909", 1, 1, "Bessel 1841", "Hungarian_Datum_1909", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3821, "epsg", 3821,
        "TWD67", 1, 1, "GRS 1967 Modified", "Taiwan_Datum_1967", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3824, "epsg", 3824,
        "TWD97", 1, 1, "GRS 1980", "Taiwan_Datum_1997", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3825, "epsg", 3825,
        "TWD97 / TM2 zone 119", 0, 0, "GRS 1980", "Taiwan_Datum_1997", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3826, "epsg", 3826,
        "TWD97 / TM2 zone 121", 0, 0, "GRS 1980", "Taiwan_Datum_1997", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3827, "epsg", 3827,
        "TWD67 / TM2 zone 119", 0, 0, "GRS 1967 Modified", "Taiwan_Datum_1967", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=119 +k=0.9999 +x_0=250000 +y");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3828, "epsg", 3828,
        "TWD67 / TM2 zone 121", 0, 0, "GRS 1967 Modified", "Taiwan_Datum_1967", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=121 +k=0.9999 +x_0=250000 +y");
    add_proj4text (p, 1,
        "_0=0 +ellps=aust_SA +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3829, "epsg", 3829,
        "Hu Tzu Shan 1950 / UTM zone 51N", 0, 0, "International 1924", "Hu_Tzu_Shan_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3832, "epsg", 3832,
        "WGS 84 / PDC Mercator", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3833, "epsg", 3833,
        "Pulkovo 1942(58) / Gauss-Kruger zone 2", 0, 1, "Krassowsky 1940", "Pulkovo_1942_58", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3834, "epsg", 3834,
        "Pulkovo 1942(83) / Gauss-Kruger zone 2", 0, 1, "Krassowsky 1940", "Pulkovo_1942_83", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=9 +k=1 +x_0=2500000 +y_0=0 +");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3835, "epsg", 3835,
        "Pulkovo 1942(83) / Gauss-Kruger zone 3", 0, 1, "Krassowsky 1940", "Pulkovo_1942_83", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3836, "epsg", 3836,
        "Pulkovo 1942(83) / Gauss-Kruger zone 4", 0, 1, "Krassowsky 1940", "Pulkovo_1942_83", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3837, "epsg", 3837,
        "Pulkovo 1942(58) / 3-degree Gauss-Kruger zone 3", 0, 1, "Krassowsky 1940", "Pulkovo_1942_58", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3838, "epsg", 3838,
        "Pulkovo 1942(58) / 3-degree Gauss-Kruger zone 4", 0, 1, "Krassowsky 1940", "Pulkovo_1942_58", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3839, "epsg", 3839,
        "Pulkovo 1942(58) / 3-degree Gauss-Kruger zone 9", 0, 1, "Krassowsky 1940", "Pulkovo_1942_58", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3840, "epsg", 3840,
        "Pulkovo 1942(58) / 3-degree Gauss-Kruger zone 10", 0, 1, "Krassowsky 1940", "Pulkovo_1942_58", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3841, "epsg", 3841,
        "Pulkovo 1942(83) / 3-degree Gauss-Kruger zone 6", 0, 1, "Krassowsky 1940", "Pulkovo_1942_83", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3842, "epsg", 3842,
        "Pulkovo 1942(83) / 3-degree Gauss-Kruger zone 7 (deprecated)", 0, 1, "Krassowsky 1940", "Pulkovo_1942_83", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=18 +k=1 +x_0=6500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=krass +towgs84=26,-121,-78,0,0,0,0 +units=m +no_d");
    ...
    p = add_epsg_def_ex (filter, first, last, 3843, "epsg", 3843,
        "Pulkovo 1942(83) / 3-degree Gauss-Kruger zone 8 (deprecated)", 0, 1, "Krassowsky 1940", "Pulkovo_1942_83", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=18 +k=1 +x_0=6500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=krass +towgs84=26,-121,-78,0,0,0,0 +units=m +no_d");
    ...
    p = add_epsg_def_ex (filter, first, last, 3844, "epsg", 3844,
        "Pulkovo 1942(58) / Stereo70", 0, 1, "Krassowsky 1940", "Pulkovo_1942_58", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3845, "epsg", 3845,
        "SWEREF99 / RT90 7.5 gon V emulation", 0, 1, "GRS 1980", "SWEREF99", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3846, "epsg", 3846,
        "SWEREF99 / RT90 5 gon V emulation", 0, 1, "GRS 1980", "SWEREF99", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3847, "epsg", 3847,
        "SWEREF99 / RT90 2.5 gon V emulation", 0, 1, "GRS 1980", "SWEREF99", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3848, "epsg", 3848,
        "SWEREF99 / RT90 0 gon emulation", 0, 1, "GRS 1980", "SWEREF99", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3849, "epsg", 3849,
        "SWEREF99 / RT90 2.5 gon O emulation", 0, 1, "GRS 1980", "SWEREF99", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3850, "epsg", 3850,
        "SWEREF99 / RT90 5 gon O emulation", 0, 1, "GRS 1980", "SWEREF99", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3851, "epsg", 3851,
        "NZGD2000 / NZCS2000", 0, 1, "GRS 1980", "New_Zealand_Geodetic_Datum_2000", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3852, "epsg", 3852,
        "RSRGD2000 / DGLC2000", 0, 1, "GRS 1980", "Ross_Sea_Region_Geodetic_Datum_2000", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3854, "epsg", 3854,
        "County ST74", 0, 1, "GRS 1980", "SWEREF99", "metre", "x", "North", "y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3857, "epsg", 3857,
        "WGS 84 / Pseudo-Mercator", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 ");
    add_proj4text (p, 1,
        "+x_0=0.0 +y_0=0 +k=1.0 +units=m +nadgrids=@null +wktext ");
    ...
    p = add_epsg_def_ex (filter, first, last, 3873, "epsg", 3873,
        "ETRS89 / GK19FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3874, "epsg", 3874,
        "ETRS89 / GK20FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3875, "epsg", 3875,
        "ETRS89 / GK21FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3876, "epsg", 3876,
        "ETRS89 / GK22FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3877, "epsg", 3877,
        "ETRS89 / GK23FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3878, "epsg", 3878,
        "ETRS89 / GK24FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3879, "epsg", 3879,
        "ETRS89 / GK25FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3880, "epsg", 3880,
        "ETRS89 / GK26FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3881, "epsg", 3881,
        "ETRS89 / GK27FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3882, "epsg", 3882,
        "ETRS89 / GK28FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3883, "epsg", 3883,
        "ETRS89 / GK29FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3884, "epsg", 3884,
        "ETRS89 / GK30FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3885, "epsg", 3885,
        "ETRS89 / GK31FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3889, "epsg", 3889,
        "IGRS", 1, 1, "GRS 1980", "Iraqi_Geospatial_Reference_System", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
