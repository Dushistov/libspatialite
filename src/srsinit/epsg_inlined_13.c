...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 3346, "epsg", 3346,
        "LKS94 / Lithuania TM", 0, 1, "GRS 1980", "Lithuania_1994_ETRS89", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3347, "epsg", 3347,
        "NAD83 / Statistics Canada Lambert", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3348, "epsg", 3348,
        "NAD83(CSRS) / Statistics Canada Lambert", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=63.390675 +lon_0=-9");
    add_proj4text (p, 1,
        "1.86666666666666 +x_0=6200000 +y_0=3000000 +ellps=GRS80 ");
    ...
    p = add_epsg_def_ex (filter, first, last, 3349, "epsg", 3349,
        "WGS 84 / PDC Mercator (deprecated)", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3350, "epsg", 3350,
        "Pulkovo 1942 / CS63 zone C0", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3351, "epsg", 3351,
        "Pulkovo 1942 / CS63 zone C1", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3352, "epsg", 3352,
        "Pulkovo 1942 / CS63 zone C2", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3353, "epsg", 3353,
        "Mhast (onshore) / UTM zone 32S", 0, 0, "International 1924", "Mhast_onshore", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3354, "epsg", 3354,
        "Mhast (offshore) / UTM zone 32S", 0, 0, "International 1924", "Mhast_offshore", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=utm +zone=32 +south +ellps=intl +units=m +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3355, "epsg", 3355,
        "Egypt Gulf of Suez S-650 TL / Red Belt", 0, 0, "Helmert 1906", "Egypt_Gulf_of_Suez_S_650_TL", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3356, "epsg", 3356,
        "Grand Cayman 1959 / UTM zone 17N (deprecated)", 0, 0, "Clarke 1866", "Grand_Cayman_Geodetic_Datum_1959", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3357, "epsg", 3357,
        "Little Cayman 1961 / UTM zone 17N (deprecated)", 0, 0, "Clarke 1866", "Sister_Islands_Geodetic_Datum_1961", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3358, "epsg", 3358,
        "NAD83(HARN) / North Carolina", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3359, "epsg", 3359,
        "NAD83(HARN) / North Carolina (ftUS) (deprecated)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=36.16666666666666 +lat_2=34.33333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3360, "epsg", 3360,
        "NAD83(HARN) / South Carolina", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3361, "epsg", 3361,
        "NAD83(HARN) / South Carolina (ft)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=34.83333333333334 +lat_2=32.5 +lat_0=31");
    add_proj4text (p, 1,
        ".83333333333333 +lon_0=-81 +x_0=609600 +y_0=0 +ellps=GRS");
    ...
    p = add_epsg_def_ex (filter, first, last, 3362, "epsg", 3362,
        "NAD83(HARN) / Pennsylvania North", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3363, "epsg", 3363,
        "NAD83(HARN) / Pennsylvania North (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=41.95 +lat_2=40.88333333333333 +lat_0=4");
    add_proj4text (p, 1,
        "0.16666666666666 +lon_0=-77.75 +x_0=600000 +y_0=0 +ellps");
    ...
    p = add_epsg_def_ex (filter, first, last, 3364, "epsg", 3364,
        "NAD83(HARN) / Pennsylvania South", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3365, "epsg", 3365,
        "NAD83(HARN) / Pennsylvania South (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=40.96666666666667 +lat_2=39.93333333333");
    add_proj4text (p, 1,
        "333 +lat_0=39.33333333333334 +lon_0=-77.75 +x_0=600000 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 3366, "epsg", 3366,
        "Hong Kong 1963 Grid System (deprecated)", 0, 1, "Clarke 1858", "Hong_Kong_1963", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3367, "epsg", 3367,
        "IGN Astro 1960 / UTM zone 28N", 0, 0, "Clarke 1880 (RGS)", "IGN_Astro_1960", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3368, "epsg", 3368,
        "IGN Astro 1960 / UTM zone 29N", 0, 0, "Clarke 1880 (RGS)", "IGN_Astro_1960", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3369, "epsg", 3369,
        "IGN Astro 1960 / UTM zone 30N", 0, 0, "Clarke 1880 (RGS)", "IGN_Astro_1960", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3370, "epsg", 3370,
        "NAD27 / UTM zone 59N", 0, 0, "Clarke 1866", "North_American_Datum_1927", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3371, "epsg", 3371,
        "NAD27 / UTM zone 60N", 0, 0, "Clarke 1866", "North_American_Datum_1927", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3372, "epsg", 3372,
        "NAD83 / UTM zone 59N", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3373, "epsg", 3373,
        "NAD83 / UTM zone 60N", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3374, "epsg", 3374,
        "FD54 / UTM zone 29N", 0, 0, "International 1924", "Faroe_Datum_1954", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3375, "epsg", 3375,
        "GDM2000 / Peninsula RSO", 0, 0, "GRS 1980", "Geodetic_Datum_of_Malaysia_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3376, "epsg", 3376,
        "GDM2000 / East Malaysia BRSO", 0, 0, "GRS 1980", "Geodetic_Datum_of_Malaysia_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3377, "epsg", 3377,
        "GDM2000 / Johor Grid", 0, 0, "GRS 1980", "Geodetic_Datum_of_Malaysia_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3378, "epsg", 3378,
        "GDM2000 / Sembilan and Melaka Grid", 0, 0, "GRS 1980", "Geodetic_Datum_of_Malaysia_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3379, "epsg", 3379,
        "GDM2000 / PahangGrid", 0, 0, "GRS 1980", "Geodetic_Datum_of_Malaysia_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3380, "epsg", 3380,
        "GDM2000 / Selangor Grid", 0, 0, "GRS 1980", "Geodetic_Datum_of_Malaysia_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3381, "epsg", 3381,
        "GDM2000 / Terengganu Grid", 0, 0, "GRS 1980", "Geodetic_Datum_of_Malaysia_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3382, "epsg", 3382,
        "GDM2000 / Pinang Grid", 0, 0, "GRS 1980", "Geodetic_Datum_of_Malaysia_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3383, "epsg", 3383,
        "GDM2000 / Kedah and Perlis Grid", 0, 0, "GRS 1980", "Geodetic_Datum_of_Malaysia_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3384, "epsg", 3384,
        "GDM2000 / Perak Grid", 0, 0, "GRS 1980", "Geodetic_Datum_of_Malaysia_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3385, "epsg", 3385,
        "GDM2000 / Kelantan Grid", 0, 0, "GRS 1980", "Geodetic_Datum_of_Malaysia_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3386, "epsg", 3386,
        "KKJ / Finland zone 0", 0, 1, "International 1924", "Kartastokoordinaattijarjestelma_1966", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3387, "epsg", 3387,
        "KKJ / Finland zone 5", 0, 1, "International 1924", "Kartastokoordinaattijarjestelma_1966", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3388, "epsg", 3388,
        "Pulkovo 1942 / Caspian Sea Mercator", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "none", "North", "none", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3389, "epsg", 3389,
        "Pulkovo 1942 / 3-degree Gauss-Kruger zone 60", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3390, "epsg", 3390,
        "Pulkovo 1995 / 3-degree Gauss-Kruger zone 60", 0, 1, "Krassowsky 1940", "Pulkovo_1995", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=180 +k=1 +x_0=60500000 +y_0=");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3391, "epsg", 3391,
        "Karbala 1979 / UTM zone 37N", 0, 0, "Clarke 1880 (RGS)", "Karbala_1979", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3392, "epsg", 3392,
        "Karbala 1979 / UTM zone 38N", 0, 0, "Clarke 1880 (RGS)", "Karbala_1979", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3393, "epsg", 3393,
        "Karbala 1979 / UTM zone 39N", 0, 0, "Clarke 1880 (RGS)", "Karbala_1979", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3394, "epsg", 3394,
        "Nahrwan 1934 / Iraq zone", 0, 0, "Clarke 1880 (RGS)", "Nahrwan_1934", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3395, "epsg", 3395,
        "WGS 84 / World Mercator", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3396, "epsg", 3396,
        "PD/83 / 3-degree Gauss-Kruger zone 3", 0, 1, "Bessel 1841", "Potsdam_Datum_83", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3397, "epsg", 3397,
        "PD/83 / 3-degree Gauss-Kruger zone 4", 0, 1, "Bessel 1841", "Potsdam_Datum_83", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3398, "epsg", 3398,
        "RD/83 / 3-degree Gauss-Kruger zone 4", 0, 1, "Bessel 1841", "Rauenberg_Datum_83", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=12 +k=1 +x_0=4500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=bessel +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3399, "epsg", 3399,
        "RD/83 / 3-degree Gauss-Kruger zone 5", 0, 1, "Bessel 1841", "Rauenberg_Datum_83", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3400, "epsg", 3400,
        "NAD83 / Alberta 10-TM (Forest)", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3401, "epsg", 3401,
        "NAD83 / Alberta 10-TM (Resource)", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3402, "epsg", 3402,
        "NAD83(CSRS) / Alberta 10-TM (Forest)", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-115 +k=0.9992 +x_0=500000 +");
    add_proj4text (p, 1,
        "y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_d");
    ...
    p = add_epsg_def_ex (filter, first, last, 3403, "epsg", 3403,
        "NAD83(CSRS) / Alberta 10-TM (Resource)", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-115 +k=0.9992 +x_0=0 +y_0=0");
    add_proj4text (p, 1,
        " +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3404, "epsg", 3404,
        "NAD83(HARN) / North Carolina (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=36.16666666666666 +lat_2=34.33333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3405, "epsg", 3405,
        "VN-2000 / UTM zone 48N", 0, 0, "WGS 84", "Vietnam_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3406, "epsg", 3406,
        "VN-2000 / UTM zone 49N", 0, 0, "WGS 84", "Vietnam_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3407, "epsg", 3407,
        "Hong Kong 1963 Grid System", 0, 1, "Clarke 1858", "Hong_Kong_1963", "Clarke's foot", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
        "+proj=cass +lat_0=22.31213333333334 +lon_0=114.178555555");
    add_proj4text (p, 1,
        "5556 +x_0=40243.57775604237 +y_0=19069.93351512578 +a=63");
    ...
    p = add_epsg_def_ex (filter, first, last, 3408, "epsg", 3408,
        "NSIDC EASE-Grid North", 0, 0, "International 1924 Authalic Sphere", "Not_specified_based_on_International_1924_Authalic_Sphere", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3409, "epsg", 3409,
        "NSIDC EASE-Grid South", 0, 0, "International 1924 Authalic Sphere", "Not_specified_based_on_International_1924_Authalic_Sphere", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=laea +lat_0=-90 +lon_0=0 +x_0=0 +y_0=0 +a=6371228 ");
    add_proj4text (p, 1,
        "+b=6371228 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3410, "epsg", 3410,
        "NSIDC EASE-Grid Global", 0, 0, "International 1924 Authalic Sphere", "Not_specified_based_on_International_1924_Authalic_Sphere", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3411, "epsg", 3411,
        "NSIDC Sea Ice Polar Stereographic North", 0, 0, "Hughes 1980", "Not_specified_based_on_Hughes_1980_ellipsoid", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3412, "epsg", 3412,
        "NSIDC Sea Ice Polar Stereographic South", 0, 0, "Hughes 1980", "Not_specified_based_on_Hughes_1980_ellipsoid", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3413, "epsg", 3413,
        "WGS 84 / NSIDC Sea Ice Polar Stereographic North", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=stere +lat_0=90 +lat_ts=70 +lon_0=-45 +k=1 +x_0=0 ");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3414, "epsg", 3414,
        "SVY21 / Singapore TM", 0, 1, "WGS 84", "SVY21", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3415, "epsg", 3415,
        "WGS 72BE / South China Sea Lambert", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3416, "epsg", 3416,
        "ETRS89 / Austria Lambert", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3417, "epsg", 3417,
        "NAD83 / Iowa North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3418, "epsg", 3418,
        "NAD83 / Iowa South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3419, "epsg", 3419,
        "NAD83 / Kansas North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3420, "epsg", 3420,
        "NAD83 / Kansas South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3421, "epsg", 3421,
        "NAD83 / Nevada East (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3422, "epsg", 3422,
        "NAD83 / Nevada Central (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3423, "epsg", 3423,
        "NAD83 / Nevada West (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3424, "epsg", 3424,
        "NAD83 / New Jersey (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3425, "epsg", 3425,
        "NAD83(HARN) / Iowa North (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=43.26666666666667 +lat_2=42.06666666666");
    add_proj4text (p, 1,
        "667 +lat_0=41.5 +lon_0=-93.5 +x_0=1500000 +y_0=999999.99");
    ...
    p = add_epsg_def_ex (filter, first, last, 3426, "epsg", 3426,
        "NAD83(HARN) / Iowa South (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=41.78333333333333 +lat_2=40.61666666666");
    add_proj4text (p, 1,
        "667 +lat_0=40 +lon_0=-93.5 +x_0=500000.00001016 +y_0=0 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 3427, "epsg", 3427,
        "NAD83(HARN) / Kansas North (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=39.78333333333333 +lat_2=38.71666666666");
    add_proj4text (p, 1,
        "667 +lat_0=38.33333333333334 +lon_0=-98 +x_0=399999.9999");
    ...
    p = add_epsg_def_ex (filter, first, last, 3428, "epsg", 3428,
        "NAD83(HARN) / Kansas South (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=38.56666666666667 +lat_2=37.26666666666");
    add_proj4text (p, 1,
        "667 +lat_0=36.66666666666666 +lon_0=-98.5 +x_0=399999.99");
    ...
    p = add_epsg_def_ex (filter, first, last, 3429, "epsg", 3429,
        "NAD83(HARN) / Nevada East (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=34.75 +lon_0=-115.5833333333333 +k=0.");
    add_proj4text (p, 1,
        "9999 +x_0=200000.00001016 +y_0=8000000.000010163 +ellps=");
    ...
    p = add_epsg_def_ex (filter, first, last, 3430, "epsg", 3430,
        "NAD83(HARN) / Nevada Central (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=34.75 +lon_0=-116.6666666666667 +k=0.");
    add_proj4text (p, 1,
        "9999 +x_0=500000.00001016 +y_0=6000000 +ellps=GRS80 +tow");
    ...
    p = add_epsg_def_ex (filter, first, last, 3431, "epsg", 3431,
        "NAD83(HARN) / Nevada West (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=34.75 +lon_0=-118.5833333333333 +k=0.");
    add_proj4text (p, 1,
        "9999 +x_0=800000.0000101599 +y_0=3999999.99998984 +ellps");
    ...
    p = add_epsg_def_ex (filter, first, last, 3432, "epsg", 3432,
        "NAD83(HARN) / New Jersey (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38.83333333333334 +lon_0=-74.5 +k=0.9");
    add_proj4text (p, 1,
        "999 +x_0=150000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0");
    ...
    p = add_epsg_def_ex (filter, first, last, 3433, "epsg", 3433,
        "NAD83 / Arkansas North (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3434, "epsg", 3434,
        "NAD83 / Arkansas South (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3435, "epsg", 3435,
        "NAD83 / Illinois East (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3436, "epsg", 3436,
        "NAD83 / Illinois West (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3437, "epsg", 3437,
        "NAD83 / New Hampshire (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3438, "epsg", 3438,
        "NAD83 / Rhode Island (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3439, "epsg", 3439,
        "PSD93 / UTM zone 39N", 0, 0, "Clarke 1880 (RGS)", "PDO_Survey_Datum_1993", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3440, "epsg", 3440,
        "PSD93 / UTM zone 40N", 0, 0, "Clarke 1880 (RGS)", "PDO_Survey_Datum_1993", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3441, "epsg", 3441,
        "NAD83(HARN) / Arkansas North (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=36.23333333333333 +lat_2=34.93333333333");
    add_proj4text (p, 1,
        "333 +lat_0=34.33333333333334 +lon_0=-92 +x_0=399999.9999");
    ...
    p = add_epsg_def_ex (filter, first, last, 3442, "epsg", 3442,
        "NAD83(HARN) / Arkansas South (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=34.76666666666667 +lat_2=33.3 +lat_0=32");
    add_proj4text (p, 1,
        ".66666666666666 +lon_0=-92 +x_0=399999.99998984 +y_0=399");
    ...
    p = add_epsg_def_ex (filter, first, last, 3443, "epsg", 3443,
        "NAD83(HARN) / Illinois East (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=36.66666666666666 +lon_0=-88.33333333");
    add_proj4text (p, 1,
        "333333 +k=0.9999749999999999 +x_0=300000.0000000001 +y_0");
    ...
    p = add_epsg_def_ex (filter, first, last, 3444, "epsg", 3444,
        "NAD83(HARN) / Illinois West (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=36.66666666666666 +lon_0=-90.16666666");
    add_proj4text (p, 1,
        "666667 +k=0.999941177 +x_0=699999.9999898402 +y_0=0 +ell");
    ...
    p = add_epsg_def_ex (filter, first, last, 3445, "epsg", 3445,
        "NAD83(HARN) / New Hampshire (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=42.5 +lon_0=-71.66666666666667 +k=0.9");
    add_proj4text (p, 1,
        "99966667 +x_0=300000.0000000001 +y_0=0 +ellps=GRS80 +tow");
    ...
    p = add_epsg_def_ex (filter, first, last, 3446, "epsg", 3446,
        "NAD83(HARN) / Rhode Island (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=41.08333333333334 +lon_0=-71.5 +k=0.9");
    add_proj4text (p, 1,
        "9999375 +x_0=99999.99998983997 +y_0=0 +ellps=GRS80 +towg");
