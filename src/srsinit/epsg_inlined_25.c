...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 4878, "epsg", 4878,
        "ETRS89 / NTM zone 28 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4879, "epsg", 4879,
        "ETRS89 / NTM zone 29 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4880, "epsg", 4880,
        "ETRS89 / NTM zone 30 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4901, "epsg", 4901,
        "ATF (Paris)", 1, 1, "Plessis 1817", "Ancienne_Triangulation_Francaise_Paris", "grad", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4902, "epsg", 4902,
        "NDG (Paris)", 1, 1, "Plessis 1817", "Nord_de_Guerre_Paris", "grad", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4903, "epsg", 4903,
        "Madrid 1870 (Madrid)", 1, 1, "Struve 1860", "Madrid_1870_Madrid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4904, "epsg", 4904,
        "Lisbon 1890 (Lisbon)", 1, 1, "Bessel 1841", "Lisbon_1890_Lisbon", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5013, "epsg", 5013,
        "PTRA08", 1, 1, "GRS 1980", "Autonomous_Regions_of_Portugal_2008", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5014, "epsg", 5014,
        "PTRA08 / UTM zone 25N", 0, 0, "GRS 1980", "Autonomous_Regions_of_Portugal_2008", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5015, "epsg", 5015,
        "PTRA08 / UTM zone 26N", 0, 0, "GRS 1980", "Autonomous_Regions_of_Portugal_2008", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5016, "epsg", 5016,
        "PTRA08 / UTM zone 28N", 0, 0, "GRS 1980", "Autonomous_Regions_of_Portugal_2008", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5018, "epsg", 5018,
        "Lisbon / Portuguese Grid New", 0, 0, "International 1924", "Lisbon_1937", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5041, "epsg", 5041,
        "WGS 84 / UPS North (E,N)", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5042, "epsg", 5042,
        "WGS 84 / UPS South (E,N)", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5069, "epsg", 5069,
        "NAD27 / Conus Albers", 0, 0, "Clarke 1866", "North_American_Datum_1927", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5070, "epsg", 5070,
        "NAD83 / Conus Albers", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=aea +lat_1=29.5 +lat_2=45.5 +lat_0=23 +lon_0=-96 +");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 5071, "epsg", 5071,
        "NAD83(HARN) / Conus Albers", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=aea +lat_1=29.5 +lat_2=45.5 +lat_0=23 +lon_0=-96 +");
    add_proj4text (p, 1,
        "x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=");
    ...
    p = add_epsg_def_ex (filter, first, last, 5072, "epsg", 5072,
        "NAD83(NSRS2007) / Conus Albers", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=aea +lat_1=29.5 +lat_2=45.5 +lat_0=23 +lon_0=-96 +");
    add_proj4text (p, 1,
        "x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=");
    ...
    p = add_epsg_def_ex (filter, first, last, 5132, "epsg", 5132,
        "Tokyo 1892", 1, 1, "Bessel 1841", "Tokyo_1892", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5167, "epsg", 5167,
        "Korean 1985 / East Sea Belt", 0, 1, "Bessel 1841", "Korean_Datum_1985", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5168, "epsg", 5168,
        "Korean 1985 / Central Belt Jeju", 0, 1, "Bessel 1841", "Korean_Datum_1985", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5169, "epsg", 5169,
        "Tokyo 1892 / Korea West Belt", 0, 1, "Bessel 1841", "Tokyo_1892", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5170, "epsg", 5170,
        "Tokyo 1892 / Korea Central Belt", 0, 1, "Bessel 1841", "Tokyo_1892", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38 +lon_0=127 +k=1 +x_0=200000 +y_0=5");
    add_proj4text (p, 1,
        "00000 +ellps=bessel +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5171, "epsg", 5171,
        "Tokyo 1892 / Korea East Belt", 0, 1, "Bessel 1841", "Tokyo_1892", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5172, "epsg", 5172,
        "Tokyo 1892 / Korea East Sea Belt", 0, 1, "Bessel 1841", "Tokyo_1892", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38 +lon_0=131 +k=1 +x_0=200000 +y_0=5");
    add_proj4text (p, 1,
        "00000 +ellps=bessel +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5173, "epsg", 5173,
        "Korean 1985 / Modified West Belt", 0, 1, "Bessel 1841", "Korean_Datum_1985", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5174, "epsg", 5174,
        "Korean 1985 / Modified Central Belt", 0, 1, "Bessel 1841", "Korean_Datum_1985", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5175, "epsg", 5175,
        "Korean 1985 / Modified Central Belt Jeju", 0, 1, "Bessel 1841", "Korean_Datum_1985", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38 +lon_0=127.0028902777778 +k=1 +x_0");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 5176, "epsg", 5176,
        "Korean 1985 / Modified East Belt", 0, 1, "Bessel 1841", "Korean_Datum_1985", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5177, "epsg", 5177,
        "Korean 1985 / Modified East Sea Belt", 0, 1, "Bessel 1841", "Korean_Datum_1985", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5178, "epsg", 5178,
        "Korean 1985 / Unified CS", 0, 1, "Bessel 1841", "Korean_Datum_1985", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5179, "epsg", 5179,
        "Korea 2000 / Unified CS", 0, 1, "GRS 1980", "Geocentric_datum_of_Korea", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38 +lon_0=127.5 +k=0.9996 +x_0=100000");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 5180, "epsg", 5180,
        "Korea 2000 / West Belt", 0, 1, "GRS 1980", "Geocentric_datum_of_Korea", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38 +lon_0=125 +k=1 +x_0=200000 +y_0=5");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 5181, "epsg", 5181,
        "Korea 2000 / Central Belt", 0, 1, "GRS 1980", "Geocentric_datum_of_Korea", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38 +lon_0=127 +k=1 +x_0=200000 +y_0=5");
    add_proj4text (p, 1,
        "00000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_d");
    ...
    p = add_epsg_def_ex (filter, first, last, 5182, "epsg", 5182,
        "Korea 2000 / Central Belt Jeju", 0, 1, "GRS 1980", "Geocentric_datum_of_Korea", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38 +lon_0=127 +k=1 +x_0=200000 +y_0=5");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 5183, "epsg", 5183,
        "Korea 2000 / East Belt", 0, 1, "GRS 1980", "Geocentric_datum_of_Korea", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38 +lon_0=129 +k=1 +x_0=200000 +y_0=5");
    add_proj4text (p, 1,
        "00000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_d");
    ...
    p = add_epsg_def_ex (filter, first, last, 5184, "epsg", 5184,
        "Korea 2000 / East Sea Belt", 0, 1, "GRS 1980", "Geocentric_datum_of_Korea", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=38 +lon_0=131 +k=1 +x_0=200000 +y_0=5");
    add_proj4text (p, 1,
        "00000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_d");
    ...
    p = add_epsg_def_ex (filter, first, last, 5185, "epsg", 5185,
        "Korea 2000 / West Belt 2010", 0, 1, "GRS 1980", "Geocentric_datum_of_Korea", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5186, "epsg", 5186,
        "Korea 2000 / Central Belt 2010", 0, 1, "GRS 1980", "Geocentric_datum_of_Korea", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5187, "epsg", 5187,
        "Korea 2000 / East Belt 2010", 0, 1, "GRS 1980", "Geocentric_datum_of_Korea", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5188, "epsg", 5188,
        "Korea 2000 / East Sea Belt 2010", 0, 1, "GRS 1980", "Geocentric_datum_of_Korea", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5221, "epsg", 5221,
        "S-JTSK (Ferro) / Krovak East North", 0, 0, "Bessel 1841", "System_Jednotne_Trigonometricke_Site_Katastralni_Ferro", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5223, "epsg", 5223,
        "WGS 84 / Gabon TM", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5228, "epsg", 5228,
        "S-JTSK/05", 1, 1, "Bessel 1841", "System_Jednotne_Trigonometricke_Site_Katastralni_05", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5229, "epsg", 5229,
        "S-JTSK/05 (Ferro)", 1, 1, "Bessel 1841", "System_Jednotne_Trigonometricke_Site_Katastralni_05_Ferro", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=bessel +towgs84=572.213,85.334,461.");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 5233, "epsg", 5233,
        "SLD99", 1, 1, "Everest 1830 (1937 Adjustment)", "Sri_Lanka_Datum_1999", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5234, "epsg", 5234,
        "Kandawala / Sri Lanka Grid", 0, 0, "Everest 1830 (1937 Adjustment)", "Kandawala", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5235, "epsg", 5235,
        "SLD99 / Sri Lanka Grid 1999", 0, 0, "Everest 1830 (1937 Adjustment)", "Sri_Lanka_Datum_1999", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5243, "epsg", 5243,
        "ETRS89 / LCC Germany (E-N)", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5246, "epsg", 5246,
        "GDBD2009", 1, 1, "GRS 1980", "Geocentric_Datum_Brunei_Darussalam_2009", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5247, "epsg", 5247,
        "GDBD2009 / Brunei BRSO", 0, 0, "GRS 1980", "Geocentric_Datum_Brunei_Darussalam_2009", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5252, "epsg", 5252,
        "TUREF", 1, 1, "GRS 1980", "Turkish_National_Reference_Frame", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5253, "epsg", 5253,
        "TUREF / TM27", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5254, "epsg", 5254,
        "TUREF / TM30", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5255, "epsg", 5255,
        "TUREF / TM33", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5256, "epsg", 5256,
        "TUREF / TM36", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5257, "epsg", 5257,
        "TUREF / TM39", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5258, "epsg", 5258,
        "TUREF / TM42", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5259, "epsg", 5259,
        "TUREF / TM45", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5264, "epsg", 5264,
        "DRUKREF 03", 1, 1, "GRS 1980", "Bhutan_National_Geodetic_Datum", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5266, "epsg", 5266,
        "DRUKREF 03 / Bhutan National Grid", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5269, "epsg", 5269,
        "TUREF / 3-degree Gauss-Kruger zone 9", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5270, "epsg", 5270,
        "TUREF / 3-degree Gauss-Kruger zone 10", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5271, "epsg", 5271,
        "TUREF / 3-degree Gauss-Kruger zone 11", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5272, "epsg", 5272,
        "TUREF / 3-degree Gauss-Kruger zone 12", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5273, "epsg", 5273,
        "TUREF / 3-degree Gauss-Kruger zone 13", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5274, "epsg", 5274,
        "TUREF / 3-degree Gauss-Kruger zone 14", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5275, "epsg", 5275,
        "TUREF / 3-degree Gauss-Kruger zone 15", 0, 1, "GRS 1980", "Turkish_National_Reference_Frame", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5292, "epsg", 5292,
        "DRUKREF 03 / Bumthang TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5293, "epsg", 5293,
        "DRUKREF 03 / Chhukha TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5294, "epsg", 5294,
        "DRUKREF 03 / Dagana TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5295, "epsg", 5295,
        "DRUKREF 03 / Gasa TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5296, "epsg", 5296,
        "DRUKREF 03 / Ha TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5297, "epsg", 5297,
        "DRUKREF 03 / Lhuentse TM", 0, 0, "GRS 1980", "Bhutan_National_Geodetic_Datum", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
