/*
 ...
 this code was autogenerated by "auto_epsg_ext" on Thu Dec  4 10:42:55 2014
...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 3890, "epsg", 3890,
        "IGRS / UTM zone 37N", 0, 0, "GRS 1980", "Iraqi_Geospatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3891, "epsg", 3891,
        "IGRS / UTM zone 38N", 0, 0, "GRS 1980", "Iraqi_Geospatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3892, "epsg", 3892,
        "IGRS / UTM zone 39N", 0, 0, "GRS 1980", "Iraqi_Geospatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3893, "epsg", 3893,
        "ED50 / Iraq National Grid", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3901, "epsg", 3901,
        "KKJ / Finland Uniform Coordinate System", 0, 1, "International 1924", "Kartastokoordinaattijarjestelma_1966", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3902, "epsg", 3902,
        "ETRS89 / TM35FIN(N,E)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3906, "epsg", 3906,
        "MGI 1901", 1, 1, "Bessel 1841", "MGI_1901", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3907, "epsg", 3907,
        "MGI 1901 / Balkans zone 5", 0, 1, "Bessel 1841", "MGI_1901", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3908, "epsg", 3908,
        "MGI 1901 / Balkans zone 6", 0, 1, "Bessel 1841", "MGI_1901", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3909, "epsg", 3909,
        "MGI 1901 / Balkans zone 7", 0, 1, "Bessel 1841", "MGI_1901", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3910, "epsg", 3910,
        "MGI 1901 / Balkans zone 8", 0, 1, "Bessel 1841", "MGI_1901", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3911, "epsg", 3911,
        "MGI 1901 / Slovenia Grid", 0, 1, "Bessel 1841", "MGI_1901", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3912, "epsg", 3912,
        "MGI 1901 / Slovene National Grid", 0, 0, "Bessel 1841", "MGI_1901", "metre", "Y", "East", "X", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=15 +k=0.9999 +x_0=500000 +y_");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3920, "epsg", 3920,
        "Puerto Rico / UTM zone 20N", 0, 0, "Clarke 1866", "Puerto_Rico", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3942, "epsg", 3942,
        "RGF93 / CC42", 0, 0, "GRS 1980", "Reseau_Geodesique_Francais_1993", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3943, "epsg", 3943,
        "RGF93 / CC43", 0, 0, "GRS 1980", "Reseau_Geodesique_Francais_1993", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3944, "epsg", 3944,
        "RGF93 / CC44", 0, 0, "GRS 1980", "Reseau_Geodesique_Francais_1993", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3945, "epsg", 3945,
        "RGF93 / CC45", 0, 0, "GRS 1980", "Reseau_Geodesique_Francais_1993", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3946, "epsg", 3946,
        "RGF93 / CC46", 0, 0, "GRS 1980", "Reseau_Geodesique_Francais_1993", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3947, "epsg", 3947,
        "RGF93 / CC47", 0, 0, "GRS 1980", "Reseau_Geodesique_Francais_1993", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3948, "epsg", 3948,
        "RGF93 / CC48", 0, 0, "GRS 1980", "Reseau_Geodesique_Francais_1993", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3949, "epsg", 3949,
        "RGF93 / CC49", 0, 0, "GRS 1980", "Reseau_Geodesique_Francais_1993", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3950, "epsg", 3950,
        "RGF93 / CC50", 0, 0, "GRS 1980", "Reseau_Geodesique_Francais_1993", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3968, "epsg", 3968,
        "NAD83 / Virginia Lambert", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3969, "epsg", 3969,
        "NAD83(HARN) / Virginia Lambert", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=37 +lat_2=39.5 +lat_0=36 +lon_0=-79.5 +");
    add_proj4text (p, 1,
        "x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=");
    ...
    p = add_epsg_def_ex (filter, first, last, 3970, "epsg", 3970,
        "NAD83(NSRS2007) / Virginia Lambert", 0, 0, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=37 +lat_2=39.5 +lat_0=36 +lon_0=-79.5 +");
    add_proj4text (p, 1,
        "x_0=0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=");
    ...
    p = add_epsg_def_ex (filter, first, last, 3973, "epsg", 3973,
        "WGS 84 / NSIDC EASE-Grid North", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3974, "epsg", 3974,
        "WGS 84 / NSIDC EASE-Grid South", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3975, "epsg", 3975,
        "WGS 84 / NSIDC EASE-Grid Global", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3976, "epsg", 3976,
        "WGS 84 / NSIDC Sea Ice Polar Stereographic South", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3978, "epsg", 3978,
        "NAD83 / Canada Atlas Lambert", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3979, "epsg", 3979,
        "NAD83(CSRS) / Canada Atlas Lambert", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=49 +lat_2=77 +lat_0=49 +lon_0=-95 +x_0=");
    add_proj4text (p, 1,
        "0 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +n");
    ...
    p = add_epsg_def_ex (filter, first, last, 3985, "epsg", 3985,
        "Katanga 1955 / Katanga Lambert (deprecated)", 0, 0, "Clarke 1866", "Katanga_1955", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3986, "epsg", 3986,
        "Katanga 1955 / Katanga Gauss zone A", 0, 0, "Clarke 1866", "Katanga_1955", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3987, "epsg", 3987,
        "Katanga 1955 / Katanga Gauss zone B", 0, 0, "Clarke 1866", "Katanga_1955", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3988, "epsg", 3988,
        "Katanga 1955 / Katanga Gauss zone C", 0, 0, "Clarke 1866", "Katanga_1955", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3989, "epsg", 3989,
        "Katanga 1955 / Katanga Gauss zone D", 0, 0, "Clarke 1866", "Katanga_1955", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3991, "epsg", 3991,
        "Puerto Rico State Plane CS of 1927", 0, 0, "Clarke 1866", "Puerto_Rico", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3992, "epsg", 3992,
        "Puerto Rico / St. Croix", 0, 0, "Clarke 1866", "Puerto_Rico", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=18.43333333333333 +lat_2=18.03333333333");
    add_proj4text (p, 1,
        "333 +lat_0=17.83333333333333 +lon_0=-66.43333333333334 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 3994, "epsg", 3994,
        "WGS 84 / Mercator 41", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3995, "epsg", 3995,
        "WGS 84 / Arctic Polar Stereographic", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3996, "epsg", 3996,
        "WGS 84 / IBCAO Polar Stereographic", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3997, "epsg", 3997,
        "WGS 84 / Dubai Local TM", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4001, "epsg", 4001,
        "Unknown datum based upon the Airy 1830 ellipsoid", 1, 1, "Airy 1830", "Not_specified_based_on_Airy_1830_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4002, "epsg", 4002,
        "Unknown datum based upon the Airy Modified 1849 ellipsoid", 1, 1, "Airy Modified 1849", "Not_specified_based_on_Airy_Modified_1849_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4003, "epsg", 4003,
        "Unknown datum based upon the Australian National Spheroid", 1, 1, "Australian National Spheroid", "Not_specified_based_on_Australian_National_Spheroid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4004, "epsg", 4004,
        "Unknown datum based upon the Bessel 1841 ellipsoid", 1, 1, "Bessel 1841", "Not_specified_based_on_Bessel_1841_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4005, "epsg", 4005,
        "Unknown datum based upon the Bessel Modified ellipsoid", 1, 1, "Bessel Modified", "Not_specified_based_on_Bessel_Modified_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4006, "epsg", 4006,
        "Unknown datum based upon the Bessel Namibia ellipsoid", 1, 1, "Bessel Namibia (GLM)", "Not_specified_based_on_Bessel_Namibia_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4007, "epsg", 4007,
        "Unknown datum based upon the Clarke 1858 ellipsoid", 1, 1, "Clarke 1858", "Not_specified_based_on_Clarke_1858_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4008, "epsg", 4008,
        "Unknown datum based upon the Clarke 1866 ellipsoid", 1, 1, "Clarke 1866", "Not_specified_based_on_Clarke_1866_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4009, "epsg", 4009,
        "Unknown datum based upon the Clarke 1866 Michigan ellipsoid", 1, 1, "Clarke 1866 Michigan", "Not_specified_based_on_Clarke_1866_Michigan_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4010, "epsg", 4010,
        "Unknown datum based upon the Clarke 1880 (Benoit) ellipsoid", 1, 1, "Clarke 1880 (Benoit)", "Not_specified_based_on_Clarke_1880_Benoit_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4011, "epsg", 4011,
        "Unknown datum based upon the Clarke 1880 (IGN) ellipsoid", 1, 1, "Clarke 1880 (IGN)", "Not_specified_based_on_Clarke_1880_IGN_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4012, "epsg", 4012,
        "Unknown datum based upon the Clarke 1880 (RGS) ellipsoid", 1, 1, "Clarke 1880 (RGS)", "Not_specified_based_on_Clarke_1880_RGS_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4013, "epsg", 4013,
        "Unknown datum based upon the Clarke 1880 (Arc) ellipsoid", 1, 1, "Clarke 1880 (Arc)", "Not_specified_based_on_Clarke_1880_Arc_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4014, "epsg", 4014,
        "Unknown datum based upon the Clarke 1880 (SGA 1922) ellipsoid", 1, 1, "Clarke 1880 (SGA 1922)", "Not_specified_based_on_Clarke_1880_SGA_1922_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4015, "epsg", 4015,
        "Unknown datum based upon the Everest 1830 (1937 Adjustment) ellipsoid", 1, 1, "Everest 1830 (1937 Adjustment)", "Not_specified_based_on_Everest_1830_1937_Adjustment_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4016, "epsg", 4016,
        "Unknown datum based upon the Everest 1830 (1967 Definition) ellipsoid", 1, 1, "Everest 1830 (1967 Definition)", "Not_specified_based_on_Everest_1830_1967_Definition_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4018, "epsg", 4018,
        "Unknown datum based upon the Everest 1830 Modified ellipsoid", 1, 1, "Everest 1830 Modified", "Not_specified_based_on_Everest_1830_Modified_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4019, "epsg", 4019,
        "Unknown datum based upon the GRS 1980 ellipsoid", 1, 1, "GRS 1980", "Not_specified_based_on_GRS_1980_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4020, "epsg", 4020,
        "Unknown datum based upon the Helmert 1906 ellipsoid", 1, 1, "Helmert 1906", "Not_specified_based_on_Helmert_1906_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4021, "epsg", 4021,
        "Unknown datum based upon the Indonesian National Spheroid", 1, 1, "Indonesian National Spheroid", "Not_specified_based_on_Indonesian_National_Spheroid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4022, "epsg", 4022,
        "Unknown datum based upon the International 1924 ellipsoid", 1, 1, "International 1924", "Not_specified_based_on_International_1924_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4023, "epsg", 4023,
        "MOLDREF99", 1, 1, "GRS 1980", "MOLDREF99", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4024, "epsg", 4024,
        "Unknown datum based upon the Krassowsky 1940 ellipsoid", 1, 1, "Krassowsky 1940", "Not_specified_based_on_Krassowsky_1940_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4025, "epsg", 4025,
        "Unknown datum based upon the NWL 9D ellipsoid", 1, 1, "NWL 9D", "Not_specified_based_on_NWL_9D_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4026, "epsg", 4026,
        "MOLDREF99 / Moldova TM", 0, 1, "GRS 1980", "MOLDREF99", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4027, "epsg", 4027,
        "Unknown datum based upon the Plessis 1817 ellipsoid", 1, 1, "Plessis 1817", "Not_specified_based_on_Plessis_1817_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4028, "epsg", 4028,
        "Unknown datum based upon the Struve 1860 ellipsoid", 1, 1, "Struve 1860", "Not_specified_based_on_Struve_1860_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4029, "epsg", 4029,
        "Unknown datum based upon the War Office ellipsoid", 1, 1, "War Office", "Not_specified_based_on_War_Office_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4030, "epsg", 4030,
        "Unknown datum based upon the WGS 84 ellipsoid", 1, 1, "WGS 84", "Not_specified_based_on_WGS_84_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4031, "epsg", 4031,
        "Unknown datum based upon the GEM 10C ellipsoid", 1, 1, "GEM 10C", "Not_specified_based_on_GEM_10C_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=WGS84 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4032, "epsg", 4032,
        "Unknown datum based upon the OSU86F ellipsoid", 1, 1, "OSU86F", "Not_specified_based_on_OSU86F_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4033, "epsg", 4033,
        "Unknown datum based upon the OSU91A ellipsoid", 1, 1, "OSU91A", "Not_specified_based_on_OSU91A_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4034, "epsg", 4034,
        "Unknown datum based upon the Clarke 1880 ellipsoid", 1, 1, "Clarke 1880", "Not_specified_based_on_Clarke_1880_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4035, "epsg", 4035,
        "Unknown datum based upon the Authalic Sphere", 1, 1, "Sphere", "Not_specified_based_on_Authalic_Sphere", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4036, "epsg", 4036,
        "Unknown datum based upon the GRS 1967 ellipsoid", 1, 1, "GRS 1967", "Not_specified_based_on_GRS_1967_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4037, "epsg", 4037,
        "WGS 84 / TMzn35N", 0, 1, "WGS 84", "WGS_1984", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4038, "epsg", 4038,
        "WGS 84 / TMzn36N", 0, 1, "WGS 84", "WGS_1984", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4041, "epsg", 4041,
        "Unknown datum based upon the Average Terrestrial System 1977 ellipsoid", 1, 1, "Average Terrestrial System 1977", "Not_specified_based_on_Average_Terrestrial_System_1977_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4042, "epsg", 4042,
        "Unknown datum based upon the Everest (1830 Definition) ellipsoid", 1, 1, "Everest (1830 Definition)", "Not_specified_based_on_Everest_1830_Definition_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4043, "epsg", 4043,
        "Unknown datum based upon the WGS 72 ellipsoid", 1, 1, "WGS 72", "Not_specified_based_on_WGS_72_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4044, "epsg", 4044,
        "Unknown datum based upon the Everest 1830 (1962 Definition) ellipsoid", 1, 1, "Everest 1830 (1962 Definition)", "Not_specified_based_on_Everest_1830_1962_Definition_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4045, "epsg", 4045,
        "Unknown datum based upon the Everest 1830 (1975 Definition) ellipsoid", 1, 1, "Everest 1830 (1975 Definition)", "Not_specified_based_on_Everest_1830_1975_Definition_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4046, "epsg", 4046,
        "RGRDC 2005", 1, 1, "GRS 1980", "Reseau_Geodesique_de_la_RDC_2005", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4047, "epsg", 4047,
        "Unspecified datum based upon the GRS 1980 Authalic Sphere", 1, 1, "GRS 1980 Authalic Sphere", "Not_specified_based_on_GRS_1980_Authalic_Sphere", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4048, "epsg", 4048,
        "RGRDC 2005 / Congo TM zone 12", 0, 0, "GRS 1980", "Reseau_Geodesique_de_la_RDC_2005", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4049, "epsg", 4049,
        "RGRDC 2005 / Congo TM zone 14", 0, 0, "GRS 1980", "Reseau_Geodesique_de_la_RDC_2005", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4050, "epsg", 4050,
        "RGRDC 2005 / Congo TM zone 16", 0, 0, "GRS 1980", "Reseau_Geodesique_de_la_RDC_2005", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4051, "epsg", 4051,
        "RGRDC 2005 / Congo TM zone 18", 0, 0, "GRS 1980", "Reseau_Geodesique_de_la_RDC_2005", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4052, "epsg", 4052,
        "Unspecified datum based upon the Clarke 1866 Authalic Sphere", 1, 1, "Clarke 1866 Authalic Sphere", "Not_specified_based_on_Clarke_1866_Authalic_Sphere", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4053, "epsg", 4053,
        "Unspecified datum based upon the International 1924 Authalic Sphere", 1, 1, "International 1924 Authalic Sphere", "Not_specified_based_on_International_1924_Authalic_Sphere", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4054, "epsg", 4054,
        "Unspecified datum based upon the Hughes 1980 ellipsoid", 1, 1, "Hughes 1980", "Not_specified_based_on_Hughes_1980_ellipsoid", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4055, "epsg", 4055,
        "Popular Visualisation CRS", 1, 1, "Popular Visualisation Sphere", "Popular_Visualisation_Datum", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4056, "epsg", 4056,
        "RGRDC 2005 / Congo TM zone 20", 0, 0, "GRS 1980", "Reseau_Geodesique_de_la_RDC_2005", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4057, "epsg", 4057,
        "RGRDC 2005 / Congo TM zone 22", 0, 0, "GRS 1980", "Reseau_Geodesique_de_la_RDC_2005", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4058, "epsg", 4058,
        "RGRDC 2005 / Congo TM zone 24", 0, 0, "GRS 1980", "Reseau_Geodesique_de_la_RDC_2005", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4059, "epsg", 4059,
        "RGRDC 2005 / Congo TM zone 26", 0, 0, "GRS 1980", "Reseau_Geodesique_de_la_RDC_2005", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4060, "epsg", 4060,
        "RGRDC 2005 / Congo TM zone 28", 0, 0, "GRS 1980", "Reseau_Geodesique_de_la_RDC_2005", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
