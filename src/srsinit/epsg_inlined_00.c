...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 2000, "epsg", 2000,
        "Anguilla 1957 / British West Indies Grid", 0, 0, "Clarke 1880 (RGS)", "Anguilla_1957", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2001, "epsg", 2001,
        "Antigua 1943 / British West Indies Grid", 0, 0, "Clarke 1880 (RGS)", "Antigua_1943", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-62 +k=0.9995000000000001 +x");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2002, "epsg", 2002,
        "Dominica 1945 / British West Indies Grid", 0, 0, "Clarke 1880 (RGS)", "Dominica_1945", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-62 +k=0.9995000000000001 +x");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2003, "epsg", 2003,
        "Grenada 1953 / British West Indies Grid", 0, 0, "Clarke 1880 (RGS)", "Grenada_1953", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-62 +k=0.9995000000000001 +x");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2004, "epsg", 2004,
        "Montserrat 1958 / British West Indies Grid", 0, 0, "Clarke 1880 (RGS)", "Montserrat_1958", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-62 +k=0.9995000000000001 +x");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2005, "epsg", 2005,
        "St. Kitts 1955 / British West Indies Grid", 0, 0, "Clarke 1880 (RGS)", "St_Kitts_1955", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-62 +k=0.9995000000000001 +x");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2006, "epsg", 2006,
        "St. Lucia 1955 / British West Indies Grid", 0, 0, "Clarke 1880 (RGS)", "St_Lucia_1955", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-62 +k=0.9995000000000001 +x");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2007, "epsg", 2007,
        "St. Vincent 45 / British West Indies Grid", 0, 0, "Clarke 1880 (RGS)", "St_Vincent_1945", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-62 +k=0.9995000000000001 +x");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2008, "epsg", 2008,
        "NAD27(CGQ77) / SCoPQ zone 2 (deprecated)", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2009, "epsg", 2009,
        "NAD27(CGQ77) / SCoPQ zone 3", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2010, "epsg", 2010,
        "NAD27(CGQ77) / SCoPQ zone 4", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2011, "epsg", 2011,
        "NAD27(CGQ77) / SCoPQ zone 5", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2012, "epsg", 2012,
        "NAD27(CGQ77) / SCoPQ zone 6", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2013, "epsg", 2013,
        "NAD27(CGQ77) / SCoPQ zone 7", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2014, "epsg", 2014,
        "NAD27(CGQ77) / SCoPQ zone 8", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2015, "epsg", 2015,
        "NAD27(CGQ77) / SCoPQ zone 9", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2016, "epsg", 2016,
        "NAD27(CGQ77) / SCoPQ zone 10", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2017, "epsg", 2017,
        "NAD27(76) / MTM zone 8", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-73.5 +k=0.9999 +x_0=304800 ");
    add_proj4text (p, 1,
        "+y_0=0 +ellps=clrk66 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2018, "epsg", 2018,
        "NAD27(76) / MTM zone 9", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-76.5 +k=0.9999 +x_0=304800 ");
    add_proj4text (p, 1,
        "+y_0=0 +ellps=clrk66 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2019, "epsg", 2019,
        "NAD27(76) / MTM zone 10", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-79.5 +k=0.9999 +x_0=304800 ");
    add_proj4text (p, 1,
        "+y_0=0 +ellps=clrk66 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 2020, "epsg", 2020,
        "NAD27(76) / MTM zone 11", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2021, "epsg", 2021,
        "NAD27(76) / MTM zone 12", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2022, "epsg", 2022,
        "NAD27(76) / MTM zone 13", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2023, "epsg", 2023,
        "NAD27(76) / MTM zone 14", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2024, "epsg", 2024,
        "NAD27(76) / MTM zone 15", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2025, "epsg", 2025,
        "NAD27(76) / MTM zone 16", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2026, "epsg", 2026,
        "NAD27(76) / MTM zone 17", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2027, "epsg", 2027,
        "NAD27(76) / UTM zone 15N", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2028, "epsg", 2028,
        "NAD27(76) / UTM zone 16N", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2029, "epsg", 2029,
        "NAD27(76) / UTM zone 17N", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2030, "epsg", 2030,
        "NAD27(76) / UTM zone 18N", 0, 0, "Clarke 1866", "North_American_Datum_1927_1976", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2031, "epsg", 2031,
        "NAD27(CGQ77) / UTM zone 17N", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=utm +zone=17 +ellps=clrk66 +units=m +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2032, "epsg", 2032,
        "NAD27(CGQ77) / UTM zone 18N", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=utm +zone=18 +ellps=clrk66 +units=m +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2033, "epsg", 2033,
        "NAD27(CGQ77) / UTM zone 19N", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2034, "epsg", 2034,
        "NAD27(CGQ77) / UTM zone 20N", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2035, "epsg", 2035,
        "NAD27(CGQ77) / UTM zone 21N", 0, 0, "Clarke 1866", "North_American_Datum_1927_CGQ77", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2036, "epsg", 2036,
        "NAD83(CSRS98) / New Brunswick Stereo (deprecated)", 0, 1, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2037, "epsg", 2037,
        "NAD83(CSRS98) / UTM zone 19N (deprecated)", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2038, "epsg", 2038,
        "NAD83(CSRS98) / UTM zone 20N (deprecated)", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2039, "epsg", 2039,
        "Israel / Israeli TM Grid", 0, 0, "GRS 1980", "Israel", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2040, "epsg", 2040,
        "Locodjo 1965 / UTM zone 30N", 0, 0, "Clarke 1880 (RGS)", "Locodjo_1965", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2041, "epsg", 2041,
        "Abidjan 1987 / UTM zone 30N", 0, 0, "Clarke 1880 (RGS)", "Abidjan_1987", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2042, "epsg", 2042,
        "Locodjo 1965 / UTM zone 29N", 0, 0, "Clarke 1880 (RGS)", "Locodjo_1965", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2043, "epsg", 2043,
        "Abidjan 1987 / UTM zone 29N", 0, 0, "Clarke 1880 (RGS)", "Abidjan_1987", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2044, "epsg", 2044,
        "Hanoi 1972 / Gauss-Kruger zone 18", 0, 1, "Krassowsky 1940", "Hanoi_1972", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2045, "epsg", 2045,
        "Hanoi 1972 / Gauss-Kruger zone 19", 0, 1, "Krassowsky 1940", "Hanoi_1972", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2046, "epsg", 2046,
        "Hartebeesthoek94 / Lo15", 0, 0, "WGS 84", "Hartebeesthoek94", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2047, "epsg", 2047,
        "Hartebeesthoek94 / Lo17", 0, 0, "WGS 84", "Hartebeesthoek94", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2048, "epsg", 2048,
        "Hartebeesthoek94 / Lo19", 0, 0, "WGS 84", "Hartebeesthoek94", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2049, "epsg", 2049,
        "Hartebeesthoek94 / Lo21", 0, 0, "WGS 84", "Hartebeesthoek94", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2050, "epsg", 2050,
        "Hartebeesthoek94 / Lo23", 0, 0, "WGS 84", "Hartebeesthoek94", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2051, "epsg", 2051,
        "Hartebeesthoek94 / Lo25", 0, 0, "WGS 84", "Hartebeesthoek94", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2052, "epsg", 2052,
        "Hartebeesthoek94 / Lo27", 0, 0, "WGS 84", "Hartebeesthoek94", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2053, "epsg", 2053,
        "Hartebeesthoek94 / Lo29", 0, 0, "WGS 84", "Hartebeesthoek94", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2054, "epsg", 2054,
        "Hartebeesthoek94 / Lo31", 0, 0, "WGS 84", "Hartebeesthoek94", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2055, "epsg", 2055,
        "Hartebeesthoek94 / Lo33", 0, 0, "WGS 84", "Hartebeesthoek94", "metre", "Y", "West", "X", "South");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2056, "epsg", 2056,
        "CH1903+ / LV95", 0, 0, "Bessel 1841", "CH1903+", "metre", "Y", "East", "X", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2057, "epsg", 2057,
        "Rassadiran / Nakhl e Taqi", 0, 0, "International 1924", "Rassadiran", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2058, "epsg", 2058,
        "ED50(ED77) / UTM zone 38N", 0, 0, "International 1924", "European_Datum_1950_1977", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2059, "epsg", 2059,
        "ED50(ED77) / UTM zone 39N", 0, 0, "International 1924", "European_Datum_1950_1977", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2060, "epsg", 2060,
        "ED50(ED77) / UTM zone 40N", 0, 0, "International 1924", "European_Datum_1950_1977", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2061, "epsg", 2061,
        "ED50(ED77) / UTM zone 41N", 0, 0, "International 1924", "European_Datum_1950_1977", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2062, "epsg", 2062,
        "Madrid 1870 (Madrid) / Spain", 0, 0, "Struve 1860", "Madrid_1870_Madrid", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2063, "epsg", 2063,
        "Dabola 1981 / UTM zone 28N (deprecated)", 0, 0, "Clarke 1880 (IGN)", "Conakry_1905", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2064, "epsg", 2064,
        "Dabola 1981 / UTM zone 29N (deprecated)", 0, 0, "Clarke 1880 (IGN)", "Conakry_1905", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2065, "epsg", 2065,
        "S-JTSK (Ferro) / Krovak", 0, 0, "Bessel 1841", "System_Jednotne_Trigonometricke_Site_Katastralni_Ferro", "metre", "X", "South", "Y", "West");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2066, "epsg", 2066,
        "Mount Dillon / Tobago Grid", 0, 0, "Clarke 1858", "Mount_Dillon", "Clarke's link", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2067, "epsg", 2067,
        "Naparima 1955 / UTM zone 20N", 0, 0, "International 1924", "Naparima_1955", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2068, "epsg", 2068,
        "ELD79 / Libya zone 5", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2069, "epsg", 2069,
        "ELD79 / Libya zone 6", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2070, "epsg", 2070,
        "ELD79 / Libya zone 7", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2071, "epsg", 2071,
        "ELD79 / Libya zone 8", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2072, "epsg", 2072,
        "ELD79 / Libya zone 9", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2073, "epsg", 2073,
        "ELD79 / Libya zone 10", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2074, "epsg", 2074,
        "ELD79 / Libya zone 11", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2075, "epsg", 2075,
        "ELD79 / Libya zone 12", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2076, "epsg", 2076,
        "ELD79 / Libya zone 13", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2077, "epsg", 2077,
        "ELD79 / UTM zone 32N", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2078, "epsg", 2078,
        "ELD79 / UTM zone 33N", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2079, "epsg", 2079,
        "ELD79 / UTM zone 34N", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2080, "epsg", 2080,
        "ELD79 / UTM zone 35N", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2081, "epsg", 2081,
        "Chos Malal 1914 / Argentina 2", 0, 1, "International 1924", "Chos_Malal_1914", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2082, "epsg", 2082,
        "Pampa del Castillo / Argentina 2", 0, 1, "International 1924", "Pampa_del_Castillo", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-69 +k=1 +x_0=2500000 +y_0");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2083, "epsg", 2083,
        "Hito XVIII 1963 / Argentina 2", 0, 1, "International 1924", "Hito_XVIII_1963", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=-90 +lon_0=-69 +k=1 +x_0=2500000 +y_0");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 2084, "epsg", 2084,
        "Hito XVIII 1963 / UTM zone 19S", 0, 0, "International 1924", "Hito_XVIII_1963", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2085, "epsg", 2085,
        "NAD27 / Cuba Norte (deprecated)", 0, 1, "Clarke 1866", "North_American_Datum_1927", "metre", "Y", "North", "X", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2086, "epsg", 2086,
        "NAD27 / Cuba Sur (deprecated)", 0, 1, "Clarke 1866", "North_American_Datum_1927", "metre", "Y", "North", "X", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2087, "epsg", 2087,
        "ELD79 / TM 12 NE", 0, 0, "International 1924", "European_Libyan_Datum_1979", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2088, "epsg", 2088,
        "Carthage / TM 11 NE", 0, 0, "Clarke 1880 (IGN)", "Carthage", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2089, "epsg", 2089,
        "Yemen NGN96 / UTM zone 38N", 0, 0, "WGS 84", "Yemen_National_Geodetic_Network_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2090, "epsg", 2090,
        "Yemen NGN96 / UTM zone 39N", 0, 0, "WGS 84", "Yemen_National_Geodetic_Network_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2091, "epsg", 2091,
        "South Yemen / Gauss Kruger zone 8 (deprecated)", 0, 1, "Krassowsky 1940", "South_Yemen", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2092, "epsg", 2092,
        "South Yemen / Gauss Kruger zone 9 (deprecated)", 0, 1, "Krassowsky 1940", "South_Yemen", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2093, "epsg", 2093,
        "Hanoi 1972 / GK 106 NE", 0, 1, "Krassowsky 1940", "Hanoi_1972", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2094, "epsg", 2094,
        "WGS 72BE / TM 106 NE", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2095, "epsg", 2095,
        "Bissau / UTM zone 28N", 0, 0, "International 1924", "Bissau", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2096, "epsg", 2096,
        "Korean 1985 / East Belt", 0, 1, "Bessel 1841", "Korean_Datum_1985", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2097, "epsg", 2097,
        "Korean 1985 / Central Belt", 0, 1, "Bessel 1841", "Korean_Datum_1985", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2098, "epsg", 2098,
        "Korean 1985 / West Belt", 0, 1, "Bessel 1841", "Korean_Datum_1985", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2099, "epsg", 2099,
        "Qatar 1948 / Qatar Grid", 0, 0, "Helmert 1906", "Qatar_1948", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 2100, "epsg", 2100,
        "GGRS87 / Greek Grid", 0, 0, "GRS 1980", "Greek_Geodetic_Reference_System_1987", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
