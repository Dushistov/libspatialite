...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 4206, "epsg", 4206,
        "Agadez", 1, 1, "Clarke 1880 (IGN)", "Agadez", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4207, "epsg", 4207,
        "Lisbon", 1, 1, "International 1924", "Lisbon_1937", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4208, "epsg", 4208,
        "Aratu", 1, 1, "International 1924", "Aratu", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4209, "epsg", 4209,
        "Arc 1950", 1, 1, "Clarke 1880 (Arc)", "Arc_1950", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4210, "epsg", 4210,
        "Arc 1960", 1, 1, "Clarke 1880 (RGS)", "Arc_1960", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4211, "epsg", 4211,
        "Batavia", 1, 1, "Bessel 1841", "Batavia", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4212, "epsg", 4212,
        "Barbados 1938", 1, 1, "Clarke 1880 (RGS)", "Barbados_1938", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4213, "epsg", 4213,
        "Beduaram", 1, 1, "Clarke 1880 (IGN)", "Beduaram", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4214, "epsg", 4214,
        "Beijing 1954", 1, 1, "Krassowsky 1940", "Beijing_1954", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4215, "epsg", 4215,
        "Belge 1950", 1, 1, "International 1924", "Reseau_National_Belge_1950", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4216, "epsg", 4216,
        "Bermuda 1957", 1, 1, "Clarke 1866", "Bermuda_1957", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4217, "epsg", 4217,
        "NAD83 / BLM 59N (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4218, "epsg", 4218,
        "Bogota 1975", 1, 1, "International 1924", "Bogota_1975", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4219, "epsg", 4219,
        "Bukit Rimpah", 1, 1, "Bessel 1841", "Bukit_Rimpah", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4220, "epsg", 4220,
        "Camacupa", 1, 1, "Clarke 1880 (RGS)", "Camacupa", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4221, "epsg", 4221,
        "Campo Inchauspe", 1, 1, "International 1924", "Campo_Inchauspe", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4222, "epsg", 4222,
        "Cape", 1, 1, "Clarke 1880 (Arc)", "Cape", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +a=6378249.145 +b=6356514.966398753 +towgs");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 4223, "epsg", 4223,
        "Carthage", 1, 1, "Clarke 1880 (IGN)", "Carthage", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4224, "epsg", 4224,
        "Chua", 1, 1, "International 1924", "Chua", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4225, "epsg", 4225,
        "Corrego Alegre 1970-72", 1, 1, "International 1924", "Corrego_Alegre_1970_72", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4226, "epsg", 4226,
        "Cote d'Ivoire", 1, 1, "Clarke 1880 (IGN)", "Cote_d_Ivoire", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +a=6378249.2 +b=6356515 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4227, "epsg", 4227,
        "Deir ez Zor", 1, 1, "Clarke 1880 (IGN)", "Deir_ez_Zor", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4228, "epsg", 4228,
        "Douala", 1, 1, "Clarke 1880 (IGN)", "Douala", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +a=6378249.2 +b=6356515 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4229, "epsg", 4229,
        "Egypt 1907", 1, 1, "Helmert 1906", "Egypt_1907", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4230, "epsg", 4230,
        "ED50", 1, 1, "International 1924", "European_Datum_1950", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4231, "epsg", 4231,
        "ED87", 1, 1, "International 1924", "European_Datum_1987", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4232, "epsg", 4232,
        "Fahud", 1, 1, "Clarke 1880 (RGS)", "Fahud", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4233, "epsg", 4233,
        "Gandajika 1970", 1, 1, "International 1924", "Gandajika_1970", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4234, "epsg", 4234,
        "Garoua", 1, 1, "Clarke 1880 (IGN)", "Garoua", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +a=6378249.2 +b=6356515 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4235, "epsg", 4235,
        "Guyane Francaise", 1, 1, "International 1924", "Guyane_Francaise", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=intl +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4236, "epsg", 4236,
        "Hu Tzu Shan 1950", 1, 1, "International 1924", "Hu_Tzu_Shan_1950", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4237, "epsg", 4237,
        "HD72", 1, 1, "GRS 1967", "Hungarian_Datum_1972", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4238, "epsg", 4238,
        "ID74", 1, 1, "Indonesian National Spheroid", "Indonesian_Datum_1974", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4239, "epsg", 4239,
        "Indian 1954", 1, 1, "Everest 1830 (1937 Adjustment)", "Indian_1954", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4240, "epsg", 4240,
        "Indian 1975", 1, 1, "Everest 1830 (1937 Adjustment)", "Indian_1975", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +a=6377276.345 +b=6356075.41314024 +towgs8");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 4241, "epsg", 4241,
        "Jamaica 1875", 1, 1, "Clarke 1880", "Jamaica_1875", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4242, "epsg", 4242,
        "JAD69", 1, 1, "Clarke 1866", "Jamaica_1969", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4243, "epsg", 4243,
        "Kalianpur 1880", 1, 1, "Everest (1830 Definition)", "Kalianpur_1880", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4244, "epsg", 4244,
        "Kandawala", 1, 1, "Everest 1830 (1937 Adjustment)", "Kandawala", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +a=6377276.345 +b=6356075.41314024 +towgs8");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 4245, "epsg", 4245,
        "Kertau 1968", 1, 1, "Everest 1830 Modified", "Kertau_1968", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4246, "epsg", 4246,
        "KOC", 1, 1, "Clarke 1880 (RGS)", "Kuwait_Oil_Company", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4247, "epsg", 4247,
        "La Canoa", 1, 1, "International 1924", "La_Canoa", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4248, "epsg", 4248,
        "PSAD56", 1, 1, "International 1924", "Provisional_South_American_Datum_1956", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4249, "epsg", 4249,
        "Lake", 1, 1, "International 1924", "Lake", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=intl +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4250, "epsg", 4250,
        "Leigon", 1, 1, "Clarke 1880 (RGS)", "Leigon", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4251, "epsg", 4251,
        "Liberia 1964", 1, 1, "Clarke 1880 (RGS)", "Liberia_1964", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4252, "epsg", 4252,
        "Lome", 1, 1, "Clarke 1880 (IGN)", "Lome", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +a=6378249.2 +b=6356515 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4253, "epsg", 4253,
        "Luzon 1911", 1, 1, "Clarke 1866", "Luzon_1911", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4254, "epsg", 4254,
        "Hito XVIII 1963", 1, 1, "International 1924", "Hito_XVIII_1963", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4255, "epsg", 4255,
        "Herat North", 1, 1, "International 1924", "Herat_North", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4256, "epsg", 4256,
        "Mahe 1971", 1, 1, "Clarke 1880 (RGS)", "Mahe_1971", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4257, "epsg", 4257,
        "Makassar", 1, 1, "Bessel 1841", "Makassar", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4259, "epsg", 4259,
        "Malongo 1987", 1, 1, "International 1924", "Malongo_1987", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4260, "epsg", 4260,
        "Manoca", 1, 1, "Clarke 1880 (RGS)", "Manoca", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4261, "epsg", 4261,
        "Merchich", 1, 1, "Clarke 1880 (IGN)", "Merchich", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4262, "epsg", 4262,
        "Massawa", 1, 1, "Bessel 1841", "Massawa", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4263, "epsg", 4263,
        "Minna", 1, 1, "Clarke 1880 (RGS)", "Minna", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4264, "epsg", 4264,
        "Mhast", 1, 1, "International 1924", "Mhast", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4265, "epsg", 4265,
        "Monte Mario", 1, 1, "International 1924", "Monte_Mario", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4266, "epsg", 4266,
        "M'poraloko", 1, 1, "Clarke 1880 (IGN)", "M_poraloko", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4268, "epsg", 4268,
        "NAD27 Michigan", 1, 1, "Clarke 1866 Michigan", "NAD27_Michigan", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4270, "epsg", 4270,
        "Nahrwan 1967", 1, 1, "Clarke 1880 (RGS)", "Nahrwan_1967", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4271, "epsg", 4271,
        "Naparima 1972", 1, 1, "International 1924", "Naparima_1972", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4272, "epsg", 4272,
        "NZGD49", 1, 1, "International 1924", "New_Zealand_Geodetic_Datum_1949", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4273, "epsg", 4273,
        "NGO 1948", 1, 1, "Bessel Modified", "NGO_1948", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4274, "epsg", 4274,
        "Datum 73", 1, 1, "International 1924", "Datum_73", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4275, "epsg", 4275,
        "NTF", 1, 1, "Clarke 1880 (IGN)", "Nouvelle_Triangulation_Francaise", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4276, "epsg", 4276,
        "NSWC 9Z-2", 1, 1, "NWL 9D", "NSWC_9Z_2", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4277, "epsg", 4277,
        "OSGB 1936", 1, 1, "Airy 1830", "OSGB_1936", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4278, "epsg", 4278,
        "OSGB70", 1, 1, "Airy 1830", "OSGB_1970_SN", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4279, "epsg", 4279,
        "OS(SN)80", 1, 1, "Airy 1830", "OS_SN_1980", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=airy +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4280, "epsg", 4280,
        "Padang", 1, 1, "Bessel 1841", "Padang_1884", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4281, "epsg", 4281,
        "Palestine 1923", 1, 1, "Clarke 1880 (Benoit)", "Palestine_1923", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4282, "epsg", 4282,
        "Pointe Noire", 1, 1, "Clarke 1880 (IGN)", "Congo_1960_Pointe_Noire", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4283, "epsg", 4283,
        "GDA94", 1, 1, "GRS 1980", "Geocentric_Datum_of_Australia_1994", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4284, "epsg", 4284,
        "Pulkovo 1942", 1, 1, "Krassowsky 1940", "Pulkovo_1942", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4285, "epsg", 4285,
        "Qatar 1974", 1, 1, "International 1924", "Qatar_1974", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4286, "epsg", 4286,
        "Qatar 1948", 1, 1, "Helmert 1906", "Qatar_1948", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4287, "epsg", 4287,
        "Qornoq", 1, 1, "International 1924", "Qornoq", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4288, "epsg", 4288,
        "Loma Quintana", 1, 1, "International 1924", "Loma_Quintana", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=intl +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4291, "epsg", 4291,
        "SAD69", 1, 1, "GRS 1967", "South_American_Datum_1969", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4292, "epsg", 4292,
        "Sapper Hill 1943", 1, 1, "International 1924", "Sapper_Hill_1943", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4293, "epsg", 4293,
        "Schwarzeck", 1, 1, "Bessel Namibia (GLM)", "Schwarzeck", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4294, "epsg", 4294,
        "Segora", 1, 1, "Bessel 1841", "Segora", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4295, "epsg", 4295,
        "Serindung", 1, 1, "Bessel 1841", "Serindung", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=bessel +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4296, "epsg", 4296,
        "Sudan", 1, 1, "Clarke 1880 (IGN)", "Sudan", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +a=6378249.2 +b=6356515 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4297, "epsg", 4297,
        "Tananarive", 1, 1, "International 1924", "Tananarive_1925", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4298, "epsg", 4298,
        "Timbalai 1948", 1, 1, "Everest 1830 (1967 Definition)", "Timbalai_1948", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4299, "epsg", 4299,
        "TM65", 1, 1, "Airy Modified 1849", "TM65", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4300, "epsg", 4300,
        "TM75", 1, 1, "Airy Modified 1849", "Geodetic_Datum_of_1965", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=mod_airy +towgs84=482.5,-130.6,564.");
    add_proj4text (p, 1,
        "6,-1.042,-0.214,-0.631,8.15 +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4302, "epsg", 4302,
        "Trinidad 1903", 1, 1, "Clarke 1858", "Trinidad_1903", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4303, "epsg", 4303,
        "TC(1948)", 1, 1, "Helmert 1906", "Trucial_Coast_1948", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=helmert +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4304, "epsg", 4304,
        "Voirol 1875", 1, 1, "Clarke 1880 (IGN)", "Voirol_1875", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4306, "epsg", 4306,
        "Bern 1938", 1, 1, "Bessel 1841", "Bern_1938", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=bessel +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4307, "epsg", 4307,
        "Nord Sahara 1959", 1, 1, "Clarke 1880 (RGS)", "Nord_Sahara_1959", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4308, "epsg", 4308,
        "RT38", 1, 1, "Bessel 1841", "Stockholm_1938", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=bessel +no_defs");
    add_srs_wkt (p, 0,
