...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 32243, "epsg", 32243,
        "WGS 72 / UTM zone 43N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32244, "epsg", 32244,
        "WGS 72 / UTM zone 44N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32245, "epsg", 32245,
        "WGS 72 / UTM zone 45N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32246, "epsg", 32246,
        "WGS 72 / UTM zone 46N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32247, "epsg", 32247,
        "WGS 72 / UTM zone 47N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32248, "epsg", 32248,
        "WGS 72 / UTM zone 48N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32249, "epsg", 32249,
        "WGS 72 / UTM zone 49N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32250, "epsg", 32250,
        "WGS 72 / UTM zone 50N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32251, "epsg", 32251,
        "WGS 72 / UTM zone 51N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32252, "epsg", 32252,
        "WGS 72 / UTM zone 52N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32253, "epsg", 32253,
        "WGS 72 / UTM zone 53N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32254, "epsg", 32254,
        "WGS 72 / UTM zone 54N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32255, "epsg", 32255,
        "WGS 72 / UTM zone 55N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32256, "epsg", 32256,
        "WGS 72 / UTM zone 56N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32257, "epsg", 32257,
        "WGS 72 / UTM zone 57N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32258, "epsg", 32258,
        "WGS 72 / UTM zone 58N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32259, "epsg", 32259,
        "WGS 72 / UTM zone 59N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32260, "epsg", 32260,
        "WGS 72 / UTM zone 60N", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32301, "epsg", 32301,
        "WGS 72 / UTM zone 1S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32302, "epsg", 32302,
        "WGS 72 / UTM zone 2S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32303, "epsg", 32303,
        "WGS 72 / UTM zone 3S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32304, "epsg", 32304,
        "WGS 72 / UTM zone 4S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32305, "epsg", 32305,
        "WGS 72 / UTM zone 5S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32306, "epsg", 32306,
        "WGS 72 / UTM zone 6S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32307, "epsg", 32307,
        "WGS 72 / UTM zone 7S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32308, "epsg", 32308,
        "WGS 72 / UTM zone 8S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32309, "epsg", 32309,
        "WGS 72 / UTM zone 9S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32310, "epsg", 32310,
        "WGS 72 / UTM zone 10S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32311, "epsg", 32311,
        "WGS 72 / UTM zone 11S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32312, "epsg", 32312,
        "WGS 72 / UTM zone 12S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32313, "epsg", 32313,
        "WGS 72 / UTM zone 13S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32314, "epsg", 32314,
        "WGS 72 / UTM zone 14S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32315, "epsg", 32315,
        "WGS 72 / UTM zone 15S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32316, "epsg", 32316,
        "WGS 72 / UTM zone 16S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32317, "epsg", 32317,
        "WGS 72 / UTM zone 17S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32318, "epsg", 32318,
        "WGS 72 / UTM zone 18S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32319, "epsg", 32319,
        "WGS 72 / UTM zone 19S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32320, "epsg", 32320,
        "WGS 72 / UTM zone 20S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32321, "epsg", 32321,
        "WGS 72 / UTM zone 21S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32322, "epsg", 32322,
        "WGS 72 / UTM zone 22S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32323, "epsg", 32323,
        "WGS 72 / UTM zone 23S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32324, "epsg", 32324,
        "WGS 72 / UTM zone 24S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32325, "epsg", 32325,
        "WGS 72 / UTM zone 25S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32326, "epsg", 32326,
        "WGS 72 / UTM zone 26S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32327, "epsg", 32327,
        "WGS 72 / UTM zone 27S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32328, "epsg", 32328,
        "WGS 72 / UTM zone 28S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32329, "epsg", 32329,
        "WGS 72 / UTM zone 29S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32330, "epsg", 32330,
        "WGS 72 / UTM zone 30S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32331, "epsg", 32331,
        "WGS 72 / UTM zone 31S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32332, "epsg", 32332,
        "WGS 72 / UTM zone 32S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32333, "epsg", 32333,
        "WGS 72 / UTM zone 33S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32334, "epsg", 32334,
        "WGS 72 / UTM zone 34S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32335, "epsg", 32335,
        "WGS 72 / UTM zone 35S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32336, "epsg", 32336,
        "WGS 72 / UTM zone 36S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32337, "epsg", 32337,
        "WGS 72 / UTM zone 37S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32338, "epsg", 32338,
        "WGS 72 / UTM zone 38S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32339, "epsg", 32339,
        "WGS 72 / UTM zone 39S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32340, "epsg", 32340,
        "WGS 72 / UTM zone 40S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32341, "epsg", 32341,
        "WGS 72 / UTM zone 41S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32342, "epsg", 32342,
        "WGS 72 / UTM zone 42S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32343, "epsg", 32343,
        "WGS 72 / UTM zone 43S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32344, "epsg", 32344,
        "WGS 72 / UTM zone 44S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32345, "epsg", 32345,
        "WGS 72 / UTM zone 45S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32346, "epsg", 32346,
        "WGS 72 / UTM zone 46S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32347, "epsg", 32347,
        "WGS 72 / UTM zone 47S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32348, "epsg", 32348,
        "WGS 72 / UTM zone 48S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32349, "epsg", 32349,
        "WGS 72 / UTM zone 49S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32350, "epsg", 32350,
        "WGS 72 / UTM zone 50S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32351, "epsg", 32351,
        "WGS 72 / UTM zone 51S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32352, "epsg", 32352,
        "WGS 72 / UTM zone 52S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32353, "epsg", 32353,
        "WGS 72 / UTM zone 53S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32354, "epsg", 32354,
        "WGS 72 / UTM zone 54S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32355, "epsg", 32355,
        "WGS 72 / UTM zone 55S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32356, "epsg", 32356,
        "WGS 72 / UTM zone 56S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32357, "epsg", 32357,
        "WGS 72 / UTM zone 57S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32358, "epsg", 32358,
        "WGS 72 / UTM zone 58S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32359, "epsg", 32359,
        "WGS 72 / UTM zone 59S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32360, "epsg", 32360,
        "WGS 72 / UTM zone 60S", 0, 0, "WGS 72", "WGS_1972", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32401, "epsg", 32401,
        "WGS 72BE / UTM zone 1N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32402, "epsg", 32402,
        "WGS 72BE / UTM zone 2N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32403, "epsg", 32403,
        "WGS 72BE / UTM zone 3N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32404, "epsg", 32404,
        "WGS 72BE / UTM zone 4N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32405, "epsg", 32405,
        "WGS 72BE / UTM zone 5N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32406, "epsg", 32406,
        "WGS 72BE / UTM zone 6N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32407, "epsg", 32407,
        "WGS 72BE / UTM zone 7N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32408, "epsg", 32408,
        "WGS 72BE / UTM zone 8N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32409, "epsg", 32409,
        "WGS 72BE / UTM zone 9N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32410, "epsg", 32410,
        "WGS 72BE / UTM zone 10N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32411, "epsg", 32411,
        "WGS 72BE / UTM zone 11N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32412, "epsg", 32412,
        "WGS 72BE / UTM zone 12N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32413, "epsg", 32413,
        "WGS 72BE / UTM zone 13N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32414, "epsg", 32414,
        "WGS 72BE / UTM zone 14N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32415, "epsg", 32415,
        "WGS 72BE / UTM zone 15N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32416, "epsg", 32416,
        "WGS 72BE / UTM zone 16N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32417, "epsg", 32417,
        "WGS 72BE / UTM zone 17N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32418, "epsg", 32418,
        "WGS 72BE / UTM zone 18N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32419, "epsg", 32419,
        "WGS 72BE / UTM zone 19N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32420, "epsg", 32420,
        "WGS 72BE / UTM zone 20N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32421, "epsg", 32421,
        "WGS 72BE / UTM zone 21N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32422, "epsg", 32422,
        "WGS 72BE / UTM zone 22N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 32423, "epsg", 32423,
        "WGS 72BE / UTM zone 23N", 0, 0, "WGS 72", "WGS_1972_Transit_Broadcast_Ephemeris", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
