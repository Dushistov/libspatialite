...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 3036, "epsg", 3036,
        "Moznet / UTM zone 36S", 0, 0, "WGS 84", "Moznet_ITRF94", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3037, "epsg", 3037,
        "Moznet / UTM zone 37S", 0, 0, "WGS 84", "Moznet_ITRF94", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3038, "epsg", 3038,
        "ETRS89 / TM26 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3039, "epsg", 3039,
        "ETRS89 / TM27 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3040, "epsg", 3040,
        "ETRS89 / UTM zone 28N (N-E)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3041, "epsg", 3041,
        "ETRS89 / UTM zone 29N (N-E)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3042, "epsg", 3042,
        "ETRS89 / UTM zone 30N (N-E)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3043, "epsg", 3043,
        "ETRS89 / UTM zone 31N (N-E)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3044, "epsg", 3044,
        "ETRS89 / UTM zone 32N (N-E)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3045, "epsg", 3045,
        "ETRS89 / UTM zone 33N (N-E)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3046, "epsg", 3046,
        "ETRS89 / UTM zone 34N (N-E)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3047, "epsg", 3047,
        "ETRS89 / UTM zone 35N (N-E)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3048, "epsg", 3048,
        "ETRS89 / UTM zone 36N (N-E)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3049, "epsg", 3049,
        "ETRS89 / UTM zone 37N (N-E)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3050, "epsg", 3050,
        "ETRS89 / TM38 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3051, "epsg", 3051,
        "ETRS89 / TM39 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3054, "epsg", 3054,
        "Hjorsey 1955 / UTM zone 26N", 0, 0, "International 1924", "Hjorsey_1955", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3055, "epsg", 3055,
        "Hjorsey 1955 / UTM zone 27N", 0, 0, "International 1924", "Hjorsey_1955", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3056, "epsg", 3056,
        "Hjorsey 1955 / UTM zone 28N", 0, 0, "International 1924", "Hjorsey_1955", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3057, "epsg", 3057,
        "ISN93 / Lambert 1993", 0, 0, "GRS 1980", "Islands_Net_1993", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3058, "epsg", 3058,
        "Helle 1954 / Jan Mayen Grid", 0, 1, "International 1924", "Helle_1954", "metre", "x", "North", "y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3059, "epsg", 3059,
        "LKS92 / Latvia TM", 0, 1, "GRS 1980", "Latvia_1992", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3060, "epsg", 3060,
        "IGN72 Grande Terre / UTM zone 58S", 0, 0, "International 1924", "IGN72_Grande_Terre", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3061, "epsg", 3061,
        "Porto Santo 1995 / UTM zone 28N", 0, 0, "International 1924", "Porto_Santo_1995", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3062, "epsg", 3062,
        "Azores Oriental 1995 / UTM zone 26N", 0, 0, "International 1924", "Azores_Oriental_Islands_1995", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3063, "epsg", 3063,
        "Azores Central 1995 / UTM zone 26N", 0, 0, "International 1924", "Azores_Central_Islands_1995", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3064, "epsg", 3064,
        "IGM95 / UTM zone 32N", 0, 0, "WGS 84", "Istituto_Geografico_Militaire_1995", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3065, "epsg", 3065,
        "IGM95 / UTM zone 33N", 0, 0, "WGS 84", "Istituto_Geografico_Militaire_1995", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3066, "epsg", 3066,
        "ED50 / Jordan TM", 0, 0, "International 1924", "European_Datum_1950", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3067, "epsg", 3067,
        "ETRS89 / TM35FIN(E,N)", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=utm +zone=35 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +");
    add_proj4text (p, 1,
        "units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 3068, "epsg", 3068,
        "DHDN / Soldner Berlin", 0, 1, "Bessel 1841", "Deutsches_Hauptdreiecksnetz", "metre", "x", "North", "y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3069, "epsg", 3069,
        "NAD27 / Wisconsin Transverse Mercator", 0, 0, "Clarke 1866", "North_American_Datum_1927", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3070, "epsg", 3070,
        "NAD83 / Wisconsin Transverse Mercator", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3071, "epsg", 3071,
        "NAD83(HARN) / Wisconsin Transverse Mercator", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=-90 +k=0.9996 +x_0=520000 +y");
    add_proj4text (p, 1,
        "_0=-4480000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m");
    ...
    p = add_epsg_def_ex (filter, first, last, 3072, "epsg", 3072,
        "NAD83 / Maine CS2000 East", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3073, "epsg", 3073,
        "NAD83 / Maine CS2000 Central (deprecated)", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3074, "epsg", 3074,
        "NAD83 / Maine CS2000 West", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3075, "epsg", 3075,
        "NAD83(HARN) / Maine CS2000 East", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=43.83333333333334 +lon_0=-67.875 +k=0");
    add_proj4text (p, 1,
        ".99998 +x_0=700000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,");
    ...
    p = add_epsg_def_ex (filter, first, last, 3076, "epsg", 3076,
        "NAD83(HARN) / Maine CS2000 Central (deprecated)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=43 +lon_0=-69.125 +k=0.99998 +x_0=500");
    add_proj4text (p, 1,
        "000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m ");
    ...
    p = add_epsg_def_ex (filter, first, last, 3077, "epsg", 3077,
        "NAD83(HARN) / Maine CS2000 West", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=42.83333333333334 +lon_0=-70.375 +k=0");
    add_proj4text (p, 1,
        ".99998 +x_0=300000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,");
    ...
    p = add_epsg_def_ex (filter, first, last, 3078, "epsg", 3078,
        "NAD83 / Michigan Oblique Mercator", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3079, "epsg", 3079,
        "NAD83(HARN) / Michigan Oblique Mercator", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=omerc +lat_0=45.30916666666666 +lonc=-86 +alpha=33");
    add_proj4text (p, 1,
        "7.25556 +k=0.9996 +x_0=2546731.496 +y_0=-4354009.816 +no");
    ...
    p = add_epsg_def_ex (filter, first, last, 3080, "epsg", 3080,
        "NAD27 / Shackleford", 0, 0, "Clarke 1866", "North_American_Datum_1927", "foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3081, "epsg", 3081,
        "NAD83 / Texas State Mapping System", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=27.41666666666667 +lat_2=34.91666666666");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3082, "epsg", 3082,
        "NAD83 / Texas Centric Lambert Conformal", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3083, "epsg", 3083,
        "NAD83 / Texas Centric Albers Equal Area", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3084, "epsg", 3084,
        "NAD83(HARN) / Texas Centric Lambert Conformal", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=27.5 +lat_2=35 +lat_0=18 +lon_0=-100 +x");
    add_proj4text (p, 1,
        "_0=1500000 +y_0=5000000 +ellps=GRS80 +towgs84=0,0,0,0,0,");
    ...
    p = add_epsg_def_ex (filter, first, last, 3085, "epsg", 3085,
        "NAD83(HARN) / Texas Centric Albers Equal Area", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=aea +lat_1=27.5 +lat_2=35 +lat_0=18 +lon_0=-100 +x");
    add_proj4text (p, 1,
        "_0=1500000 +y_0=6000000 +ellps=GRS80 +towgs84=0,0,0,0,0,");
    ...
    p = add_epsg_def_ex (filter, first, last, 3086, "epsg", 3086,
        "NAD83 / Florida GDL Albers", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3087, "epsg", 3087,
        "NAD83(HARN) / Florida GDL Albers", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=aea +lat_1=24 +lat_2=31.5 +lat_0=24 +lon_0=-84 +x_");
    add_proj4text (p, 1,
        "0=400000 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +uni");
    ...
    p = add_epsg_def_ex (filter, first, last, 3088, "epsg", 3088,
        "NAD83 / Kentucky Single Zone", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3089, "epsg", 3089,
        "NAD83 / Kentucky Single Zone (ftUS)", 0, 0, "GRS 1980", "North_American_Datum_1983", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=37.08333333333334 +lat_2=38.66666666666");
    add_proj4text (p, 1,
        "666 +lat_0=36.33333333333334 +lon_0=-85.75 +x_0=1500000 ");
    ...
    p = add_epsg_def_ex (filter, first, last, 3090, "epsg", 3090,
        "NAD83(HARN) / Kentucky Single Zone", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=37.08333333333334 +lat_2=38.66666666666");
    add_proj4text (p, 1,
        "666 +lat_0=36.33333333333334 +lon_0=-85.75 +x_0=1500000 ");
    ...
    p = add_epsg_def_ex (filter, first, last, 3091, "epsg", 3091,
        "NAD83(HARN) / Kentucky Single Zone (ftUS)", 0, 0, "GRS 1980", "NAD83_High_Accuracy_Reference_Network", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=37.08333333333334 +lat_2=38.66666666666");
    add_proj4text (p, 1,
        "666 +lat_0=36.33333333333334 +lon_0=-85.75 +x_0=1500000 ");
    ...
    p = add_epsg_def_ex (filter, first, last, 3092, "epsg", 3092,
        "Tokyo / UTM zone 51N", 0, 0, "Bessel 1841", "Tokyo", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3093, "epsg", 3093,
        "Tokyo / UTM zone 52N", 0, 0, "Bessel 1841", "Tokyo", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3094, "epsg", 3094,
        "Tokyo / UTM zone 53N", 0, 0, "Bessel 1841", "Tokyo", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3095, "epsg", 3095,
        "Tokyo / UTM zone 54N", 0, 0, "Bessel 1841", "Tokyo", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3096, "epsg", 3096,
        "Tokyo / UTM zone 55N", 0, 0, "Bessel 1841", "Tokyo", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3097, "epsg", 3097,
        "JGD2000 / UTM zone 51N", 0, 0, "GRS 1980", "Japanese_Geodetic_Datum_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3098, "epsg", 3098,
        "JGD2000 / UTM zone 52N", 0, 0, "GRS 1980", "Japanese_Geodetic_Datum_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3099, "epsg", 3099,
        "JGD2000 / UTM zone 53N", 0, 0, "GRS 1980", "Japanese_Geodetic_Datum_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3100, "epsg", 3100,
        "JGD2000 / UTM zone 54N", 0, 0, "GRS 1980", "Japanese_Geodetic_Datum_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3101, "epsg", 3101,
        "JGD2000 / UTM zone 55N", 0, 0, "GRS 1980", "Japanese_Geodetic_Datum_2000", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3102, "epsg", 3102,
        "American Samoa 1962 / American Samoa Lambert", 0, 0, "Clarke 1866", "American_Samoa_1962", "US survey foot", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3103, "epsg", 3103,
        "Mauritania 1999 / UTM zone 28N (deprecated)", 0, 0, "Clarke 1880 (RGS)", "Mauritania_1999", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3104, "epsg", 3104,
        "Mauritania 1999 / UTM zone 29N (deprecated)", 0, 0, "Clarke 1880 (RGS)", "Mauritania_1999", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3105, "epsg", 3105,
        "Mauritania 1999 / UTM zone 30N (deprecated)", 0, 0, "Clarke 1880 (RGS)", "Mauritania_1999", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3106, "epsg", 3106,
        "Gulshan 303 / Bangladesh Transverse Mercator", 0, 0, "Everest 1830 (1937 Adjustment)", "Gulshan_303", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3107, "epsg", 3107,
        "GDA94 / SA Lambert", 0, 0, "GRS 1980", "Geocentric_Datum_of_Australia_1994", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3108, "epsg", 3108,
        "ETRS89 / Guernsey Grid", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3109, "epsg", 3109,
        "ETRS89 / Jersey Transverse Mercator", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3110, "epsg", 3110,
        "AGD66 / Vicgrid66", 0, 0, "Australian National Spheroid", "Australian_Geodetic_Datum_1966", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3111, "epsg", 3111,
        "GDA94 / Vicgrid94", 0, 0, "GRS 1980", "Geocentric_Datum_of_Australia_1994", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-36 +lat_2=-38 +lat_0=-37 +lon_0=145 +x");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3112, "epsg", 3112,
        "GDA94 / Geoscience Australia Lambert", 0, 0, "GRS 1980", "Geocentric_Datum_of_Australia_1994", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3113, "epsg", 3113,
        "GDA94 / BCSG02", 0, 0, "GRS 1980", "Geocentric_Datum_of_Australia_1994", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3114, "epsg", 3114,
        "MAGNA-SIRGAS / Colombia Far West zone", 0, 1, "GRS 1980", "Marco_Geocentrico_Nacional_de_Referencia", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3115, "epsg", 3115,
        "MAGNA-SIRGAS / Colombia West zone", 0, 1, "GRS 1980", "Marco_Geocentrico_Nacional_de_Referencia", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3116, "epsg", 3116,
        "MAGNA-SIRGAS / Colombia Bogota zone", 0, 1, "GRS 1980", "Marco_Geocentrico_Nacional_de_Referencia", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3117, "epsg", 3117,
        "MAGNA-SIRGAS / Colombia East Central zone", 0, 1, "GRS 1980", "Marco_Geocentrico_Nacional_de_Referencia", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3118, "epsg", 3118,
        "MAGNA-SIRGAS / Colombia East zone", 0, 1, "GRS 1980", "Marco_Geocentrico_Nacional_de_Referencia", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3119, "epsg", 3119,
        "Douala 1948 / AEF west", 0, 0, "International 1924", "Douala_1948", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3120, "epsg", 3120,
        "Pulkovo 1942(58) / Poland zone I", 0, 1, "Krassowsky 1940", "Pulkovo_1942_58", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3121, "epsg", 3121,
        "PRS92 / Philippines zone 1", 0, 0, "Clarke 1866", "Philippine_Reference_System_1992", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3122, "epsg", 3122,
        "PRS92 / Philippines zone 2", 0, 0, "Clarke 1866", "Philippine_Reference_System_1992", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3123, "epsg", 3123,
        "PRS92 / Philippines zone 3", 0, 0, "Clarke 1866", "Philippine_Reference_System_1992", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3124, "epsg", 3124,
        "PRS92 / Philippines zone 4", 0, 0, "Clarke 1866", "Philippine_Reference_System_1992", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3125, "epsg", 3125,
        "PRS92 / Philippines zone 5", 0, 0, "Clarke 1866", "Philippine_Reference_System_1992", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3126, "epsg", 3126,
        "ETRS89 / ETRS-GK19FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3127, "epsg", 3127,
        "ETRS89 / ETRS-GK20FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3128, "epsg", 3128,
        "ETRS89 / ETRS-GK21FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3129, "epsg", 3129,
        "ETRS89 / ETRS-GK22FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3130, "epsg", 3130,
        "ETRS89 / ETRS-GK23FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3131, "epsg", 3131,
        "ETRS89 / ETRS-GK24FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3132, "epsg", 3132,
        "ETRS89 / ETRS-GK25FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3133, "epsg", 3133,
        "ETRS89 / ETRS-GK26FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3134, "epsg", 3134,
        "ETRS89 / ETRS-GK27FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3135, "epsg", 3135,
        "ETRS89 / ETRS-GK28FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3136, "epsg", 3136,
        "ETRS89 / ETRS-GK29FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3137, "epsg", 3137,
        "ETRS89 / ETRS-GK30FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3138, "epsg", 3138,
        "ETRS89 / ETRS-GK31FIN", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
