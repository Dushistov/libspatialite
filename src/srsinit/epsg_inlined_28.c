...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 5854, "epsg", 5854,
        "SWEREF99 18 45", 0, 1, "GRS 1980", "SWEREF99", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5855, "epsg", 5855,
        "SWEREF99 20 15", 0, 1, "GRS 1980", "SWEREF99", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5856, "epsg", 5856,
        "SWEREF99 21 45", 0, 1, "GRS 1980", "SWEREF99", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5857, "epsg", 5857,
        "SWEREF99 23 15", 0, 1, "GRS 1980", "SWEREF99", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5858, "epsg", 5858,
        "SAD69(96) / UTM zone 22S", 0, 0, "GRS 1967 Modified", "South_American_Datum_1969_96", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5875, "epsg", 5875,
        "SAD69(96) / UTM zone 18S", 0, 0, "GRS 1967 Modified", "South_American_Datum_1969_96", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5876, "epsg", 5876,
        "SAD69(96) / UTM zone 19S", 0, 0, "GRS 1967 Modified", "South_American_Datum_1969_96", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5877, "epsg", 5877,
        "SAD69(96) / UTM zone 20S", 0, 0, "GRS 1967 Modified", "South_American_Datum_1969_96", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5879, "epsg", 5879,
        "Cadastre 1997 / UTM zone 38S", 0, 0, "International 1924", "Cadastre_1997", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5880, "epsg", 5880,
        "SIRGAS 2000 / Brazil Polyconic", 0, 0, "GRS 1980", "Sistema_de_Referencia_Geocentrico_para_las_AmericaS_2000", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5886, "epsg", 5886,
        "TGD2005", 1, 1, "GRS 1980", "Tonga_Geodetic_Datum_2005", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5887, "epsg", 5887,
        "TGD2005 / Tonga Map Grid", 0, 0, "GRS 1980", "Tonga_Geodetic_Datum_2005", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5890, "epsg", 5890,
        "JAXA Snow Depth Polar Stereographic North", 0, 0, "Hughes 1980", "Not_specified_based_on_Hughes_1980_ellipsoid", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5921, "epsg", 5921,
        "WGS 84 / EPSG Arctic Regional zone A1", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5922, "epsg", 5922,
        "WGS 84 / EPSG Arctic Regional zone A2", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=85 +lat_2=77 +lat_0=81.31722600000001 +");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 5923, "epsg", 5923,
        "WGS 84 / EPSG Arctic Regional zone A3", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=85 +lat_2=77 +lat_0=81.31722600000001 +");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 5924, "epsg", 5924,
        "WGS 84 / EPSG Arctic Regional zone A4", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=85 +lat_2=77 +lat_0=81.31722600000001 +");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 5925, "epsg", 5925,
        "WGS 84 / EPSG Arctic Regional zone A5", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=85 +lat_2=77 +lat_0=81.31722600000001 +");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 5926, "epsg", 5926,
        "WGS 84 / EPSG Arctic Regional zone B1", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5927, "epsg", 5927,
        "WGS 84 / EPSG Arctic Regional zone B2", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=77 +lat_2=69 +lat_0=73.15574086111111 +");
    add_proj4text (p, 1,
        "lon_0=-39 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5928, "epsg", 5928,
        "WGS 84 / EPSG Arctic Regional zone B3", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=77 +lat_2=69 +lat_0=73.15574086111111 +");
    add_proj4text (p, 1,
        "lon_0=33 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5929, "epsg", 5929,
        "WGS 84 / EPSG Arctic Regional zone B4", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=77 +lat_2=69 +lat_0=73.15574086111111 +");
    add_proj4text (p, 1,
        "lon_0=105 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5930, "epsg", 5930,
        "WGS 84 / EPSG Arctic Regional zone B5", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=77 +lat_2=69 +lat_0=73.15574086111111 +");
    add_proj4text (p, 1,
        "lon_0=177 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5931, "epsg", 5931,
        "WGS 84 / EPSG Arctic Regional zone C1", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5932, "epsg", 5932,
        "WGS 84 / EPSG Arctic Regional zone C2", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=69 +lat_2=61 +lat_0=65.10127088888888 +");
    add_proj4text (p, 1,
        "lon_0=-39 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5933, "epsg", 5933,
        "WGS 84 / EPSG Arctic Regional zone C3", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=69 +lat_2=61 +lat_0=65.10127088888888 +");
    add_proj4text (p, 1,
        "lon_0=33 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5934, "epsg", 5934,
        "WGS 84 / EPSG Arctic Regional zone C4", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=69 +lat_2=61 +lat_0=65.10127088888888 +");
    add_proj4text (p, 1,
        "lon_0=105 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5935, "epsg", 5935,
        "WGS 84 / EPSG Arctic Regional zone C5", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=69 +lat_2=61 +lat_0=65.10127088888888 +");
    add_proj4text (p, 1,
        "lon_0=177 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 5936, "epsg", 5936,
        "WGS 84 / EPSG Alaska Polar Stereographic", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5937, "epsg", 5937,
        "WGS 84 / EPSG Canada Polar Stereographic", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5938, "epsg", 5938,
        "WGS 84 / EPSG Greenland Polar Stereographic", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5939, "epsg", 5939,
        "WGS 84 / EPSG Norway Polar Stereographic", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 5940, "epsg", 5940,
        "WGS 84 / EPSG Russia Polar Stereographic", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6050, "epsg", 6050,
        "GR96 / EPSG Arctic zone 1-25", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6051, "epsg", 6051,
        "GR96 / EPSG Arctic zone 2-18", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6052, "epsg", 6052,
        "GR96 / EPSG Arctic zone 2-20", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=83.66666666666667 +lat_2=80.33333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6053, "epsg", 6053,
        "GR96 / EPSG Arctic zone 3-29", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6054, "epsg", 6054,
        "GR96 / EPSG Arctic zone 3-31", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=80.33333333333333 +lat_2=77 +lat_0=78.7");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6055, "epsg", 6055,
        "GR96 / EPSG Arctic zone 3-33", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=80.33333333333333 +lat_2=77 +lat_0=78.7");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6056, "epsg", 6056,
        "GR96 / EPSG Arctic zone 4-20", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6057, "epsg", 6057,
        "GR96 / EPSG Arctic zone 4-22", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=77 +lat_2=73.66666666666667 +lat_0=75.3");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6058, "epsg", 6058,
        "GR96 / EPSG Arctic zone 4-24", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=77 +lat_2=73.66666666666667 +lat_0=75.3");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6059, "epsg", 6059,
        "GR96 / EPSG Arctic zone 5-41", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6060, "epsg", 6060,
        "GR96 / EPSG Arctic zone 5-43", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=73.66666666666667 +lat_2=70.33333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6061, "epsg", 6061,
        "GR96 / EPSG Arctic zone 5-45", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=73.66666666666667 +lat_2=70.33333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6062, "epsg", 6062,
        "GR96 / EPSG Arctic zone 6-26", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6063, "epsg", 6063,
        "GR96 / EPSG Arctic zone 6-28", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=70.33333333333333 +lat_2=67 +lat_0=68.6");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6064, "epsg", 6064,
        "GR96 / EPSG Arctic zone 6-30", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=70.33333333333333 +lat_2=67 +lat_0=68.6");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6065, "epsg", 6065,
        "GR96 / EPSG Arctic zone 7-11", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6066, "epsg", 6066,
        "GR96 / EPSG Arctic zone 7-13", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=67 +lat_2=63.66666666666666 +lat_0=65.3");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6067, "epsg", 6067,
        "GR96 / EPSG Arctic zone 8-20", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 6068, "epsg", 6068,
        "GR96 / EPSG Arctic zone 8-22", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=63.66666666666666 +lat_2=60.33333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6069, "epsg", 6069,
        "ETRS89 / EPSG Arctic zone 2-22", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=83.66666666666667 +lat_2=80.33333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6070, "epsg", 6070,
        "ETRS89 / EPSG Arctic zone 3-11", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=80.33333333333333 +lat_2=77 +lat_0=78.7");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6071, "epsg", 6071,
        "ETRS89 / EPSG Arctic zone 4-26", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=77 +lat_2=73.66666666666667 +lat_0=75.3");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6072, "epsg", 6072,
        "ETRS89 / EPSG Arctic zone 4-28", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=77 +lat_2=73.66666666666667 +lat_0=75.3");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6073, "epsg", 6073,
        "ETRS89 / EPSG Arctic zone 5-11", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=73.66666666666667 +lat_2=70.33333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6074, "epsg", 6074,
        "ETRS89 / EPSG Arctic zone 5-13", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=73.66666666666667 +lat_2=70.33333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6075, "epsg", 6075,
        "WGS 84 / EPSG Arctic zone 2-24", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=83.66666666666667 +lat_2=80.33333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6076, "epsg", 6076,
        "WGS 84 / EPSG Arctic zone 2-26", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=83.66666666666667 +lat_2=80.33333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6077, "epsg", 6077,
        "WGS 84 / EPSG Arctic zone 3-13", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=80.33333333333333 +lat_2=77 +lat_0=78.7");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6078, "epsg", 6078,
        "WGS 84 / EPSG Arctic zone 3-15", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=80.33333333333333 +lat_2=77 +lat_0=78.7");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6079, "epsg", 6079,
        "WGS 84 / EPSG Arctic zone 3-17", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=80.33333333333333 +lat_2=77 +lat_0=78.7");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6080, "epsg", 6080,
        "WGS 84 / EPSG Arctic zone 3-19", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=80.33333333333333 +lat_2=77 +lat_0=78.7");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6081, "epsg", 6081,
        "WGS 84 / EPSG Arctic zone 4-30", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=77 +lat_2=73.66666666666667 +lat_0=75.3");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6082, "epsg", 6082,
        "WGS 84 / EPSG Arctic zone 4-32", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=77 +lat_2=73.66666666666667 +lat_0=75.3");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6083, "epsg", 6083,
        "WGS 84 / EPSG Arctic zone 4-34", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=77 +lat_2=73.66666666666667 +lat_0=75.3");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 6084, "epsg", 6084,
        "WGS 84 / EPSG Arctic zone 4-36", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=77 +lat_2=73.66666666666667 +lat_0=75.3");
    add_proj4text (p, 1,
