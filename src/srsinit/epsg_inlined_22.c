...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 4523, "epsg", 4523,
        "CGCS2000 / 3-degree Gauss-Kruger zone 35", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4524, "epsg", 4524,
        "CGCS2000 / 3-degree Gauss-Kruger zone 36", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4525, "epsg", 4525,
        "CGCS2000 / 3-degree Gauss-Kruger zone 37", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4526, "epsg", 4526,
        "CGCS2000 / 3-degree Gauss-Kruger zone 38", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4527, "epsg", 4527,
        "CGCS2000 / 3-degree Gauss-Kruger zone 39", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4528, "epsg", 4528,
        "CGCS2000 / 3-degree Gauss-Kruger zone 40", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4529, "epsg", 4529,
        "CGCS2000 / 3-degree Gauss-Kruger zone 41", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4530, "epsg", 4530,
        "CGCS2000 / 3-degree Gauss-Kruger zone 42", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4531, "epsg", 4531,
        "CGCS2000 / 3-degree Gauss-Kruger zone 43", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4532, "epsg", 4532,
        "CGCS2000 / 3-degree Gauss-Kruger zone 44", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4533, "epsg", 4533,
        "CGCS2000 / 3-degree Gauss-Kruger zone 45", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4534, "epsg", 4534,
        "CGCS2000 / 3-degree Gauss-Kruger CM 75E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4535, "epsg", 4535,
        "CGCS2000 / 3-degree Gauss-Kruger CM 78E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4536, "epsg", 4536,
        "CGCS2000 / 3-degree Gauss-Kruger CM 81E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4537, "epsg", 4537,
        "CGCS2000 / 3-degree Gauss-Kruger CM 84E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4538, "epsg", 4538,
        "CGCS2000 / 3-degree Gauss-Kruger CM 87E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4539, "epsg", 4539,
        "CGCS2000 / 3-degree Gauss-Kruger CM 90E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4540, "epsg", 4540,
        "CGCS2000 / 3-degree Gauss-Kruger CM 93E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4541, "epsg", 4541,
        "CGCS2000 / 3-degree Gauss-Kruger CM 96E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4542, "epsg", 4542,
        "CGCS2000 / 3-degree Gauss-Kruger CM 99E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4543, "epsg", 4543,
        "CGCS2000 / 3-degree Gauss-Kruger CM 102E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4544, "epsg", 4544,
        "CGCS2000 / 3-degree Gauss-Kruger CM 105E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4545, "epsg", 4545,
        "CGCS2000 / 3-degree Gauss-Kruger CM 108E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4546, "epsg", 4546,
        "CGCS2000 / 3-degree Gauss-Kruger CM 111E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4547, "epsg", 4547,
        "CGCS2000 / 3-degree Gauss-Kruger CM 114E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4548, "epsg", 4548,
        "CGCS2000 / 3-degree Gauss-Kruger CM 117E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4549, "epsg", 4549,
        "CGCS2000 / 3-degree Gauss-Kruger CM 120E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4550, "epsg", 4550,
        "CGCS2000 / 3-degree Gauss-Kruger CM 123E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4551, "epsg", 4551,
        "CGCS2000 / 3-degree Gauss-Kruger CM 126E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4552, "epsg", 4552,
        "CGCS2000 / 3-degree Gauss-Kruger CM 129E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4553, "epsg", 4553,
        "CGCS2000 / 3-degree Gauss-Kruger CM 132E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4554, "epsg", 4554,
        "CGCS2000 / 3-degree Gauss-Kruger CM 135E", 0, 1, "CGCS2000", "China_2000", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4555, "epsg", 4555,
        "New Beijing", 1, 1, "Krassowsky 1940", "New_Beijing", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4558, "epsg", 4558,
        "RRAF 1991", 1, 1, "GRS 1980", "Reseau_de_Reference_des_Antilles_Francaises_1991", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4559, "epsg", 4559,
        "RRAF 1991 / UTM zone 20N", 0, 0, "GRS 1980", "Reseau_de_Reference_des_Antilles_Francaises_1991", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4568, "epsg", 4568,
        "New Beijing / Gauss-Kruger zone 13", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4569, "epsg", 4569,
        "New Beijing / Gauss-Kruger zone 14", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4570, "epsg", 4570,
        "New Beijing / Gauss-Kruger zone 15", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4571, "epsg", 4571,
        "New Beijing / Gauss-Kruger zone 16", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4572, "epsg", 4572,
        "New Beijing / Gauss-Kruger zone 17", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4573, "epsg", 4573,
        "New Beijing / Gauss-Kruger zone 18", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4574, "epsg", 4574,
        "New Beijing / Gauss-Kruger zone 19", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4575, "epsg", 4575,
        "New Beijing / Gauss-Kruger zone 20", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4576, "epsg", 4576,
        "New Beijing / Gauss-Kruger zone 21", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4577, "epsg", 4577,
        "New Beijing / Gauss-Kruger zone 22", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4578, "epsg", 4578,
        "New Beijing / Gauss-Kruger zone 23", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4579, "epsg", 4579,
        "New Beijing / Gauss-Kruger CM 75E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=75 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "ellps=krass +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4580, "epsg", 4580,
        "New Beijing / Gauss-Kruger CM 81E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=81 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "ellps=krass +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4581, "epsg", 4581,
        "New Beijing / Gauss-Kruger CM 87E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=87 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "ellps=krass +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4582, "epsg", 4582,
        "New Beijing / Gauss-Kruger CM 93E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=93 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "ellps=krass +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4583, "epsg", 4583,
        "New Beijing / Gauss-Kruger CM 99E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=99 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "ellps=krass +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4584, "epsg", 4584,
        "New Beijing / Gauss-Kruger CM 105E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=105 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=krass +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4585, "epsg", 4585,
        "New Beijing / Gauss-Kruger CM 111E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=111 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=krass +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4586, "epsg", 4586,
        "New Beijing / Gauss-Kruger CM 117E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=117 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=krass +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4587, "epsg", 4587,
        "New Beijing / Gauss-Kruger CM 123E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=123 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=krass +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4588, "epsg", 4588,
        "New Beijing / Gauss-Kruger CM 129E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=129 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=krass +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4589, "epsg", 4589,
        "New Beijing / Gauss-Kruger CM 135E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=135 +k=1 +x_0=500000 +y_0=0 ");
    add_proj4text (p, 1,
        "+ellps=krass +units=m +no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4600, "epsg", 4600,
        "Anguilla 1957", 1, 1, "Clarke 1880 (RGS)", "Anguilla_1957", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4601, "epsg", 4601,
        "Antigua 1943", 1, 1, "Clarke 1880 (RGS)", "Antigua_1943", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4602, "epsg", 4602,
        "Dominica 1945", 1, 1, "Clarke 1880 (RGS)", "Dominica_1945", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4603, "epsg", 4603,
        "Grenada 1953", 1, 1, "Clarke 1880 (RGS)", "Grenada_1953", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4604, "epsg", 4604,
        "Montserrat 1958", 1, 1, "Clarke 1880 (RGS)", "Montserrat_1958", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4605, "epsg", 4605,
        "St. Kitts 1955", 1, 1, "Clarke 1880 (RGS)", "St_Kitts_1955", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4606, "epsg", 4606,
        "St. Lucia 1955", 1, 1, "Clarke 1880 (RGS)", "St_Lucia_1955", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4607, "epsg", 4607,
        "St. Vincent 1945", 1, 1, "Clarke 1880 (RGS)", "St_Vincent_1945", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4608, "epsg", 4608,
        "NAD27(76)", 1, 1, "Clarke 1866", "North_American_Datum_1927_1976", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4609, "epsg", 4609,
        "NAD27(CGQ77)", 1, 1, "Clarke 1866", "North_American_Datum_1927_CGQ77", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=clrk66 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4610, "epsg", 4610,
        "Xian 1980", 1, 1, "IAG 1975", "Xian_1980", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4611, "epsg", 4611,
        "Hong Kong 1980", 1, 1, "International 1924", "Hong_Kong_1980", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4613, "epsg", 4613,
        "Segara", 1, 1, "Bessel 1841", "Gunung_Segara", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4614, "epsg", 4614,
        "QND95", 1, 1, "International 1924", "Qatar_National_Datum_1995", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4615, "epsg", 4615,
        "Porto Santo", 1, 1, "International 1924", "Porto_Santo_1936", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4616, "epsg", 4616,
        "Selvagem Grande", 1, 1, "International 1924", "Selvagem_Grande", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4618, "epsg", 4618,
        "SAD69", 1, 1, "GRS 1967 Modified", "South_American_Datum_1969", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4620, "epsg", 4620,
        "Point 58", 1, 1, "Clarke 1880 (RGS)", "Point_58", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4621, "epsg", 4621,
        "Fort Marigot", 1, 1, "International 1924", "Fort_Marigot", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4622, "epsg", 4622,
        "Guadeloupe 1948", 1, 1, "International 1924", "Guadeloupe_1948", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4623, "epsg", 4623,
        "CSG67", 1, 1, "International 1924", "Centre_Spatial_Guyanais_1967", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4624, "epsg", 4624,
        "RGFG95", 1, 1, "GRS 1980", "Reseau_Geodesique_Francais_Guyane_1995", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4625, "epsg", 4625,
        "Martinique 1938", 1, 1, "International 1924", "Martinique_1938", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4626, "epsg", 4626,
        "Reunion 1947", 1, 1, "International 1924", "Reunion_1947", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4627, "epsg", 4627,
        "RGR92", 1, 1, "GRS 1980", "Reseau_Geodesique_de_la_Reunion_1992", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4628, "epsg", 4628,
        "Tahiti 52", 1, 1, "International 1924", "Tahiti_52", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4629, "epsg", 4629,
        "Tahaa 54", 1, 1, "International 1924", "Tahaa_54", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4630, "epsg", 4630,
        "IGN72 Nuku Hiva", 1, 1, "International 1924", "IGN72_Nuku_Hiva", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4631, "epsg", 4631,
        "K0 1949", 1, 1, "International 1924", "K0_1949", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4632, "epsg", 4632,
        "Combani 1950", 1, 1, "International 1924", "Combani_1950", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4633, "epsg", 4633,
        "IGN56 Lifou", 1, 1, "International 1924", "IGN56_Lifou", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4634, "epsg", 4634,
        "IGN72 Grand Terre", 1, 1, "International 1924", "IGN72_Grande_Terre", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4635, "epsg", 4635,
        "ST87 Ouvea", 1, 1, "International 1924", "ST87_Ouvea", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4636, "epsg", 4636,
        "Petrels 1972", 1, 1, "International 1924", "Petrels_1972", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4637, "epsg", 4637,
        "Perroud 1950", 1, 1, "International 1924", "Pointe_Geologie_Perroud_1950", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4638, "epsg", 4638,
        "Saint Pierre et Miquelon 1950", 1, 1, "Clarke 1866", "Saint_Pierre_et_Miquelon_1950", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4639, "epsg", 4639,
        "MOP78", 1, 1, "International 1924", "MOP78", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4640, "epsg", 4640,
        "RRAF 1991", 1, 1, "WGS 84", "Reseau_de_Reference_des_Antilles_Francaises_1991", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4641, "epsg", 4641,
        "IGN53 Mare", 1, 1, "International 1924", "IGN53_Mare", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4642, "epsg", 4642,
        "ST84 Ile des Pins", 1, 1, "International 1924", "ST84_Ile_des_Pins", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=intl +towgs84=-13,-348,292,0,0,0,0 ");
    add_proj4text (p, 1,
        "+no_defs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4643, "epsg", 4643,
        "ST71 Belep", 1, 1, "International 1924", "ST71_Belep", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
