...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 4749, "epsg", 4749,
        "RGNC91-93", 1, 1, "GRS 1980", "Reseau_Geodesique_de_Nouvelle_Caledonie_91_93", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4750, "epsg", 4750,
        "ST87 Ouvea", 1, 1, "WGS 84", "ST87_Ouvea", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4751, "epsg", 4751,
        "Kertau (RSO)", 1, 1, "Everest 1830 (RSO 1969)", "Kertau_RSO", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4752, "epsg", 4752,
        "Viti Levu 1912", 1, 1, "Clarke 1880 (international foot)", "Viti_Levu_1912", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4753, "epsg", 4753,
        "fk89", 1, 1, "International 1924", "fk89", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4754, "epsg", 4754,
        "LGD2006", 1, 1, "International 1924", "Libyan_Geodetic_Datum_2006", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4755, "epsg", 4755,
        "DGN95", 1, 1, "WGS 84", "Datum_Geodesi_Nasional_1995", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4756, "epsg", 4756,
        "VN-2000", 1, 1, "WGS 84", "Vietnam_2000", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4757, "epsg", 4757,
        "SVY21", 1, 1, "WGS 84", "SVY21", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4758, "epsg", 4758,
        "JAD2001", 1, 1, "WGS 84", "Jamaica_2001", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4759, "epsg", 4759,
        "NAD83(NSRS2007)", 1, 1, "GRS 1980", "NAD83_National_Spatial_Reference_System_2007", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4760, "epsg", 4760,
        "WGS 66", 1, 1, "NWL 9D", "World_Geodetic_System_1966", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4761, "epsg", 4761,
        "HTRS96", 1, 1, "GRS 1980", "Croatian_Terrestrial_Reference_System", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4762, "epsg", 4762,
        "BDA2000", 1, 1, "WGS 84", "Bermuda_2000", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4763, "epsg", 4763,
        "Pitcairn 2006", 1, 1, "WGS 84", "Pitcairn_2006", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4764, "epsg", 4764,
        "RSRGD2000", 1, 1, "GRS 1980", "Ross_Sea_Region_Geodetic_Datum_2000", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4765, "epsg", 4765,
        "Slovenia 1996", 1, 1, "GRS 1980", "Slovenia_Geodetic_Datum_1996", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4766, "epsg", 4766,
        "New Beijing / 3-degree Gauss-Kruger zone 30", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4767, "epsg", 4767,
        "New Beijing / 3-degree Gauss-Kruger zone 31", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4768, "epsg", 4768,
        "New Beijing / 3-degree Gauss-Kruger zone 32", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4769, "epsg", 4769,
        "New Beijing / 3-degree Gauss-Kruger zone 33", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4770, "epsg", 4770,
        "New Beijing / 3-degree Gauss-Kruger zone 34", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4771, "epsg", 4771,
        "New Beijing / 3-degree Gauss-Kruger zone 35", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4772, "epsg", 4772,
        "New Beijing / 3-degree Gauss-Kruger zone 36", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4773, "epsg", 4773,
        "New Beijing / 3-degree Gauss-Kruger zone 37", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4774, "epsg", 4774,
        "New Beijing / 3-degree Gauss-Kruger zone 38", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4775, "epsg", 4775,
        "New Beijing / 3-degree Gauss-Kruger zone 39", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4776, "epsg", 4776,
        "New Beijing / 3-degree Gauss-Kruger zone 40", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4777, "epsg", 4777,
        "New Beijing / 3-degree Gauss-Kruger zone 41", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4778, "epsg", 4778,
        "New Beijing / 3-degree Gauss-Kruger zone 42", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4779, "epsg", 4779,
        "New Beijing / 3-degree Gauss-Kruger zone 43", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4780, "epsg", 4780,
        "New Beijing / 3-degree Gauss-Kruger zone 44", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4781, "epsg", 4781,
        "New Beijing / 3-degree Gauss-Kruger zone 45", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4782, "epsg", 4782,
        "New Beijing / 3-degree Gauss-Kruger CM 75E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4783, "epsg", 4783,
        "New Beijing / 3-degree Gauss-Kruger CM 78E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4784, "epsg", 4784,
        "New Beijing / 3-degree Gauss-Kruger CM 81E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4785, "epsg", 4785,
        "New Beijing / 3-degree Gauss-Kruger CM 84E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4786, "epsg", 4786,
        "New Beijing / 3-degree Gauss-Kruger CM 87E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4787, "epsg", 4787,
        "New Beijing / 3-degree Gauss-Kruger CM 90E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4788, "epsg", 4788,
        "New Beijing / 3-degree Gauss-Kruger CM 93E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4789, "epsg", 4789,
        "New Beijing / 3-degree Gauss-Kruger CM 96E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4790, "epsg", 4790,
        "New Beijing / 3-degree Gauss-Kruger CM 99E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4791, "epsg", 4791,
        "New Beijing / 3-degree Gauss-Kruger CM 102E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4792, "epsg", 4792,
        "New Beijing / 3-degree Gauss-Kruger CM 105E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4793, "epsg", 4793,
        "New Beijing / 3-degree Gauss-Kruger CM 108E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4794, "epsg", 4794,
        "New Beijing / 3-degree Gauss-Kruger CM 111E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4795, "epsg", 4795,
        "New Beijing / 3-degree Gauss-Kruger CM 114E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4796, "epsg", 4796,
        "New Beijing / 3-degree Gauss-Kruger CM 117E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4797, "epsg", 4797,
        "New Beijing / 3-degree Gauss-Kruger CM 120E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4798, "epsg", 4798,
        "New Beijing / 3-degree Gauss-Kruger CM 123E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4799, "epsg", 4799,
        "New Beijing / 3-degree Gauss-Kruger CM 126E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4800, "epsg", 4800,
        "New Beijing / 3-degree Gauss-Kruger CM 129E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4801, "epsg", 4801,
        "Bern 1898 (Bern)", 1, 1, "Bessel 1841", "CH1903_Bern", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4802, "epsg", 4802,
        "Bogota 1975 (Bogota)", 1, 1, "International 1924", "Bogota_1975_Bogota", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4803, "epsg", 4803,
        "Lisbon (Lisbon)", 1, 1, "International 1924", "Lisbon_1937_Lisbon", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4804, "epsg", 4804,
        "Makassar (Jakarta)", 1, 1, "Bessel 1841", "Makassar_Jakarta", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4805, "epsg", 4805,
        "MGI (Ferro)", 1, 1, "Bessel 1841", "Militar_Geographische_Institut_Ferro", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4806, "epsg", 4806,
        "Monte Mario (Rome)", 1, 1, "International 1924", "Monte_Mario_Rome", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4807, "epsg", 4807,
        "NTF (Paris)", 1, 1, "Clarke 1880 (IGN)", "Nouvelle_Triangulation_Francaise_Paris", "grad", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4808, "epsg", 4808,
        "Padang (Jakarta)", 1, 1, "Bessel 1841", "Padang_1884_Jakarta", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4809, "epsg", 4809,
        "Belge 1950 (Brussels)", 1, 1, "International 1924", "Reseau_National_Belge_1950_Brussels", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4810, "epsg", 4810,
        "Tananarive (Paris)", 1, 1, "International 1924", "Tananarive_1925_Paris", "grad", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4811, "epsg", 4811,
        "Voirol 1875 (Paris)", 1, 1, "Clarke 1880 (IGN)", "Voirol_1875_Paris", "grad", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4812, "epsg", 4812,
        "New Beijing / 3-degree Gauss-Kruger CM 132E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4813, "epsg", 4813,
        "Batavia (Jakarta)", 1, 1, "Bessel 1841", "Batavia_Jakarta", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4814, "epsg", 4814,
        "RT38 (Stockholm)", 1, 1, "Bessel 1841", "Stockholm_1938_Stockholm", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4815, "epsg", 4815,
        "Greek (Athens)", 1, 1, "Bessel 1841", "Greek_Athens", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4816, "epsg", 4816,
        "Carthage (Paris)", 1, 1, "Clarke 1880 (IGN)", "Carthage_Paris", "grad", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4817, "epsg", 4817,
        "NGO 1948 (Oslo)", 1, 1, "Bessel Modified", "NGO_1948_Oslo", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4818, "epsg", 4818,
        "S-JTSK (Ferro)", 1, 1, "Bessel 1841", "System_Jednotne_Trigonometricke_Site_Katastralni_Ferro", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4819, "epsg", 4819,
        "Nord Sahara 1959 (Paris)", 1, 1, "Clarke 1880 (RGS)", "Nord_Sahara_1959_Paris", "grad", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4820, "epsg", 4820,
        "Segara (Jakarta)", 1, 1, "Bessel 1841", "Gunung_Segara_Jakarta", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4821, "epsg", 4821,
        "Voirol 1879 (Paris)", 1, 1, "Clarke 1880 (IGN)", "Voirol_1879_Paris", "grad", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4822, "epsg", 4822,
        "New Beijing / 3-degree Gauss-Kruger CM 135E", 0, 1, "Krassowsky 1940", "New_Beijing", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4823, "epsg", 4823,
        "Sao Tome", 1, 1, "International 1924", "Sao_Tome", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=intl +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4824, "epsg", 4824,
        "Principe", 1, 1, "International 1924", "Principe", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=intl +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4826, "epsg", 4826,
        "WGS 84 / Cape Verde National", 0, 0, "WGS 84", "WGS_1984", "metre", "M", "East", "P", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4839, "epsg", 4839,
        "ETRS89 / LCC Germany (N-E)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4855, "epsg", 4855,
        "ETRS89 / NTM zone 5 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4856, "epsg", 4856,
        "ETRS89 / NTM zone 6 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4857, "epsg", 4857,
        "ETRS89 / NTM zone 7 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4858, "epsg", 4858,
        "ETRS89 / NTM zone 8 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4859, "epsg", 4859,
        "ETRS89 / NTM zone 9 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4860, "epsg", 4860,
        "ETRS89 / NTM zone 10 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4861, "epsg", 4861,
        "ETRS89 / NTM zone 11 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4862, "epsg", 4862,
        "ETRS89 / NTM zone 12 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4863, "epsg", 4863,
        "ETRS89 / NTM zone 13 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4864, "epsg", 4864,
        "ETRS89 / NTM zone 14 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4865, "epsg", 4865,
        "ETRS89 / NTM zone 15 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4866, "epsg", 4866,
        "ETRS89 / NTM zone 16 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4867, "epsg", 4867,
        "ETRS89 / NTM zone 17 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4868, "epsg", 4868,
        "ETRS89 / NTM zone 18 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4869, "epsg", 4869,
        "ETRS89 / NTM zone 19 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4870, "epsg", 4870,
        "ETRS89 / NTM zone 20 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4871, "epsg", 4871,
        "ETRS89 / NTM zone 21 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4872, "epsg", 4872,
        "ETRS89 / NTM zone 22 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4873, "epsg", 4873,
        "ETRS89 / NTM zone 23 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4874, "epsg", 4874,
        "ETRS89 / NTM zone 24 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4875, "epsg", 4875,
        "ETRS89 / NTM zone 25 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4876, "epsg", 4876,
        "ETRS89 / NTM zone 26 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4877, "epsg", 4877,
        "ETRS89 / NTM zone 27 (deprecated)", 0, 1, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Northing", "North", "Easting", "East");
    add_proj4text (p, 0,
