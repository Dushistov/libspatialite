...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 3140, "epsg", 3140,
        "Viti Levu 1912 / Viti Levu Grid", 0, 1, "Clarke 1880 (international foot)", "Viti_Levu_1912", "link", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3141, "epsg", 3141,
        "Fiji 1956 / UTM zone 60S", 0, 0, "International 1924", "Fiji_1956", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3142, "epsg", 3142,
        "Fiji 1956 / UTM zone 1S", 0, 0, "International 1924", "Fiji_1956", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3143, "epsg", 3143,
        "Fiji 1986 / Fiji Map Grid (deprecated)", 0, 0, "WGS 72", "Fiji_Geodetic_Datum_1986", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3146, "epsg", 3146,
        "Pulkovo 1942 / 3-degree Gauss-Kruger zone 6 (deprecated)", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3147, "epsg", 3147,
        "Pulkovo 1942 / 3-degree Gauss-Kruger CM 18E (deprecated)", 0, 1, "Krassowsky 1940", "Pulkovo_1942", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3148, "epsg", 3148,
        "Indian 1960 / UTM zone 48N", 0, 0, "Everest 1830 (1937 Adjustment)", "Indian_1960", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3149, "epsg", 3149,
        "Indian 1960 / UTM zone 49N", 0, 0, "Everest 1830 (1937 Adjustment)", "Indian_1960", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3150, "epsg", 3150,
        "Pulkovo 1995 / 3-degree Gauss-Kruger zone 6 (deprecated)", 0, 1, "Krassowsky 1940", "Pulkovo_1995", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=18 +k=1 +x_0=6500000 +y_0=0 ");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3151, "epsg", 3151,
        "Pulkovo 1995 / 3-degree Gauss-Kruger CM 18E (deprecated)", 0, 1, "Krassowsky 1940", "Pulkovo_1995", "metre", "X", "North", "Y", "East");
    add_proj4text (p, 0,
        "+proj=tmerc +lat_0=0 +lon_0=18 +k=1 +x_0=500000 +y_0=0 +");
    add_proj4text (p, 1,
        "ellps=krass +towgs84=24.47,-130.89,-81.56,-0,-0,0.13,-0.");
    ...
    p = add_epsg_def_ex (filter, first, last, 3152, "epsg", 3152,
        "ST74", 0, 1, "GRS 1980", "SWEREF99", "metre", "x", "North", "y", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3153, "epsg", 3153,
        "NAD83(CSRS) / BC Albers", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3161, "epsg", 3161,
        "NAD83 / Ontario MNR Lambert", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3162, "epsg", 3162,
        "NAD83(CSRS) / Ontario MNR Lambert", 0, 0, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=44.5 +lat_2=53.5 +lat_0=0 +lon_0=-85 +x");
    add_proj4text (p, 1,
        "_0=930000 +y_0=6430000 +ellps=GRS80 +towgs84=0,0,0,0,0,0");
    ...
    p = add_epsg_def_ex (filter, first, last, 3163, "epsg", 3163,
        "RGNC91-93 / Lambert New Caledonia", 0, 0, "GRS 1980", "Reseau_Geodesique_de_Nouvelle_Caledonie_91_93", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3164, "epsg", 3164,
        "ST87 Ouvea / UTM zone 58S", 0, 0, "WGS 84", "ST87_Ouvea", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3165, "epsg", 3165,
        "NEA74 Noumea / Noumea Lambert", 0, 0, "International 1924", "NEA74_Noumea", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3166, "epsg", 3166,
        "NEA74 Noumea / Noumea Lambert 2", 0, 0, "International 1924", "NEA74_Noumea", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3167, "epsg", 3167,
        "Kertau (RSO) / RSO Malaya (ch)", 0, 0, "Everest 1830 (RSO 1969)", "Kertau_RSO", "British chain (Sears 1922 truncated)", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3168, "epsg", 3168,
        "Kertau (RSO) / RSO Malaya (m)", 0, 0, "Everest 1830 (RSO 1969)", "Kertau_RSO", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=omerc +lat_0=4 +lonc=102.25 +alpha=323.0257905 +k=");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3169, "epsg", 3169,
        "RGNC91-93 / UTM zone 57S", 0, 0, "GRS 1980", "Reseau_Geodesique_de_Nouvelle_Caledonie_91_93", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3170, "epsg", 3170,
        "RGNC91-93 / UTM zone 58S", 0, 0, "GRS 1980", "Reseau_Geodesique_de_Nouvelle_Caledonie_91_93", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3171, "epsg", 3171,
        "RGNC91-93 / UTM zone 59S", 0, 0, "GRS 1980", "Reseau_Geodesique_de_Nouvelle_Caledonie_91_93", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3172, "epsg", 3172,
        "IGN53 Mare / UTM zone 59S", 0, 0, "International 1924", "IGN53_Mare", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3174, "epsg", 3174,
        "NAD83 / Great Lakes Albers", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3175, "epsg", 3175,
        "NAD83 / Great Lakes and St Lawrence Albers", 0, 0, "GRS 1980", "North_American_Datum_1983", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
        "+proj=aea +lat_1=42.122774 +lat_2=49.01518 +lat_0=45.568");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3176, "epsg", 3176,
        "Indian 1960 / TM 106 NE", 0, 0, "Everest 1830 (1937 Adjustment)", "Indian_1960", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3177, "epsg", 3177,
        "LGD2006 / Libya TM", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3178, "epsg", 3178,
        "GR96 / UTM zone 18N", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3179, "epsg", 3179,
        "GR96 / UTM zone 19N", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3180, "epsg", 3180,
        "GR96 / UTM zone 20N", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3181, "epsg", 3181,
        "GR96 / UTM zone 21N", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3182, "epsg", 3182,
        "GR96 / UTM zone 22N", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3183, "epsg", 3183,
        "GR96 / UTM zone 23N", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3184, "epsg", 3184,
        "GR96 / UTM zone 24N", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3185, "epsg", 3185,
        "GR96 / UTM zone 25N", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3186, "epsg", 3186,
        "GR96 / UTM zone 26N", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3187, "epsg", 3187,
        "GR96 / UTM zone 27N", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3188, "epsg", 3188,
        "GR96 / UTM zone 28N", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3189, "epsg", 3189,
        "GR96 / UTM zone 29N", 0, 0, "GRS 1980", "Greenland_1996", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3190, "epsg", 3190,
        "LGD2006 / Libya TM zone 5", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3191, "epsg", 3191,
        "LGD2006 / Libya TM zone 6", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3192, "epsg", 3192,
        "LGD2006 / Libya TM zone 7", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3193, "epsg", 3193,
        "LGD2006 / Libya TM zone 8", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3194, "epsg", 3194,
        "LGD2006 / Libya TM zone 9", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3195, "epsg", 3195,
        "LGD2006 / Libya TM zone 10", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3196, "epsg", 3196,
        "LGD2006 / Libya TM zone 11", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3197, "epsg", 3197,
        "LGD2006 / Libya TM zone 12", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3198, "epsg", 3198,
        "LGD2006 / Libya TM zone 13", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3199, "epsg", 3199,
        "LGD2006 / UTM zone 32N", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3200, "epsg", 3200,
        "FD58 / Iraq zone", 0, 0, "Clarke 1880 (RGS)", "Final_Datum_1958", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3201, "epsg", 3201,
        "LGD2006 / UTM zone 33N", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3202, "epsg", 3202,
        "LGD2006 / UTM zone 34N", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3203, "epsg", 3203,
        "LGD2006 / UTM zone 35N", 0, 0, "International 1924", "Libyan_Geodetic_Datum_2006", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3204, "epsg", 3204,
        "WGS 84 / SCAR IMW SP19-20", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3205, "epsg", 3205,
        "WGS 84 / SCAR IMW SP21-22", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-60.66666666666666 +lat_2=-63.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3206, "epsg", 3206,
        "WGS 84 / SCAR IMW SP23-24", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-60.66666666666666 +lat_2=-63.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3207, "epsg", 3207,
        "WGS 84 / SCAR IMW SQ01-02", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3208, "epsg", 3208,
        "WGS 84 / SCAR IMW SQ19-20", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-64.66666666666667 +lat_2=-67.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3209, "epsg", 3209,
        "WGS 84 / SCAR IMW SQ21-22", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-64.66666666666667 +lat_2=-67.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3210, "epsg", 3210,
        "WGS 84 / SCAR IMW SQ37-38", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-64.66666666666667 +lat_2=-67.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3211, "epsg", 3211,
        "WGS 84 / SCAR IMW SQ39-40", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-64.66666666666667 +lat_2=-67.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3212, "epsg", 3212,
        "WGS 84 / SCAR IMW SQ41-42", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-64.66666666666667 +lat_2=-67.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3213, "epsg", 3213,
        "WGS 84 / SCAR IMW SQ43-44", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-64.66666666666667 +lat_2=-67.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3214, "epsg", 3214,
        "WGS 84 / SCAR IMW SQ45-46", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-64.66666666666667 +lat_2=-67.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3215, "epsg", 3215,
        "WGS 84 / SCAR IMW SQ47-48", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-64.66666666666667 +lat_2=-67.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3216, "epsg", 3216,
        "WGS 84 / SCAR IMW SQ49-50", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-64.66666666666667 +lat_2=-67.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3217, "epsg", 3217,
        "WGS 84 / SCAR IMW SQ51-52", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-64.66666666666667 +lat_2=-67.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3218, "epsg", 3218,
        "WGS 84 / SCAR IMW SQ53-54", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-64.66666666666667 +lat_2=-67.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3219, "epsg", 3219,
        "WGS 84 / SCAR IMW SQ55-56", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-64.66666666666667 +lat_2=-67.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3220, "epsg", 3220,
        "WGS 84 / SCAR IMW SQ57-58", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-64.66666666666667 +lat_2=-67.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3221, "epsg", 3221,
        "WGS 84 / SCAR IMW SR13-14", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3222, "epsg", 3222,
        "WGS 84 / SCAR IMW SR15-16", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3223, "epsg", 3223,
        "WGS 84 / SCAR IMW SR17-18", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3224, "epsg", 3224,
        "WGS 84 / SCAR IMW SR19-20", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
        "33333 +lat_0=-90 +lon_0=-66 +x_0=0 +y_0=0 +datum=WGS84 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 3225, "epsg", 3225,
        "WGS 84 / SCAR IMW SR27-28", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3226, "epsg", 3226,
        "WGS 84 / SCAR IMW SR29-30", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3227, "epsg", 3227,
        "WGS 84 / SCAR IMW SR31-32", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3228, "epsg", 3228,
        "WGS 84 / SCAR IMW SR33-34", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3229, "epsg", 3229,
        "WGS 84 / SCAR IMW SR35-36", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 3230, "epsg", 3230,
        "WGS 84 / SCAR IMW SR37-38", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
        "33333 +lat_0=-90 +lon_0=42 +x_0=0 +y_0=0 +datum=WGS84 +u");
    ...
    p = add_epsg_def_ex (filter, first, last, 3231, "epsg", 3231,
        "WGS 84 / SCAR IMW SR39-40", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
        "33333 +lat_0=-90 +lon_0=54 +x_0=0 +y_0=0 +datum=WGS84 +u");
    ...
    p = add_epsg_def_ex (filter, first, last, 3232, "epsg", 3232,
        "WGS 84 / SCAR IMW SR41-42", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
        "33333 +lat_0=-90 +lon_0=66 +x_0=0 +y_0=0 +datum=WGS84 +u");
    ...
    p = add_epsg_def_ex (filter, first, last, 3233, "epsg", 3233,
        "WGS 84 / SCAR IMW SR43-44", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
        "33333 +lat_0=-90 +lon_0=78 +x_0=0 +y_0=0 +datum=WGS84 +u");
    ...
    p = add_epsg_def_ex (filter, first, last, 3234, "epsg", 3234,
        "WGS 84 / SCAR IMW SR45-46", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
        "33333 +lat_0=-90 +lon_0=90 +x_0=0 +y_0=0 +datum=WGS84 +u");
    ...
    p = add_epsg_def_ex (filter, first, last, 3235, "epsg", 3235,
        "WGS 84 / SCAR IMW SR47-48", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
        "33333 +lat_0=-90 +lon_0=102 +x_0=0 +y_0=0 +datum=WGS84 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 3236, "epsg", 3236,
        "WGS 84 / SCAR IMW SR49-50", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
        "33333 +lat_0=-90 +lon_0=114 +x_0=0 +y_0=0 +datum=WGS84 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 3237, "epsg", 3237,
        "WGS 84 / SCAR IMW SR51-52", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
        "33333 +lat_0=-90 +lon_0=126 +x_0=0 +y_0=0 +datum=WGS84 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 3238, "epsg", 3238,
        "WGS 84 / SCAR IMW SR53-54", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
        "33333 +lat_0=-90 +lon_0=138 +x_0=0 +y_0=0 +datum=WGS84 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 3239, "epsg", 3239,
        "WGS 84 / SCAR IMW SR55-56", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
        "33333 +lat_0=-90 +lon_0=150 +x_0=0 +y_0=0 +datum=WGS84 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 3240, "epsg", 3240,
        "WGS 84 / SCAR IMW SR57-58", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
        "33333 +lat_0=-90 +lon_0=162 +x_0=0 +y_0=0 +datum=WGS84 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 3241, "epsg", 3241,
        "WGS 84 / SCAR IMW SR59-60", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-68.66666666666667 +lat_2=-71.333333333");
    add_proj4text (p, 1,
        "33333 +lat_0=-90 +lon_0=174 +x_0=0 +y_0=0 +datum=WGS84 +");
    ...
    p = add_epsg_def_ex (filter, first, last, 3242, "epsg", 3242,
        "WGS 84 / SCAR IMW SS04-06", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 3243, "epsg", 3243,
        "WGS 84 / SCAR IMW SS07-09", 0, 0, "WGS 84", "WGS_1984", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
        "+proj=lcc +lat_1=-72.66666666666667 +lat_2=-75.333333333");
    add_proj4text (p, 1,
