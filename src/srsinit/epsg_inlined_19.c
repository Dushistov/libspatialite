...
/* initializing the EPSG defs list */
    ...
    p = add_epsg_def_ex (filter, first, last, 4061, "epsg", 4061,
        "RGRDC 2005 / UTM zone 33S", 0, 0, "GRS 1980", "Reseau_Geodesique_de_la_RDC_2005", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4062, "epsg", 4062,
        "RGRDC 2005 / UTM zone 34S", 0, 0, "GRS 1980", "Reseau_Geodesique_de_la_RDC_2005", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4063, "epsg", 4063,
        "RGRDC 2005 / UTM zone 35S", 0, 0, "GRS 1980", "Reseau_Geodesique_de_la_RDC_2005", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4071, "epsg", 4071,
        "Chua / UTM zone 23S", 0, 0, "International 1924", "Chua", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4075, "epsg", 4075,
        "SREF98", 1, 1, "GRS 1980", "Serbian_Reference_Network_1998", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4081, "epsg", 4081,
        "REGCAN95", 1, 1, "GRS 1980", "Red_Geodesica_de_Canarias_1995", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4082, "epsg", 4082,
        "REGCAN95 / UTM zone 27N", 0, 0, "GRS 1980", "Red_Geodesica_de_Canarias_1995", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4083, "epsg", 4083,
        "REGCAN95 / UTM zone 28N", 0, 0, "GRS 1980", "Red_Geodesica_de_Canarias_1995", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4087, "epsg", 4087,
        "WGS 84 / World Equidistant Cylindrical", 0, 0, "WGS 84", "WGS_1984", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4088, "epsg", 4088,
        "World Equidistant Cylindrical (Sphere)", 0, 0, "GRS 1980 Authalic Sphere", "Not_specified_based_on_GRS_1980_Authalic_Sphere", "metre", "X", "East", "Y", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4093, "epsg", 4093,
        "ETRS89 / DKTM1", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4094, "epsg", 4094,
        "ETRS89 / DKTM2", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4095, "epsg", 4095,
        "ETRS89 / DKTM3", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4096, "epsg", 4096,
        "ETRS89 / DKTM4", 0, 0, "GRS 1980", "European_Terrestrial_Reference_System_1989", "metre", "Easting", "East", "Northing", "North");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4120, "epsg", 4120,
        "Greek", 1, 1, "Bessel 1841", "Greek", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4121, "epsg", 4121,
        "GGRS87", 1, 1, "GRS 1980", "Greek_Geodetic_Reference_System_1987", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4122, "epsg", 4122,
        "ATS77", 1, 1, "Average Terrestrial System 1977", "Average_Terrestrial_System_1977", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4123, "epsg", 4123,
        "KKJ", 1, 1, "International 1924", "Kartastokoordinaattijarjestelma_1966", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4125, "epsg", 4125,
        "Samboja", 1, 1, "Bessel 1841", "Samboja", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4126, "epsg", 4126,
        "LKS94 (ETRS89)", 1, 1, "GRS 1980", "Lithuania_1994_ETRS89", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4127, "epsg", 4127,
        "Tete", 1, 1, "Clarke 1866", "Tete", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4128, "epsg", 4128,
        "Madzansua", 1, 1, "Clarke 1866", "Madzansua", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4129, "epsg", 4129,
        "Observatario", 1, 1, "Clarke 1866", "Observatario", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=clrk66 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4130, "epsg", 4130,
        "Moznet", 1, 1, "WGS 84", "Moznet_ITRF94", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4131, "epsg", 4131,
        "Indian 1960", 1, 1, "Everest 1830 (1937 Adjustment)", "Indian_1960", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4132, "epsg", 4132,
        "FD58", 1, 1, "Clarke 1880 (RGS)", "Final_Datum_1958", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4133, "epsg", 4133,
        "EST92", 1, 1, "GRS 1980", "Estonia_1992", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4135, "epsg", 4135,
        "Old Hawaiian", 1, 1, "Clarke 1866", "Old_Hawaiian", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4136, "epsg", 4136,
        "St. Lawrence Island", 1, 1, "Clarke 1866", "St_Lawrence_Island", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=clrk66 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4137, "epsg", 4137,
        "St. Paul Island", 1, 1, "Clarke 1866", "St_Paul_Island", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=clrk66 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4138, "epsg", 4138,
        "St. George Island", 1, 1, "Clarke 1866", "St_George_Island", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=clrk66 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4139, "epsg", 4139,
        "Puerto Rico", 1, 1, "Clarke 1866", "Puerto_Rico", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4140, "epsg", 4140,
        "NAD83(CSRS98)", 1, 1, "GRS 1980", "NAD83_Canadian_Spatial_Reference_System", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4141, "epsg", 4141,
        "Israel", 1, 1, "GRS 1980", "Israel", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4142, "epsg", 4142,
        "Locodjo 1965", 1, 1, "Clarke 1880 (RGS)", "Locodjo_1965", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4143, "epsg", 4143,
        "Abidjan 1987", 1, 1, "Clarke 1880 (RGS)", "Abidjan_1987", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4144, "epsg", 4144,
        "Kalianpur 1937", 1, 1, "Everest 1830 (1937 Adjustment)", "Kalianpur_1937", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +a=6377276.345 +b=6356075.41314024 +towgs8");
    add_proj4text (p, 1,
    ...
    p = add_epsg_def_ex (filter, first, last, 4145, "epsg", 4145,
        "Kalianpur 1962", 1, 1, "Everest 1830 (1962 Definition)", "Kalianpur_1962", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4146, "epsg", 4146,
        "Kalianpur 1975", 1, 1, "Everest 1830 (1975 Definition)", "Kalianpur_1975", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4147, "epsg", 4147,
        "Hanoi 1972", 1, 1, "Krassowsky 1940", "Hanoi_1972", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4148, "epsg", 4148,
        "Hartebeesthoek94", 1, 1, "WGS 84", "Hartebeesthoek94", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4149, "epsg", 4149,
        "CH1903", 1, 1, "Bessel 1841", "CH1903", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4151, "epsg", 4151,
        "CHTRF95", 1, 1, "GRS 1980", "Swiss_Terrestrial_Reference_Frame_1995", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4153, "epsg", 4153,
        "Rassadiran", 1, 1, "International 1924", "Rassadiran", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4154, "epsg", 4154,
        "ED50(ED77)", 1, 1, "International 1924", "European_Datum_1950_1977", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4155, "epsg", 4155,
        "Dabola 1981", 1, 1, "Clarke 1880 (IGN)", "Dabola_1981", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4156, "epsg", 4156,
        "S-JTSK", 1, 1, "Bessel 1841", "System_Jednotne_Trigonometricke_Site_Katastralni", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4157, "epsg", 4157,
        "Mount Dillon", 1, 1, "Clarke 1858", "Mount_Dillon", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4158, "epsg", 4158,
        "Naparima 1955", 1, 1, "International 1924", "Naparima_1955", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4159, "epsg", 4159,
        "ELD79", 1, 1, "International 1924", "European_Libyan_Datum_1979", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4160, "epsg", 4160,
        "Chos Malal 1914", 1, 1, "International 1924", "Chos_Malal_1914", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4161, "epsg", 4161,
        "Pampa del Castillo", 1, 1, "International 1924", "Pampa_del_Castillo", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4162, "epsg", 4162,
        "Korean 1985", 1, 1, "Bessel 1841", "Korean_Datum_1985", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=bessel +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4163, "epsg", 4163,
        "Yemen NGN96", 1, 1, "WGS 84", "Yemen_National_Geodetic_Network_1996", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4164, "epsg", 4164,
        "South Yemen", 1, 1, "Krassowsky 1940", "South_Yemen", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4165, "epsg", 4165,
        "Bissau", 1, 1, "International 1924", "Bissau", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4166, "epsg", 4166,
        "Korean 1995", 1, 1, "WGS 84", "Korean_Datum_1995", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=WGS84 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4167, "epsg", 4167,
        "NZGD2000", 1, 1, "GRS 1980", "New_Zealand_Geodetic_Datum_2000", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4168, "epsg", 4168,
        "Accra", 1, 1, "War Office", "Accra", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4169, "epsg", 4169,
        "American Samoa 1962", 1, 1, "Clarke 1866", "American_Samoa_1962", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4170, "epsg", 4170,
        "SIRGAS 1995", 1, 1, "GRS 1980", "Sistema_de_Referencia_Geocentrico_para_America_del_Sur_1995", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4171, "epsg", 4171,
        "RGF93", 1, 1, "GRS 1980", "Reseau_Geodesique_Francais_1993", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4172, "epsg", 4172,
        "POSGAR", 1, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4173, "epsg", 4173,
        "IRENET95", 1, 1, "GRS 1980", "IRENET95", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4174, "epsg", 4174,
        "Sierra Leone 1924", 1, 1, "War Office", "Sierra_Leone_Colony_1924", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4175, "epsg", 4175,
        "Sierra Leone 1968", 1, 1, "Clarke 1880 (RGS)", "Sierra_Leone_1968", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4176, "epsg", 4176,
        "Australian Antarctic", 1, 1, "GRS 1980", "Australian_Antarctic_Datum_1998", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4178, "epsg", 4178,
        "Pulkovo 1942(83)", 1, 1, "Krassowsky 1940", "Pulkovo_1942_83", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4179, "epsg", 4179,
        "Pulkovo 1942(58)", 1, 1, "Krassowsky 1940", "Pulkovo_1942_58", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4180, "epsg", 4180,
        "EST97", 1, 1, "GRS 1980", "Estonia_1997", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4181, "epsg", 4181,
        "Luxembourg 1930", 1, 1, "International 1924", "Luxembourg_1930", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4182, "epsg", 4182,
        "Azores Occidental 1939", 1, 1, "International 1924", "Azores_Occidental_Islands_1939", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4183, "epsg", 4183,
        "Azores Central 1948", 1, 1, "International 1924", "Azores_Central_Islands_1948", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4184, "epsg", 4184,
        "Azores Oriental 1940", 1, 1, "International 1924", "Azores_Oriental_Islands_1940", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4185, "epsg", 4185,
        "Madeira 1936", 1, 1, "International 1924", "Madeira_1936", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=intl +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4188, "epsg", 4188,
        "OSNI 1952", 1, 1, "Airy 1830", "OSNI_1952", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4189, "epsg", 4189,
        "REGVEN", 1, 1, "GRS 1980", "Red_Geodesica_Venezolana", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4190, "epsg", 4190,
        "POSGAR 98", 1, 1, "GRS 1980", "Posiciones_Geodesicas_Argentinas_1998", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +no_de");
    add_proj4text (p, 1,
        "fs");
    ...
    p = add_epsg_def_ex (filter, first, last, 4191, "epsg", 4191,
        "Albanian 1987", 1, 1, "Krassowsky 1940", "Albanian_1987", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4192, "epsg", 4192,
        "Douala 1948", 1, 1, "International 1924", "Douala_1948", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4193, "epsg", 4193,
        "Manoca 1962", 1, 1, "Clarke 1880 (IGN)", "Manoca_1962", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4194, "epsg", 4194,
        "Qornoq 1927", 1, 1, "International 1924", "Qornoq_1927", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4195, "epsg", 4195,
        "Scoresbysund 1952", 1, 1, "International 1924", "Scoresbysund_1952", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4196, "epsg", 4196,
        "Ammassalik 1958", 1, 1, "International 1924", "Ammassalik_1958", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4197, "epsg", 4197,
        "Garoua", 1, 1, "Clarke 1880 (RGS)", "Garoua", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4198, "epsg", 4198,
        "Kousseri", 1, 1, "Clarke 1880 (RGS)", "Kousseri", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=clrk80 +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4199, "epsg", 4199,
        "Egypt 1930", 1, 1, "International 1924", "Egypt_1930", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
        "+proj=longlat +ellps=intl +no_defs");
    add_srs_wkt (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4200, "epsg", 4200,
        "Pulkovo 1995", 1, 1, "Krassowsky 1940", "Pulkovo_1995", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4201, "epsg", 4201,
        "Adindan", 1, 1, "Clarke 1880 (RGS)", "Adindan", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4202, "epsg", 4202,
        "AGD66", 1, 1, "Australian National Spheroid", "Australian_Geodetic_Datum_1966", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4203, "epsg", 4203,
        "AGD84", 1, 1, "Australian National Spheroid", "Australian_Geodetic_Datum_1984", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4204, "epsg", 4204,
        "Ain el Abd", 1, 1, "International 1924", "Ain_el_Abd_1970", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
    ...
    p = add_epsg_def_ex (filter, first, last, 4205, "epsg", 4205,
        "Afgooye", 1, 1, "Krassowsky 1940", "Afgooye", "degree", "Latitude", "North", "Longitude", "East");
    add_proj4text (p, 0,
